...
public class MyPropertyUtils extends PropertyUtilsBean {
  ...
  private static final Logger log =
    Logger.getLogger(MyPropertyUtils.class.getName());
   ...
   * 
   * Works for Beans and ?Maps? as input.
   * TODO Test for Maps.
   * 
   * @param dest 
   * @param orig 
   ...
   * 
   * @see org.apache.commons.beanutils.PropertyUtilsBean#copyProperties(java.lang.Object,
   *      java.lang.Object)
   */
  public void deepCopyProperties(Object dest, Object orig,
      Set<String> discardDestProperties) throws IllegalAccessException,
  ...
  private void deepCopyPropertiesRecursive(Object dest, Object orig, Set<String> discardDestProperties) 
    ...
    for (String propName : unmappedList) {
      ...
      convertArrayToList(destProperty, origProperty,
          destPropertyType, discardDestProperties);
    }
  }
   ...
   * @throws NoSuchFieldException
   */
  private void convertArrayToList(Object destProperty, Object origProperty,
      Type destPropertyType, Set<String> discardDestProperties)
    ...
    if (destPropertyType instanceof ParameterizedType) {
      ...
      Class<?> destListParameterizedClass = (Class<?>) destParameterizedType
          .getActualTypeArguments()[0];
      log.info("Handling parameterized type conversion: "
          + destListParameterizedClass);
      ...
      for (int i = 0; i < origArrayLength; i++) {
        ...
        deepCopyPropertiesRecursive(newDestObject, origArrayProperty,
            discardDestProperties);
   ...
   * 
   * @see
   * org.apache.commons.beanutils.PropertyUtilsBean#setSimpleProperty(java.lang
