...
public class EditCoursesInput  implements java.io.Serializable {
    private com.linkare.rec.web.wsgen.moodle.CourseDatum[] courses;

    public EditCoursesInput() {
    }

    public EditCoursesInput(
           com.linkare.rec.web.wsgen.moodle.CourseDatum[] courses) {
     ...
     * @return courses
     */
    public com.linkare.rec.web.wsgen.moodle.CourseDatum[] getCourses() {
        return courses;
    }
     ...
     * @param courses
     */
    public void setCourses(com.linkare.rec.web.wsgen.moodle.CourseDatum[] courses) {
        this.courses = courses;
    }
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("http://elab.ist.utl.pt/moodle/wspp/wsdl", "editCoursesInput"));
        org.apache.axis.description.ElementDesc elemField = new org.apache.axis.description.ElementDesc();
        elemField.setFieldName("courses");
        elemField.setXmlName(new javax.xml.namespace.QName("", "courses"));
        elemField.setXmlType(new javax.xml.namespace.QName("http://elab.ist.utl.pt/moodle/wspp/wsdl", "courseDatum"));
