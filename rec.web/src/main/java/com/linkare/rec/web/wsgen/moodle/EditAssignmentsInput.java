...
public class EditAssignmentsInput  implements java.io.Serializable {
    private com.linkare.rec.web.wsgen.moodle.AssignmentDatum[] assignments;

    public EditAssignmentsInput() {
    }

    public EditAssignmentsInput(
           com.linkare.rec.web.wsgen.moodle.AssignmentDatum[] assignments) {
     ...
     * @return assignments
     */
    public com.linkare.rec.web.wsgen.moodle.AssignmentDatum[] getAssignments() {
        return assignments;
    }
     ...
     * @param assignments
     */
    public void setAssignments(com.linkare.rec.web.wsgen.moodle.AssignmentDatum[] assignments) {
        this.assignments = assignments;
    }
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("http://elab.ist.utl.pt/moodle/wspp/wsdl", "editAssignmentsInput"));
        org.apache.axis.description.ElementDesc elemField = new org.apache.axis.description.ElementDesc();
        elemField.setFieldName("assignments");
        elemField.setXmlName(new javax.xml.namespace.QName("", "assignments"));
        elemField.setXmlType(new javax.xml.namespace.QName("http://elab.ist.utl.pt/moodle/wspp/wsdl", "assignmentDatum"));
