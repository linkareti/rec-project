...
public class AssignmentSubmissionRecord  implements java.io.Serializable {
    ...
    private com.linkare.rec.web.wsgen.moodle.FileRecord[] files;
    ...
    public AssignmentSubmissionRecord(
           ...
           com.linkare.rec.web.wsgen.moodle.FileRecord[] files) {
           this.error = error;
           this.id = id;
     ...
     * @return files
     */
    public com.linkare.rec.web.wsgen.moodle.FileRecord[] getFiles() {
        return files;
    }
     ...
     * @param files
     */
    public void setFiles(com.linkare.rec.web.wsgen.moodle.FileRecord[] files) {
        this.files = files;
    }
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("http://elab.ist.utl.pt/moodle/wspp/wsdl", "assignmentSubmissionRecord"));
        ...
        elemField.setXmlType(new javax.xml.namespace.QName("http://elab.ist.utl.pt/moodle/wspp/wsdl", "fileRecord"));
        elemField.setNillable(false);
        typeDesc.addFieldDesc(elemField);
    }
