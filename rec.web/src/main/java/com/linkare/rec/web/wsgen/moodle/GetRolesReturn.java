...
public class GetRolesReturn  implements java.io.Serializable {
    private com.linkare.rec.web.wsgen.moodle.RoleRecord[] roles;

    public GetRolesReturn() {
    }

    public GetRolesReturn(
           com.linkare.rec.web.wsgen.moodle.RoleRecord[] roles) {
           this.roles = roles;
    }
     ...
     * @return roles
     */
    public com.linkare.rec.web.wsgen.moodle.RoleRecord[] getRoles() {
        return roles;
    }
     ...
     * @param roles
     */
    public void setRoles(com.linkare.rec.web.wsgen.moodle.RoleRecord[] roles) {
        this.roles = roles;
    }
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("http://elab.ist.utl.pt/moodle/wspp/wsdl", "getRolesReturn"));
        org.apache.axis.description.ElementDesc elemField = new org.apache.axis.description.ElementDesc();
        elemField.setFieldName("roles");
        elemField.setXmlName(new javax.xml.namespace.QName("", "roles"));
        elemField.setXmlType(new javax.xml.namespace.QName("http://elab.ist.utl.pt/moodle/wspp/wsdl", "roleRecord"));
