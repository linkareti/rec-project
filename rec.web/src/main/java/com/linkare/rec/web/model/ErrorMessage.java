...
/**
 * Represents an error message generated from rec.web.
 * 
...
@NamedQueries({
		@NamedQuery(name = ErrorMessage.FIND_ALL_QUERYNAME, query = ErrorMessage.FIND_ALL_QUERY),
...
public class ErrorMessage extends DefaultDomainObject {
	...
	public int hashCode() {
		...
		int result = 1;
		result = prime * result
				+ (int) (getIdInternal() ^ (getIdInternal() >>> 32));
		return result;
	}
	...
	public boolean equals(Object obj) {
		...
		if (getIdInternal().longValue() != other.getIdInternal().longValue())
			return false;
		return true;
	}
	...
	public String toString() {
		return "ErrorMessage [id=" + getIdInternal() + ", message=" + message
				+ ", category=" + category + ", dateError=" + dateError + "]";
	}
}