...
public class EditDatabasesInput  implements java.io.Serializable {
    private com.linkare.rec.web.wsgen.moodle.DatabaseDatum[] databases;

    public EditDatabasesInput() {
    }

    public EditDatabasesInput(
           com.linkare.rec.web.wsgen.moodle.DatabaseDatum[] databases) {
     ...
     * @return databases
     */
    public com.linkare.rec.web.wsgen.moodle.DatabaseDatum[] getDatabases() {
        return databases;
    }
     ...
     * @param databases
     */
    public void setDatabases(com.linkare.rec.web.wsgen.moodle.DatabaseDatum[] databases) {
        this.databases = databases;
    }
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("http://elab.ist.utl.pt/moodle/wspp/wsdl", "editDatabasesInput"));
        org.apache.axis.description.ElementDesc elemField = new org.apache.axis.description.ElementDesc();
        elemField.setFieldName("databases");
        elemField.setXmlName(new javax.xml.namespace.QName("", "databases"));
        elemField.setXmlType(new javax.xml.namespace.QName("http://elab.ist.utl.pt/moodle/wspp/wsdl", "databaseDatum"));
