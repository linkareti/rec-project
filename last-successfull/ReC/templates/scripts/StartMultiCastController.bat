...
set PROCESSINGMANAGER_SYSPROPS=-DReC.MultiCast.ProcessingManager.ThreadPool.Coresize=@rec.processingmanager.threadpool.coresize@ -DReC.MultiCast.ProcessingManager.ThreadPool.Maxsize=@rec.processingmanager.threadpool.maxsize@ -DReC.MultiCast.ProcessingManager.Thread.Idletime=@rec.processingmanager.thread.idletime@
