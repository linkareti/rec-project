...
public class PaintUtils {
	...
	/**
	 * Draws an image on top of a component by doing a 3x3 grid stretch of the
	...
	public static void tileStretchPaint(final Graphics g, final JComponent comp, final BufferedImage img,
		...
		final int right = ins.right;
		final int top = ins.top;
		final int bottom = ins.bottom;

		// Dimension size = component.getSize();
		// Rectangle rect = component.getVisibleRect();
		// g = g.create();
		// Rectangle clip = SwingUtilities.convertRectangle(component, rect,
		// this);
		...
		// bottom
		g2d.drawImage(img, pos.x - left, pos.y + comp.getHeight(), pos.x, pos.y + comp.getHeight() + bottom, 0,
				img.getHeight() - bottom, left, img.getHeight(), null);
		...
		g2d.drawImage(img, pos.x + comp.getWidth(), pos.y + comp.getHeight(), pos.x + comp.getWidth() + right, pos.y
				+ comp.getHeight() + bottom, img.getWidth() - right, img.getHeight() - bottom, img.getWidth(),
				img.getHeight(), null);
