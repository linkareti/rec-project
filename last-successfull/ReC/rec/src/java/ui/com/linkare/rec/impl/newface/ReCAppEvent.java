...
public class ReCAppEvent extends EventObject {
	...
	public enum ReCCommand {
		SHOW_LOGIN, SELECTED_APPARATUS_CHANGE, CUSTOMIZER_DONE, CUSTOMIZER_CANCELED, CHOOSE_VLC, EXPERIMENT_HISTORY_ADDED, SHOW_EXPERIMENT_HISTORY_HEADER_INFO, SHOW_EXPERIMENT_HISTORY, REFRESH_VIEW;
	}
