...
public class ApparatusTabbedPane extends AbstractContentPane implements ChangeListener {
	 ...
	 * 
	 */
	private static final long serialVersionUID = -4043923825393531015L;
	...
	public ApparatusTabbedPane() {
		...
		setTabIndexEnabled(ApparatusTabbedPane.TAB_RESULTS, false);
	...
	public void addResultsComponent(final Component controller) {
		resultsHolderPane.add(controller);
	}

	public void addCustomizerComponent(final JComponent controller) {
	 ...
	 * @param dataDisplays
	 */
	public void setDataDisplays(final List<ExpDataDisplay> dataDisplays) {
		for (final ExpDataDisplay display : dataDisplays) {
			if (display.getToolBar() != null) {
				final JToolBar newToolBar = display.getToolBar();
				...
				if (!lastSelectedTabResults) {
					if (ApparatusTabbedPane.TAB_RESULTS == tabbedPane.getSelectedIndex()) {
	...
	public void stateChanged(final ChangeEvent e) {
		if (toolBar != null) {
			if (ApparatusTabbedPane.TAB_RESULTS == tabbedPane.getSelectedIndex() && !lastSelectedTabResults) {
				actionBarHolderPane.remove(experimentActionBar);
	...
	private void initComponents() {
		...
		final org.jdesktop.application.ResourceMap resourceMap = org.jdesktop.application.Application
				...
				.getResourceMap(ApparatusTabbedPane.class);
