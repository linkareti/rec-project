...
public class ClientQueue {
	 ...
	 * @return
	 */
	public boolean isJmxAdmin(UserInfo user) {
		Property[] userProps = user.getUserProps();
		if (userProps != null) {
			for (Property prop : userProps) {
				if (com.linkare.rec.impl.utils.mbean.MultiCastController.JMX_ADMIN_IDENTIFIER_USERINFO.equals(prop
						.getName())) {
					return true;
				}
			}
