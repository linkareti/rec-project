...
public class IndexedPropertyObjectTableCellEditor extends AbstractCellEditor implements TableCellEditor {
	...
	public void comboBoxItemStateChanged(final ItemEvent evt) {
		final JComboBox evtSourceCombo = (JComboBox) evt.getSource();
		final String tag = (String) evtSourceCombo.getSelectedItem();
		try {
	...
	public class IndexedPropertyCustomEditorButton extends JButton {
		 ...
		 * 
		 */
		private static final long serialVersionUID = 6696422899425677613L;
