...
public class MultiplierValueEditor extends AbstractSelectionListPropertyEditor {
	...
	public MultiplierValueEditor() {
		...
		addTableValue(new Byte(Multiplier.micro.getValue()), "\u03BC (1E-6)", pack + "Multiplier.micro.getValue()");
		addTableValue(new Byte(Multiplier.mili.getValue()), "m (1E-3)", pack + "Multiplier.mili.getValue()");
		addTableValue(new Byte(Multiplier.none.getValue()), "none (1E0)", pack + "Multiplier.none.getValue()");
		addTableValue(new Byte(Multiplier.kilo.getValue()), "k (1E3)", pack + "Multiplier.kilo.getValue()");
		addTableValue(new Byte(Multiplier.mega.getValue()), "M (1E6)", pack + "Multiplier.mega.getValue()");
		addTableValue(new Byte(Multiplier.giga.getValue()), "G (1E9)", pack + "Multiplier.giga.getValue()");
		addTableValue(new Byte(Multiplier.tera.getValue()), "T (1E12)", pack + "Multiplier.tera.getValue()");
