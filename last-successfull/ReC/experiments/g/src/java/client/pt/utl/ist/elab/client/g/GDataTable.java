 ...
 */
public class GDataTable extends javax.swing.JPanel implements ExpDataDisplay, Printable, ExperimentTableOperation {
	...
	private void initComponents()// GEN-BEGIN:initComponents
	{
		...
		gTableModelProxy = new pt.utl.ist.elab.client.g.GTableModelProxy();
	...
	public int print(Graphics g, PageFormat pageFormat, int pageIndex) throws PrinterException {
		...
		// bottom center
		g2.drawString("P�gina: " + (pageIndex + 1), (int) pageWidth / 2 - 35,
	...
	private pt.utl.ist.elab.client.g.GTableModelProxy gTableModelProxy;
