 ...
 */
public class ModelPWM extends pt.utl.ist.elab.client.webrobot.customizer.Models.ModelBlock implements
	...
	private int flag = 1; // 1 se os dois selecionados, 2 se o de cima
	// selecionado, 3 se o de baixo selecionado
