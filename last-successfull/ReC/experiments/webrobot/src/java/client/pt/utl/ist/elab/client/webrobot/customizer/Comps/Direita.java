...
public class Direita extends pt.utl.ist.elab.client.webrobot.customizer.Comps.Block {
	 ...
	 * 
	 */
	private static final long serialVersionUID = 2362992665838526560L;
	...
	private String text;
	private final String fullNameDescription = "Roda a direita";
	...
	public Direita(final pt.utl.ist.elab.client.webrobot.customizer.Models.ModelDireita model) {
		super();
		setCancel(false);
	...
	public void setDataModel(final pt.utl.ist.elab.client.webrobot.customizer.Models.ModelDireita model) {
		this.model = model;
	}
