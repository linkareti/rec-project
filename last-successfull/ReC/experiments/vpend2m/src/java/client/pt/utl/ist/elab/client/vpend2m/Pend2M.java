...
public class Pend2M extends DrawingPanel3D implements ActionListener, MouseListener {
	...
	protected void keepDistances() {
		...
		bola[1].setXYZ(0, bola[0].getY() + n1 * (fio[1].getYMax() - fio[1].getYMin()), bola[0].getZ() + n2
				* (fio[1].getZMax() - fio[1].getZMin()));
	}
	...
	public void move(double theta, double phi, double thetaDot, double phiDot, double point, double thetaDot2,
			double phiDot2) {
	...
	public void actionPerformed(ActionEvent e) {
		if (e.getActionCommand().equalsIgnoreCase(
				java.util.ResourceBundle.getBundle("pt/utl/ist/elab/client/vpend2m/resources/ReCExpPend2M")
