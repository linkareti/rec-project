...
public class PenduloStampDriver extends AbstractStampDriver {
	...
	public void configure(HardwareAcquisitionConfig config, HardwareInfo info) throws WrongConfigurationException {
		...
		stampConfig.addCommandData(StampConfigTranslator.TETA_INIT_STR, new Integer(Defaults.defaultIfEmpty(config
				.getSelectedHardwareParameterValue(StampConfigTranslator.TETA_INIT_STR), info
				.getHardwareParameterValue(StampConfigTranslator.TETA_INIT_STR))));

		stampConfig.addCommandData(StampConfigTranslator.HEIGHT_INIT_STR, new Integer(Defaults.defaultIfEmpty(config
				.getSelectedHardwareParameterValue(StampConfigTranslator.HEIGHT_INIT_STR), info
				.getHardwareParameterValue(StampConfigTranslator.HEIGHT_INIT_STR))));

		stampConfig.addCommandData(StampConfigTranslator.FRICTION_STR, Defaults.defaultIfEmpty(config
				.getSelectedHardwareParameterValue(StampConfigTranslator.FRICTION_STR), info
				.getHardwareParameterValue(StampConfigTranslator.FRICTION_STR)));
