 ...
 * 
 * For now this is a copy of GTableModelProxy.java
 */
 ...
 *
 */
public class PaschenTableModelProxy extends javax.swing.table.DefaultTableModel implements ExpDataModelListener,
	...
	public String getColumnName(final int columnIndex) {
		...
		final String multiplier = expDataModel.getChannelConfig(channelIndex).getSelectedScale().getMultiplier().toString();
		final String ph_unit_symbol = expDataModel.getChannelConfig(channelIndex).getSelectedScale().getPhysicsUnitSymbol();
