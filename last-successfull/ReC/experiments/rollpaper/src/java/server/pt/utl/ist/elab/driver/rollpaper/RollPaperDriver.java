...
public class RollPaperDriver extends VirtualBaseDriver {

	private static String Pend2M_DRIVER_LOGGER = "Pend2M.Logger";
	static {
		final Logger l = LogManager.getLogManager().getLogger(RollPaperDriver.Pend2M_DRIVER_LOGGER);
		if (l == null) {
			LogManager.getLogManager().addLogger(Logger.getLogger(RollPaperDriver.Pend2M_DRIVER_LOGGER));
		}
	}
	...
	public void config(final HardwareAcquisitionConfig config, final HardwareInfo info) throws IncorrectStateException,
		...
		try {
			...
			LoggerUtil.logThrowable("Error on config...", e, Logger.getLogger(RollPaperDriver.Pend2M_DRIVER_LOGGER));
	...
	public void configure(final HardwareAcquisitionConfig config, final HardwareInfo info)
		...
		dataSource = new RollPaperDataProducer(this, theta, phi, thetaDot, phiDot, l1, l2, m1, m2, w, fase, a, g, tbs,
				nSamples);
	...
	public String getDriverUniqueID() {
		return RollPaperDriver.DRIVER_UNIQUE_ID;
	}
	...
	public Object getHardwareInfo() {
		...
		try {
			...
			LoggerUtil.logThrowable("Unable to load resource: " + prop, e,
					Logger.getLogger(RollPaperDriver.Pend2M_DRIVER_LOGGER));
			try {
