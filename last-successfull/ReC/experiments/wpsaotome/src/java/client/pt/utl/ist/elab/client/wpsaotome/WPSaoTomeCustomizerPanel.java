 ...
 * @author npadriano
 */
public class WPSaoTomeCustomizerPanel extends AbstractCustomizer {
	...
	public static final float PERIOD = 3.3f;
        ...
        /** Creates new form WPSaoTomeCustomizerPanel */
	public WPSaoTomeCustomizerPanel() {
		labelBegin = ReCResourceBundle.findStringOrDefault("wpsaotome$jLabelEstimatedTime.text.beggining","Estimated time is");
                labelEnd = ReCResourceBundle.findStringOrDefault("wpsaotome$jLabelEstimatedTime.text.end","minutes");
    ...
    private void initComponents() {
        ...
        jTabbedPaneWPSaoTome = new javax.swing.JTabbedPane();
        ...
        setName("WPSaoTomeCustomizer"); // NOI18N
        setPreferredSize(new java.awt.Dimension(350, 350));
        setRequestFocusEnabled(false);
        setLayout(new java.awt.BorderLayout());

        jTabbedPaneWPSaoTome.setName("jTabbedPaneWPSaoTome"); // NOI18N
        jTabbedPaneWPSaoTome.addChangeListener(new javax.swing.event.ChangeListener() {
            public void stateChanged(javax.swing.event.ChangeEvent evt) {
                jTabbedPaneWPSaoTomeStateChanged(evt);
            }
        });
        ...
        jPanelPenduloDisplacement.setBorder(javax.swing.BorderFactory.createTitledBorder(ReCResourceBundle.findStringOrDefault("wpsaotome$jPanelPenduloDisplacement.border.title","Initial Displacement")));
        ...
        jSliderDisplacement.setToolTipText(ReCResourceBundle.findStringOrDefault("wpsaotome$jSliderDisplacement.toolTipText","Initial Displacement"));
        ...
        org.jdesktop.application.ResourceMap resourceMap = org.jdesktop.application.Application.getInstance().getContext().getResourceMap(WPSaoTomeCustomizerPanel.class);
        ...
        jSliderDisplacement.getAccessibleContext().setAccessibleName(ReCResourceBundle.findStringOrDefault("wpsaotome$jSliderDisplacement.toolTipText","Deslocamento"));
        jSliderDisplacement.getAccessibleContext().setAccessibleDescription(ReCResourceBundle.findStringOrDefault("wpsaotome$jSliderDisplacement.toolTipText","Deslocamento"));
        jFormattedTextFieldDisplacement.getAccessibleContext().setAccessibleDescription(ReCResourceBundle.findStringOrDefault("wpsaotome$jSliderDisplacement.toolTipText","Deslocamento"));

        jPanelNrPoints.setBorder(javax.swing.BorderFactory.createTitledBorder(ReCResourceBundle.findStringOrDefault("wpsaotome$jPanelNrPoints.border.title","Samples")));
        ...
        jSliderNrPoints.getAccessibleContext().setAccessibleDescription(ReCResourceBundle.findStringOrDefault("wpsaotome$jFormattedTextFieldNrPoints.toolTipText","Amostras"));
        jFormattedTextFieldNrPoints.getAccessibleContext().setAccessibleDescription(ReCResourceBundle.findStringOrDefault("wpsaotome$jFormattedTextFieldNrPoints.toolTipText","Amostras"));
        ...
        jPanelPenduloDisplacement.getAccessibleContext().setAccessibleName(ReCResourceBundle.findStringOrDefault("wpsaotome$jPanelPenduloDisplacement.border.title","Initial Displacement"));
        jPanelPenduloDisplacement.getAccessibleContext().setAccessibleDescription(ReCResourceBundle.findStringOrDefault("wpsaotome$jPanelPenduloDisplacement.border.title","Initial Displacement"));
        jPanelNrPoints.getAccessibleContext().setAccessibleName(ReCResourceBundle.findStringOrDefault("wpsaotome$jPanelNrPoints.border.title","Samples"));
        jPanelNrPoints.getAccessibleContext().setAccessibleDescription(ReCResourceBundle.findStringOrDefault("wpsaotome$jPanelNrPoints.border.title","Samples"));
        jLabelEstimatedTime.getAccessibleContext().setAccessibleName(ReCResourceBundle.findStringOrDefault("wpsaotome$jLabelEstimatedTime.text","Tempo Estimado"));
        jLabelEstimatedTime.getAccessibleContext().setAccessibleDescription(ReCResourceBundle.findStringOrDefault("wpsaotome$jLabelEstimatedTime.text","Tempo Estimado"));

        jTabbedPaneWPSaoTome.addTab(ReCResourceBundle.findStringOrDefault("wpsaotome$jPanelPendulumConfig.TabConstraints.tabTitle","Configure"), null, jPanelPendulumConfig, resourceMap.getString("jPanelPendulumConfig.TabConstraints.tabToolTip")); // NOI18N

        add(jTabbedPaneWPSaoTome, java.awt.BorderLayout.CENTER);
        jTabbedPaneWPSaoTome.getAccessibleContext().setAccessibleName(ReCResourceBundle.findStringOrDefault("wpsaotome$jPanelPendulumConfig.TabConstraints.tabTitle","Configure"));
        ...
        jButtonCancel.setText(ReCResourceBundle.findStringOrDefault("wpsaotome$Cancel.label","Cancel"));
        ...
        jButtonDefaultConfig.setText(ReCResourceBundle.findStringOrDefault("wpsaotome$DefaultConfig.label","Default Config"));
        ...
        jButtonCancel.getAccessibleContext().setAccessibleName(ReCResourceBundle.findStringOrDefault("wpsaotome$jButtonCancel.AccessibleContext.accessibleName","Cancel"));
        jButtonDefaultConfig.getAccessibleContext().setAccessibleName(ReCResourceBundle.findStringOrDefault("wpsaotome$jButtonDefaultConfig.AccessibleContext.accessibleName","Default Config"));

        add(jPanelControlButtons, java.awt.BorderLayout.PAGE_END);
    }// </editor-fold>//GEN-END:initComponents

private void jTabbedPaneWPSaoTomeStateChanged(javax.swing.event.ChangeEvent evt) {//GEN-FIRST:event_jTabbedPaneWPSaoTomeStateChanged
    validateScreen();
}//GEN-LAST:event_jTabbedPaneWPSaoTomeStateChanged
...
private void jFormattedTextFieldNrPointsFocusLost(java.awt.event.FocusEvent evt) {//GEN-FIRST:event_jFormattedTextFieldNrPointsFocusLost
	...
	private void jButtonOkActionPerformed(final java.awt.event.ActionEvent evt) {// GEN-FIRST:event_jButtonOkActionPerformed
		...
		Frequency freq = null;                
            ...
            final int time = (int) Math.ceil((WPSaoTomeCustomizerPanel.PERIOD * nsamples*(1.1) / nsamples));
            ...
            getAcquisitionConfig().getSelectedHardwareParameter("wpsaotome$parameter.displacement").setParameterValue(String.valueOf(displacement));
            getAcquisitionConfig().getSelectedHardwareParameter("wpsaotome$parameter.nrpoints").setParameterValue(String.valueOf(nsamples));        
    ...
    private javax.swing.JTabbedPane jTabbedPaneWPSaoTome;
	...
	public void setHardwareAcquisitionConfig(final HardwareAcquisitionConfig acqConfig) {
		super.setHardwareAcquisitionConfig(acqConfig);
                ...
                if (acqConfig != null) {
			System.out.println("WPSaoTomeCustomizer.setHardwareAcquisitionConfig(HardwareAcquisitionConfig  acqConfig)");
	...
	public javax.swing.ImageIcon getCustomizerIcon() {
		return new javax.swing.ImageIcon(getClass().getResource(
				"/pt/utl/ist/elab/client/wpsaotome/resources/wpsaotome_iconified.gif"));
	}

	@Override
	public String getCustomizerTitle() {
		return ReCResourceBundle.findStringOrDefault("wpsaotome$rec.exp.wpsaotome.customizer.title","wpsaotome$rec.exp.wpsaotome.customizer.title");
	}
