	...
	public void newSamples(NewExpDataEvent evt) {
		...
		for (int i = evt.getSamplesStartIndex(); i <= evt.getSamplesEndIndex(); i++) {
			...
			if (model.getValueAt(i, 2) != null && model.getValueAt(i, 3) != null) {
				dataRastoSuperior.append(model.getValueAt(i, 2).getValue().getFloatValue(), model.getValueAt(i, 3)
						.getValue().getFloatValue());
			}
			if (model.getValueAt(i, 1) != null && model.getValueAt(i, 4) != null) {
				dataRastoLateral.append(model.getValueAt(i, 1).getValue().getFloatValue(), model.getValueAt(i, 4)
						.getValue().getFloatValue());
			}
			if (model.getValueAt(i, 2) != null && model.getValueAt(i, 4) != null) {
				dataRastoLateralFixo.append(model.getValueAt(i, 2).getValue().getFloatValue(), model.getValueAt(i, 4)
						.getValue().getFloatValue());
			}
			...
			if (model.getValueAt(i, 15) != null && model.getValueAt(i, 14) != null) {
				painel2DLateral.setPreferredMinMax(-model.getValueAt(i, 15).getValue().getFloatValue() * 1.2, model
						.getValueAt(i, 15).getValue().getFloatValue() * 1.2, -model.getValueAt(i, 15).getValue()
						.getFloatValue()
						* model.getValueAt(i, 15).getValue().getFloatValue()
						* 0.1
						* model.getValueAt(i, 14).getValue().getFloatValue(), model.getValueAt(i, 15).getValue()
						.getFloatValue()
						* model.getValueAt(i, 15).getValue().getFloatValue()
						* 1.2
						* model.getValueAt(i, 14).getValue().getFloatValue());
				painel2DLateralFixo.setPreferredMinMax(-model.getValueAt(i, 15).getValue().getFloatValue() * 1.2, model
						.getValueAt(i, 15).getValue().getFloatValue() * 1.2, -model.getValueAt(i, 15).getValue()
						.getFloatValue()
						* model.getValueAt(i, 15).getValue().getFloatValue()
						* 0.1
						...
						* 1.2
						* model.getValueAt(i, 14).getValue().getFloatValue());
				painel2DSuperior.setPreferredMinMax(-model.getValueAt(i, 15).getValue().getFloatValue() * 1.2, model
						.getValueAt(i, 15).getValue().getFloatValue() * 1.2, -model.getValueAt(i, 15).getValue()
						.getFloatValue() * 1.2, model.getValueAt(i, 15).getValue().getFloatValue() * 1.2);
			}
