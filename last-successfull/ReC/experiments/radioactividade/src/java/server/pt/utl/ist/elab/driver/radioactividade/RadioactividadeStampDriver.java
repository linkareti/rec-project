...
public class RadioactividadeStampDriver extends AbstractStampDriver {
	...
	public void configure(HardwareAcquisitionConfig config, HardwareInfo info) throws WrongConfigurationException {
		...
		stampConfig.addCommandData(StampConfigTranslator.MODE_STR, Defaults.defaultIfEmpty(config
	...
	public Object getHardwareInfo() {
		...
		String baseHardwareInfoFile = "recresource://pt/utl/ist/elab/driver/radioactividade/RadioactividadeBaseHardwareInfo.xml";
		String prop = Defaults.defaultIfEmpty(System.getProperty("eLab.Radioactividade.HardwareInfo"),
