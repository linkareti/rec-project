package com.linkare.jmf.media.protocol.function.ui;
...
import com.linkare.jmf.media.protocol.function.FunctorType;
import com.linkare.jmf.media.protocol.function.FunctorTypeControl;
...
public class FunctorTypeControlComponent extends JPanel {
	...
	if(this.functorTypeControl!=null && this.functorTypeControl.getFunctorControl()!=null && this.functorTypeControl.getFunctorControl().getControlComponent()!=null)
	{
	    this.add(this.functorTypeControl.getFunctorControl().getControlComponent(),BorderLayout.CENTER);
	}
	repaint();
