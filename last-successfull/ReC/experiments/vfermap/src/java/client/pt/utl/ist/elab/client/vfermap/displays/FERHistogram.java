...
public class FERHistogram extends PlottingPanel implements ExpDataDisplay, ExpDataModelListener {
	...
	public FERHistogram() {
		 ...
		 */
		// statusStr =
		// java.util.ResourceBundle.getBundle("pt/utl/ist/elab/client/vfermap/resources/ReCExpFERMAP").getString("rec.exp.displays.inactive");
	...
	public void dataModelStartedNoData() {
		...
		if (simulType != 1) {
			...
			setTitle(java.util.ResourceBundle.getBundle("pt/utl/ist/elab/client/vfermap/resources/ReCExpFERMAP")
