...
public class PenduloStampDriver extends AbstractStampDriver {
	...
	public void configure(HardwareAcquisitionConfig config, HardwareInfo info) throws WrongConfigurationException {
		...
		stampConfig.addCommandData(StampConfigTranslator.TETA_INIT_STR, new Float(Defaults.defaultIfEmpty(config
		...
		stampConfig.addCommandData(StampConfigTranslator.HEIGHT_INIT_STR, new Float(Defaults.defaultIfEmpty(config
	...
	public Object getHardwareInfo() {
		String baseHardwareInfoFile = "recresource://pt/utl/ist/elab/driver/pendulogravitico/PenduloBaseHardwareInfo.xml";
