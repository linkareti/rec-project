 ...
 * 
 * 
 *         ang -> rad d -> mm s0 -> mm l -> cm luzX -> cm reguaSize -> cm
 */
public class BalancaTorcao extends DrawingPanel3D implements ActionListener, MouseListener {
	...
	/*
	 * 0 -> Perspective 1 -> XZ 2 -> XY 3 -> YZ 4 -> Free 3D
	 */
	...
	private void buildPopupMenu() {
		...
		viewPopMenu.addItem(ReCResourceBundle.findStringOrDefault("rec.exp.customizer.balanca.popup.view.title.1",
				"Perspective"), ReCResourceBundle.findStringOrDefault("rec.exp.customizer.balanca.popup.view.tip.1",
				"Perspective View (3D)"));
		...
		viewPopMenu.addItem(ReCResourceBundle.findStringOrDefault("rec.exp.customizer.balanca.popup.view.title.4",
				...
				"Lateral View (2D)"));
		viewPopMenu.addItem(ReCResourceBundle.findStringOrDefault("rec.exp.customizer.balanca.popup.view.title.5",
				"Free 3D"), ReCResourceBundle.findStringOrDefault("rec.exp.customizer.balanca.popup.view.tip.5",
				"Go to 3D mantaining the current view"));
		viewPopMenu.addItem(ReCResourceBundle.findStringOrDefault("rec.exp.customizer.balanca.popup.view.title.6",
				"Measure"), ReCResourceBundle.findStringOrDefault("rec.exp.customizer.balanca.popup.view.tip.6",
