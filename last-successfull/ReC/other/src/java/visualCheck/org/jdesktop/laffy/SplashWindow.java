...
public class SplashWindow extends JWindow {
	private static final Color[] COLORS = new Color[] { new Color(255, 212, 3), new Color(255, 177, 0), new Color(255, 109, 0),
			new Color(255, 2, 7), new Color(172, 3, 36), new Color(238, 4, 65), new Color(255, 116, 182), new Color(156, 145, 221),
			new Color(96, 140, 213), new Color(124, 178, 238), new Color(162, 211, 254), new Color(65, 156, 157), new Color(0, 181, 174),
			new Color(2, 191, 3), };
	...
	private class GraphicsPanel extends JPanel {
		...
		protected void paintComponent(Graphics g) {
			...
			g2.setPaint(new LinearGradientPaint(0, 0, 319, 319, new float[] { Math.max(0, (percentageComplete * 1.2f) - 0.2001f),
			// -fudge to stop both being equal at %100
					Math.min(1, (percentageComplete * 1.2f) + 0.001f) }, // +fudge to stop both being equal at %0
					new Color[] { new Color(255, 255, 255, 0), Color.WHITE }, MultipleGradientPaint.CycleMethod.NO_CYCLE));
