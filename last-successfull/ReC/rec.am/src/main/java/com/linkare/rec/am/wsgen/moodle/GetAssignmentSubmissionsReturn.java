...
public class GetAssignmentSubmissionsReturn  implements java.io.Serializable {
    private com.linkare.rec.am.wsgen.moodle.AssignmentSubmissionRecord[] submissions;

    public GetAssignmentSubmissionsReturn() {
    }

    public GetAssignmentSubmissionsReturn(
           com.linkare.rec.am.wsgen.moodle.AssignmentSubmissionRecord[] submissions) {
     ...
     * @return submissions
     */
    public com.linkare.rec.am.wsgen.moodle.AssignmentSubmissionRecord[] getSubmissions() {
        return submissions;
    }
     ...
     * @param submissions
     */
    public void setSubmissions(com.linkare.rec.am.wsgen.moodle.AssignmentSubmissionRecord[] submissions) {
        this.submissions = submissions;
    }
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("http://localhost/moodle/wspp/wsdl", "getAssignmentSubmissionsReturn"));
        org.apache.axis.description.ElementDesc elemField = new org.apache.axis.description.ElementDesc();
        elemField.setFieldName("submissions");
        elemField.setXmlName(new javax.xml.namespace.QName("", "submissions"));
        elemField.setXmlType(new javax.xml.namespace.QName("http://localhost/moodle/wspp/wsdl", "assignmentSubmissionRecord"));
