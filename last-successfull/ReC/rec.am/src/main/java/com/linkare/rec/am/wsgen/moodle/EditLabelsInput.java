...
public class EditLabelsInput  implements java.io.Serializable {
    private com.linkare.rec.am.wsgen.moodle.LabelDatum[] labels;

    public EditLabelsInput() {
    }

    public EditLabelsInput(
           com.linkare.rec.am.wsgen.moodle.LabelDatum[] labels) {
           this.labels = labels;
    }
     ...
     * @return labels
     */
    public com.linkare.rec.am.wsgen.moodle.LabelDatum[] getLabels() {
        return labels;
    }
     ...
     * @param labels
     */
    public void setLabels(com.linkare.rec.am.wsgen.moodle.LabelDatum[] labels) {
        this.labels = labels;
    }
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("http://localhost/moodle/wspp/wsdl", "editLabelsInput"));
        org.apache.axis.description.ElementDesc elemField = new org.apache.axis.description.ElementDesc();
        elemField.setFieldName("labels");
        elemField.setXmlName(new javax.xml.namespace.QName("", "labels"));
        elemField.setXmlType(new javax.xml.namespace.QName("http://localhost/moodle/wspp/wsdl", "labelDatum"));
