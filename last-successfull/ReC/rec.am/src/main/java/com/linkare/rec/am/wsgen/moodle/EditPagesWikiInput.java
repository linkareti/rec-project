...
public class EditPagesWikiInput  implements java.io.Serializable {
    private com.linkare.rec.am.wsgen.moodle.PageWikiDatum[] pagesWiki;

    public EditPagesWikiInput() {
    }

    public EditPagesWikiInput(
           com.linkare.rec.am.wsgen.moodle.PageWikiDatum[] pagesWiki) {
     ...
     * @return pagesWiki
     */
    public com.linkare.rec.am.wsgen.moodle.PageWikiDatum[] getPagesWiki() {
        return pagesWiki;
    }
     ...
     * @param pagesWiki
     */
    public void setPagesWiki(com.linkare.rec.am.wsgen.moodle.PageWikiDatum[] pagesWiki) {
        this.pagesWiki = pagesWiki;
    }
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("http://localhost/moodle/wspp/wsdl", "editPagesWikiInput"));
        org.apache.axis.description.ElementDesc elemField = new org.apache.axis.description.ElementDesc();
        elemField.setFieldName("pagesWiki");
        elemField.setXmlName(new javax.xml.namespace.QName("", "pagesWiki"));
        elemField.setXmlType(new javax.xml.namespace.QName("http://localhost/moodle/wspp/wsdl", "pageWikiDatum"));
