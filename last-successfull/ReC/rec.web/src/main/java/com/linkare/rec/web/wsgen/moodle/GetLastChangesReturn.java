...
public class GetLastChangesReturn  implements java.io.Serializable {
    private com.linkare.rec.web.wsgen.moodle.ChangeRecord[] changes;

    public GetLastChangesReturn() {
    }

    public GetLastChangesReturn(
           com.linkare.rec.web.wsgen.moodle.ChangeRecord[] changes) {
     ...
     * @return changes
     */
    public com.linkare.rec.web.wsgen.moodle.ChangeRecord[] getChanges() {
        return changes;
    }
     ...
     * @param changes
     */
    public void setChanges(com.linkare.rec.web.wsgen.moodle.ChangeRecord[] changes) {
        this.changes = changes;
    }
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("http://elab.ist.utl.pt/moodle/wspp/wsdl", "getLastChangesReturn"));
        org.apache.axis.description.ElementDesc elemField = new org.apache.axis.description.ElementDesc();
        elemField.setFieldName("changes");
        elemField.setXmlName(new javax.xml.namespace.QName("", "changes"));
        elemField.setXmlType(new javax.xml.namespace.QName("http://elab.ist.utl.pt/moodle/wspp/wsdl", "changeRecord"));
