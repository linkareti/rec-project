...
public class EditGroupingsInput  implements java.io.Serializable {
    private com.linkare.rec.web.wsgen.moodle.GroupDatum[] groupings;

    public EditGroupingsInput() {
    }

    public EditGroupingsInput(
           com.linkare.rec.web.wsgen.moodle.GroupDatum[] groupings) {
     ...
     * @return groupings
     */
    public com.linkare.rec.web.wsgen.moodle.GroupDatum[] getGroupings() {
        return groupings;
    }
     ...
     * @param groupings
     */
    public void setGroupings(com.linkare.rec.web.wsgen.moodle.GroupDatum[] groupings) {
        this.groupings = groupings;
    }
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("http://elab.ist.utl.pt/moodle/wspp/wsdl", "editGroupingsInput"));
