...
public class InteractivePend2M extends Pend2M implements InteractionListener, Runnable {
	 ...
	 * 
	 */
	private static final long serialVersionUID = -9113668877325080172L;
	...
	public InteractivePend2M(final InteractiveMenu par) {
		super(par);
		buildInteractivePend2M();
	}
	...
	public void setFreq(final double w) {
		this.w = w;
	}
	...
	public void config(final double theta, final double phi, final double thetaDot, final double phiDot,
			final double l1, final double l2, final double amp, final double fase, final double w) {
		this.w = w;
