 ...
 * Version 1.0
 * 
 * instead of: Color c = new Color(255, 0, 0); use the freqency in nanometers,
 * and gamma 0.0. .. 1.0. Color c = Wavelength.wlColor( 400.0f, 0.80f );
 * 
 * or using frequency in Terahertz and gamma 0.0. .. 1.0. Color c =
 * Wavelength.fColor( 500.0f, 1.0f );
 * 
 * You might use it to draw a realistic rainbow, or to write educational Applets
 * about the light spectrum.
 * 
 * Based on a Fortran program by Dan Bruton (astro@tamu.edu) The original
 * Fortran can be found at: http://www.isc.tamu.edu/~astro/color.html It uses
 * linear interpolation on ten spectral bands.
 * 
 * @author copyright (c) 1998-2004 Roedy Green, Canadian Mind Products may be
 *         copied and used freely for any purpose but military.
 * 
 *         Roedy Green Canadian Mind Products #327 - 964 Heywood Avenue
 *         Victoria, BC Canada V8V 2Y5 tel: (250) 361-9093
 *         mailto:roedyg@mindprod.com http://mindprod.com
 * 
 */
public class Wavelength {
	...
	public static Color wvColor(float wl, float gamma) {
		 ...
		 * numbers mark the upper bound of each band.
		 */
	...
	/**
	 * Creates a Color object given the frequency instead of the usual RGB or
	 * HSB values.
	 * 
	 * @param freq frequency of the light in Terahertz (10.0e12 Hz) Will show up
