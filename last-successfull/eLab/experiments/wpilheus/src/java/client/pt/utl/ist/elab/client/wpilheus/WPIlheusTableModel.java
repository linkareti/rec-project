 ...
 * @author npadriano
 */
public class WPIlheusTableModel extends DefaultExperimentDataTable {
	 ...
	 */
	public WPIlheusTableModel() {
		super();

		final WPIlheusTableModelProxy model = new WPIlheusTableModelProxy();
