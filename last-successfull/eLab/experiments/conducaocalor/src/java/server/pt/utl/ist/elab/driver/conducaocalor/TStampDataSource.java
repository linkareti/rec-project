	...
	public void processDataCommand(StampCommand cmd) {
		...
		if (cmd.getCommandIdentifier().equals(StampTProcessor.COMMAND_IDENTIFIER)) {
			...
			values[0] = PhysicsValueFactory.fromFloat(temperature1Brass, getAcquisitionHeader().getChannelsConfig(0)
					.getSelectedScale());
			values[1] = PhysicsValueFactory.fromFloat(temperature2Brass, getAcquisitionHeader().getChannelsConfig(1)
					.getSelectedScale());
			values[2] = PhysicsValueFactory.fromFloat(temperature3Brass, getAcquisitionHeader().getChannelsConfig(2)
					.getSelectedScale());
			values[3] = PhysicsValueFactory.fromFloat(temperature1Iron, getAcquisitionHeader().getChannelsConfig(3)
					.getSelectedScale());
			values[4] = PhysicsValueFactory.fromFloat(temperature2Iron, getAcquisitionHeader().getChannelsConfig(4)
					.getSelectedScale());
			values[5] = PhysicsValueFactory.fromFloat(temperature3Iron, getAcquisitionHeader().getChannelsConfig(5)
					.getSelectedScale());
			values[6] = PhysicsValueFactory.fromFloat(temperature1Copper, getAcquisitionHeader().getChannelsConfig(6)
					.getSelectedScale());
			values[7] = PhysicsValueFactory.fromFloat(temperature2Copper, getAcquisitionHeader().getChannelsConfig(7)
					.getSelectedScale());
			values[8] = PhysicsValueFactory.fromFloat(temperature3Copper, getAcquisitionHeader().getChannelsConfig(8)
					.getSelectedScale());
			...
			values[9] = PhysicsValueFactory.fromFloat(timeDelay, getAcquisitionHeader().getChannelsConfig(9)
					.getSelectedScale());
