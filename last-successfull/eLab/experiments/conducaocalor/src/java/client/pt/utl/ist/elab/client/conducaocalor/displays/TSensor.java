...
public class TSensor extends javax.swing.JPanel implements com.linkare.rec.impl.client.experiment.ExpDataDisplay,
	...
	public TSensor() {
		...
		GradientPaint gp1 = new GradientPaint(0, 0, BRASS_COLOR, imgS1.getWidth(), imgS1.getHeight(), BRASS_COLOR
				.brighter());
		...
		GradientPaint gp2 = new GradientPaint(0, 0, IRON_COLOR, imgS2.getWidth(), imgS2.getHeight(), IRON_COLOR
				.brighter());
		...
		GradientPaint gp3 = new GradientPaint(0, 0, COPPER_COLOR, imgS3.getWidth(), imgS3.getHeight(), COPPER_COLOR
				.brighter());
