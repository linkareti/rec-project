 ...
 */
public class ScubaCustomizer extends AbstractCustomizer {
	...
	{// GEN-HEADEREND:event_btnOKActionPerformed
		...
		getAcquisitionConfig().getSelectedHardwareParameter("xini").setParameterValue("" + sldPos1.getValue());
		getAcquisitionConfig().getSelectedHardwareParameter("xfin").setParameterValue("" + sldPos2.getValue());
		if (checkCalib.isSelected()) {
			getAcquisitionConfig().getSelectedHardwareParameter("calib").setParameterValue("1");
		} else {
			getAcquisitionConfig().getSelectedHardwareParameter("calib").setParameterValue("0");
		}
