	...
	public void newSamples(NewExpDataEvent evt) {
		...
		for (int i = evt.getSamplesStartIndex(); i <= evt.getSamplesEndIndex(); i++) {
			...
			if (model.getValueAt(i, 1) != null) {
				...
				plottingPanel1.setPreferredMinMaxX((model.getValueAt(i, 1).getValue().getFloatValue()) - 1, (model
						.getValueAt(i, 1).getValue().getFloatValue()) + 1);
			}
			if (model.getValueAt(i, 2) != null) {
				...
				plottingPanel2.setPreferredMinMaxX((model.getValueAt(i, 2).getValue().getFloatValue()) - 1, (model
						.getValueAt(i, 2).getValue().getFloatValue()) + 1);
			}
			if (model.getValueAt(i, 3) != null) {
				...
				plottingPanel1.setPreferredMinMaxY((model.getValueAt(i, 3).getValue().getFloatValue()) - 1, (model
						.getValueAt(i, 3).getValue().getFloatValue()) + 1);
			}
			if (model.getValueAt(i, 4) != null) {
				...
				plottingPanel2.setPreferredMinMaxY((model.getValueAt(i, 4).getValue().getFloatValue()) - 1, (model
						.getValueAt(i, 4).getValue().getFloatValue()) + 1);
			}
