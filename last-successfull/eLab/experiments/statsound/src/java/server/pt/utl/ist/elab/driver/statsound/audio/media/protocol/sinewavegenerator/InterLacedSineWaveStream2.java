...
public class InterLacedSineWaveStream2 implements PushBufferStream {
	...
	public InterLacedSineWaveStream2() {
		...
		// dataQueue=new com.linkare.rec.impl.utils.EventQueue(new
		// TransferHandlerDispatcher());
	}
	...
	/*
	 * private class TransferHandlerDispatcher implements
	 * com.linkare.rec.impl.utils.EventQueueDispatcher { public void
	 * dispatchEvent(Object obj) { if(obj instanceof byte[]) {
	 * newData((byte[])obj); } elseSystem.out.println(
	 * "Cannot deal in TransferHandlerDispatcher with event of class=" +
	 * (obj==null?"null":obj.getClass().getName())); }
	 * 
	 * public int getPriority() { return Thread.MAX_PRIORITY-1; }
	 * 
	 * }
	 */
