...
public class StatSoundCustomizer extends javax.swing.JPanel implements
	...
	public StatSoundCustomizer() {
		...
		final String pink = ReCResourceBundle.findString("statsound$rec.exp.statsound.lbl.pink");
	...
	private void initComponents() {
		...
		final javax.swing.GroupLayout jPanelSoundVelocityMicsLayout = new javax.swing.GroupLayout(
				jPanelSoundVelocityMics);
		...
		jTextFieldSoundVelocityNSamples.setFocusable(false);
		...
		jLabelSoundVelocityNSamplesAlert.setForeground(resourceMap
				.getColor("jLabelSoundVelocityNSamplesAlert.foreground")); // NOI18N
		...
		final javax.swing.GroupLayout jPanelSoundVelocityNSamplesLayout = new javax.swing.GroupLayout(
		...
		jTextFieldSoundVelocityPiston.setFocusable(false);
		...
		final javax.swing.GroupLayout jPanelSoundVelocityPistonLayout = new javax.swing.GroupLayout(
				jPanelSoundVelocityPiston);
		...
		final javax.swing.GroupLayout jPanelSoundVelocityWaveFormLayout = new javax.swing.GroupLayout(
		...
		jTextFieldSoundVelocityFrequency.setFocusable(false);
		...
		final javax.swing.GroupLayout jPanelSoundVelocityFrequencyLayout = new javax.swing.GroupLayout(
		...
		final javax.swing.GroupLayout jPanelSoundSpeedLayout = new javax.swing.GroupLayout(jPanelSoundSpeed);
		...
		jTabbedPaneStatSound
				.addTab(resourceMap.getString("jPanelSoundSpeed.TabConstraints.tabTitle"), jPanelSoundSpeed); // NOI18N
		...
		final javax.swing.GroupLayout jPanelStatSoundIMicsLayout = new javax.swing.GroupLayout(jPanelStatSoundIMics);
		...
		jTextFieldStatSoundINSamples.setFocusable(false);
		...
		final javax.swing.GroupLayout jPanelStatSoundINSamplesLayout = new javax.swing.GroupLayout(
				jPanelStatSoundINSamples);
		...
		jTextFieldStatSoundIPistonInitial.setFocusable(false);
		...
		final javax.swing.GroupLayout jPanelStatSoundPistonIInitialLayout = new javax.swing.GroupLayout(
		...
		jTextFieldStatSoundIPistonEnd.setFocusable(false);
		...
		final javax.swing.GroupLayout jPanelStatSoundIPistonEndLayout = new javax.swing.GroupLayout(
				jPanelStatSoundIPistonEnd);
		...
		jTextFieldStatSoundIFrequency.setFocusable(false);
		...
		final javax.swing.GroupLayout jPanelStatSoundIFrequencyLayout = new javax.swing.GroupLayout(
				jPanelStatSoundIFrequency);
		...
		jTabbedPaneStatSound
				.addTab(resourceMap.getString("jPanelStatSoundI.TabConstraints.tabTitle"), jPanelStatSoundI); // NOI18N
		...
		final javax.swing.GroupLayout jPanelStatSoundIIMicsLayout = new javax.swing.GroupLayout(jPanelStatSoundIIMics);
		...
		jTextFieldStatSoundIINSamples.setFocusable(false);
		...
		final javax.swing.GroupLayout jPanelStatSoundIINSamplesLayout = new javax.swing.GroupLayout(
				jPanelStatSoundIINSamples);
		...
		jLabelStatSoundIINSamplesAlert.getAccessibleContext().setAccessibleName(
				resourceMap.getString("jLabelStatSoundIINSamplesAlert.AccessibleContext.accessibleName")); // NOI18N
		...
		jTextFieldStatSoundIIPiston.setFocusable(false);
		...
		final javax.swing.GroupLayout jPanelStatSoundIIPistonLayout = new javax.swing.GroupLayout(
				jPanelStatSoundIIPiston);
		...
		jTextFieldStatSoundIIFrequencyInitial.setText(resourceMap
				.getString("jTextFieldStatSoundIIFrequencyInitial.text")); // NOI18N
		jTextFieldStatSoundIIFrequencyInitial.setFocusable(false);
		...
		final javax.swing.GroupLayout jPanelStatSoundIIFrequencyInitialLayout = new javax.swing.GroupLayout(
		...
		jTextFieldStatSoundIIFrequencyEnd.setFocusable(false);
		...
		final javax.swing.GroupLayout jPanelStatSoundIIFrequencyEndLayout = new javax.swing.GroupLayout(
		...
		jTabbedPaneStatSound.addTab(resourceMap.getString("jPanelStatSoundII.TabConstraints.tabTitle"),
				jPanelStatSoundII); // NOI18N
	...
	private void jButtonOKActionPerformed(final java.awt.event.ActionEvent evt) {// GEN-FIRST:event_jButtonOKActionPerformed
		...
		case 1:
			...
			acqConfig.getSelectedHardwareParameter("Piston start").setParameterValue(
					"" + jSliderSoundVelocityPiston.getValue());
			acqConfig.getSelectedHardwareParameter("Piston end").setParameterValue(
					"" + jSliderSoundVelocityPiston.getValue());
			acqConfig.getSelectedHardwareParameter("Frequency start").setParameterValue(
					"" + jSliderSoundVelocityFrequency.getValue());
			acqConfig.getSelectedHardwareParameter("Frequency end").setParameterValue(
					"" + jSliderSoundVelocityFrequency.getValue());
			acqConfig.getSelectedHardwareParameter("Wave form").setParameterValue(
					"" + jComboBoxSoundVelocityWaveForm.getSelectedIndex());
			break;
		case 2:
	...
	private void analyseTextField(final javax.swing.JTextField jtf, final javax.swing.JSlider js) {
		final String strValue = jtf.getText().trim();
		int value = 0;
		try {
