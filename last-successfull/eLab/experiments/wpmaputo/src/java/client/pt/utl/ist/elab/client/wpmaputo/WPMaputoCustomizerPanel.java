 ...
 * @author npadriano
 */
public class WPMaputoCustomizerPanel extends AbstractCustomizer {
	...
	public static final float PERIOD = 3.3f;
        ...
        /** Creates new form WPMaputoCustomizerPanel */
	public WPMaputoCustomizerPanel() {
		labelBegin = ReCResourceBundle.findStringOrDefault("wpmaputo$jLabelEstimatedTime.text.beggining","Estimated time is");
                labelEnd = ReCResourceBundle.findStringOrDefault("wpmaputo$jLabelEstimatedTime.text.end","minutes");
    ...
    private void initComponents() {
        ...
        jTabbedPaneWPMaputo = new javax.swing.JTabbedPane();
        ...
        setName("WPMaputoCustomizer"); // NOI18N
        setPreferredSize(new java.awt.Dimension(350, 350));
        setRequestFocusEnabled(false);
        setLayout(new java.awt.BorderLayout());

        jTabbedPaneWPMaputo.setName("jTabbedPaneWPMaputo"); // NOI18N
        jTabbedPaneWPMaputo.addChangeListener(new javax.swing.event.ChangeListener() {
            public void stateChanged(javax.swing.event.ChangeEvent evt) {
                jTabbedPaneWPMaputoStateChanged(evt);
            }
        });
        ...
        jPanelPenduloDisplacement.setBorder(javax.swing.BorderFactory.createTitledBorder(ReCResourceBundle.findStringOrDefault("wpmaputo$jPanelPenduloDisplacement.border.title","Initial Displacement")));
        ...
        jSliderDisplacement.setToolTipText(ReCResourceBundle.findStringOrDefault("wpmaputo$jSliderDisplacement.toolTipText","Initial Displacement"));
        ...
        org.jdesktop.application.ResourceMap resourceMap = org.jdesktop.application.Application.getInstance().getContext().getResourceMap(WPMaputoCustomizerPanel.class);
        ...
        jSliderDisplacement.getAccessibleContext().setAccessibleName(ReCResourceBundle.findStringOrDefault("wpmaputo$jSliderDisplacement.toolTipText","Deslocamento"));
        jSliderDisplacement.getAccessibleContext().setAccessibleDescription(ReCResourceBundle.findStringOrDefault("wpmaputo$jSliderDisplacement.toolTipText","Deslocamento"));
        jFormattedTextFieldDisplacement.getAccessibleContext().setAccessibleDescription(ReCResourceBundle.findStringOrDefault("wpmaputo$jSliderDisplacement.toolTipText","Deslocamento"));

        jPanelNrPoints.setBorder(javax.swing.BorderFactory.createTitledBorder(ReCResourceBundle.findStringOrDefault("wpmaputo$jPanelNrPoints.border.title","Samples")));
        ...
        jSliderNrPoints.getAccessibleContext().setAccessibleDescription(ReCResourceBundle.findStringOrDefault("wpmaputo$jFormattedTextFieldNrPoints.toolTipText","Amostras"));
        jFormattedTextFieldNrPoints.getAccessibleContext().setAccessibleDescription(ReCResourceBundle.findStringOrDefault("wpmaputo$jFormattedTextFieldNrPoints.toolTipText","Amostras"));
        ...
        jPanelPenduloDisplacement.getAccessibleContext().setAccessibleName(ReCResourceBundle.findStringOrDefault("wpmaputo$jPanelPenduloDisplacement.border.title","Initial Displacement"));
        jPanelPenduloDisplacement.getAccessibleContext().setAccessibleDescription(ReCResourceBundle.findStringOrDefault("wpmaputo$jPanelPenduloDisplacement.border.title","Initial Displacement"));
        jPanelNrPoints.getAccessibleContext().setAccessibleName(ReCResourceBundle.findStringOrDefault("wpmaputo$jPanelNrPoints.border.title","Samples"));
        jPanelNrPoints.getAccessibleContext().setAccessibleDescription(ReCResourceBundle.findStringOrDefault("wpmaputo$jPanelNrPoints.border.title","Samples"));
        jLabelEstimatedTime.getAccessibleContext().setAccessibleName(ReCResourceBundle.findStringOrDefault("wpmaputo$jLabelEstimatedTime.text","Tempo Estimado"));
        jLabelEstimatedTime.getAccessibleContext().setAccessibleDescription(ReCResourceBundle.findStringOrDefault("wpmaputo$jLabelEstimatedTime.text","Tempo Estimado"));

        jTabbedPaneWPMaputo.addTab(ReCResourceBundle.findStringOrDefault("wpmaputo$jPanelPendulumConfig.TabConstraints.tabTitle","Configure"), null, jPanelPendulumConfig, resourceMap.getString("jPanelPendulumConfig.TabConstraints.tabToolTip")); // NOI18N

        add(jTabbedPaneWPMaputo, java.awt.BorderLayout.CENTER);
        jTabbedPaneWPMaputo.getAccessibleContext().setAccessibleName(ReCResourceBundle.findStringOrDefault("wpmaputo$jPanelPendulumConfig.TabConstraints.tabTitle","Configure"));
        ...
        jButtonCancel.setText(ReCResourceBundle.findStringOrDefault("wpmaputo$Cancel.label","Cancel"));
        ...
        jButtonDefaultConfig.setText(ReCResourceBundle.findStringOrDefault("wpmaputo$DefaultConfig.label","Default Config"));
        ...
        jButtonCancel.getAccessibleContext().setAccessibleName(ReCResourceBundle.findStringOrDefault("wpmaputo$jButtonCancel.AccessibleContext.accessibleName","Cancel"));
        jButtonDefaultConfig.getAccessibleContext().setAccessibleName(ReCResourceBundle.findStringOrDefault("wpmaputo$jButtonDefaultConfig.AccessibleContext.accessibleName","Default Config"));

        add(jPanelControlButtons, java.awt.BorderLayout.PAGE_END);
    }// </editor-fold>//GEN-END:initComponents

private void jTabbedPaneWPMaputoStateChanged(javax.swing.event.ChangeEvent evt) {//GEN-FIRST:event_jTabbedPaneWPMaputoStateChanged
    validateScreen();
}//GEN-LAST:event_jTabbedPaneWPMaputoStateChanged
...
private void jFormattedTextFieldNrPointsFocusLost(java.awt.event.FocusEvent evt) {//GEN-FIRST:event_jFormattedTextFieldNrPointsFocusLost
	...
	private void jButtonOkActionPerformed(final java.awt.event.ActionEvent evt) {// GEN-FIRST:event_jButtonOkActionPerformed
		...
		Frequency freq = null;                
            ...
            final int time = (int) Math.ceil((WPMaputoCustomizerPanel.PERIOD * nsamples*(1.1) / nsamples));
            ...
            getAcquisitionConfig().getSelectedHardwareParameter("wpmaputo$parameter.displacement").setParameterValue(String.valueOf(displacement));
            getAcquisitionConfig().getSelectedHardwareParameter("wpmaputo$parameter.nrpoints").setParameterValue(String.valueOf(nsamples));        
    ...
    private javax.swing.JTabbedPane jTabbedPaneWPMaputo;
	...
	public void setHardwareAcquisitionConfig(final HardwareAcquisitionConfig acqConfig) {
		super.setHardwareAcquisitionConfig(acqConfig);
                ...
                if (acqConfig != null) {
			System.out.println("WPMaputoCustomizer.setHardwareAcquisitionConfig(HardwareAcquisitionConfig  acqConfig)");
	...
	public javax.swing.ImageIcon getCustomizerIcon() {
		return new javax.swing.ImageIcon(getClass().getResource(
				"/pt/utl/ist/elab/client/wpmaputo/resources/wpmaputo_iconified.gif"));
	}

	@Override
	public String getCustomizerTitle() {
		return ReCResourceBundle.findStringOrDefault("wpmaputo$rec.exp.wpmaputo.customizer.title","wpmaputo$rec.exp.wpmaputo.customizer.title");
	}
