...
public class Tiro extends DrawingPanel3D implements ActionListener, MouseListener {
	...
	private String actionStr = java.util.ResourceBundle.getBundle(
			"pt/utl/ist/elab/virtual/client/tiro/resources/ReCExpTiro").getString(
	...
	public void buildTiro() {
		setToolTipText(java.util.ResourceBundle.getBundle("pt/utl/ist/elab/virtual/client/tiro/resources/ReCExpTiro")
	...
	private void buildPopupMenu() {
		...
		viewPopMenu.addItem(java.util.ResourceBundle.getBundle(
				"pt/utl/ist/elab/virtual/client/tiro/resources/ReCExpTiro").getString("rec.exp.displays.save"),
				java.util.ResourceBundle.getBundle("pt/utl/ist/elab/virtual/client/tiro/resources/ReCExpTiro")
						.getString("rec.exp.displays.save.tip"));
		viewPopMenu.addItem(java.util.ResourceBundle.getBundle(
				"pt/utl/ist/elab/virtual/client/tiro/resources/ReCExpTiro").getString("rec.exp.displays.print"),
				java.util.ResourceBundle.getBundle("pt/utl/ist/elab/virtual/client/tiro/resources/ReCExpTiro")
	...
	public void doSaveAs() throws IOException {
		...
		org.jfree.ui.ExtensionFileFilter filter = new org.jfree.ui.ExtensionFileFilter(java.util.ResourceBundle
				.getBundle("pt/utl/ist/elab/virtual/client/tiro/resources/ReCExpTiro").getString("PNG_Image_Files"),
				".png");
