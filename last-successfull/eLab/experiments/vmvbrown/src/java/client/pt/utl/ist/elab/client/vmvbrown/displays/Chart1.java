...
public class Chart1 extends com.linkare.rec.impl.ui.graph.DefaultXYExperimentGraph {
	...
	// TESTE
	/*
	 * public void start(){ setLayout(new java.awt.GridBagLayout());
	 * java.awt.GridBagConstraints gridBagConstraints; gridBagConstraints = new
	 ...
	 * 
	 * removeAll(); add(chart, gridBagConstraints); updateUI();
	 * 
	 * MvBrownDataProducer mv = new
	 * MvBrownDataProducer(null,200,(byte)3,getWidth
	 * (),getHeight(),false,false,1,500); mv.initializeGraphs(new
	 * String[]{"x vs y","t vs | v |^2","| r | vs t","y vs t"}, new
	 * boolean[]{false,false,true,false}); mv.initializeGenPosGraph(true, true,
	 * true, true, false, false, false); mv.initializeLangevin(1,new
	 * double[]{0.1,0.01},new double[]{0.1,0.25},new double[]{0,0,0},false);
	 * mv.startChart(chart); } else { String name = "t vs | r |";
	 * 
