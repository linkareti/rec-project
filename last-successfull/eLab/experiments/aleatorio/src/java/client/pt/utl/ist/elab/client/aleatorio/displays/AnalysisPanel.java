...
public class AnalysisPanel extends javax.swing.JPanel implements java.lang.Cloneable {
	...
	public java.awt.Image houghCount() {
		...
		java.awt.image.MemoryImageSource mis = new java.awt.image.MemoryImageSource(imageWidth, imageHeight,
	...
	public java.awt.Image convolutionTransform() {
		...
		java.awt.image.PixelGrabber pg = new java.awt.image.PixelGrabber(BWImage, 0, 0, imageWidth, imageHeight,
				inPixels, 0, imageWidth);
		try {
			pg.grabPixels();
		} catch (InterruptedException e) {
	...
	public java.awt.Image convolutionCount() {
		...
		/*
		 * int indice; for(int index = 0; index < convolutionCenterCounter;
		 * index++) { indice = convolutionCircles[index][1] * imageWidth +
		 * convolutionCircles[index][0]; convolutionCountPixels[indice] =
		 * 0xffff00ff; try { convolutionCountPixels[indice - imageWidth - 1] =
		 * 0xffff00ff; }catch (ArrayIndexOutOfBoundsException e){} try {
		 * convolutionCountPixels[indice - imageWidth + 1] = 0xffff00ff; }catch
		 * (ArrayIndexOutOfBoundsException e){} try {
		 * convolutionCountPixels[indice + imageWidth - 1] = 0xffff00ff; }catch
		 * (ArrayIndexOutOfBoundsException e){} try {
		 * convolutionCountPixels[indice + imageWidth + 1] = 0xffff00ff; }catch
		 * (ArrayIndexOutOfBoundsException e){} } //Builds the final image
		 * java.awt.image.MemoryImageSource mis = new
		 * java.awt.image.MemoryImageSource
		 * (imageWidth,imageHeight,convolutionCountPixels,0,imageWidth);
