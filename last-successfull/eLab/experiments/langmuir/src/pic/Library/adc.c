...
void configure_adc(){	// ADC 10-bits
...
//****************************//
	...
	ADCON1bits.SIMSAM=1;	//Samples CH0 and CH1 simultaneously
...
//****************************//
	...
	ADCON2bits.CHPS = 0b01; //Converts CH0 and CH1
	//_CHPS=0b01;		//Converts CH0 and CH1
...
//****************************//
	_SAMC=20;		//**Auto Sample Time bits**//
					// (0-31) Tad
	...
	_ADCS=19;		//**A/D Conversion Clock Select bits**//
					// (1-64)*Tcy/2
...
//******************************//
	...
	_CH0SA=2;		//Channel 0 positive input is AN2
...
//*************************************//
	...
	ADPCFG = 0xFFF3; // all PORTB = Digital; AN3 and AN4 analog input
...
//*************************************//
	...
	ADCSSL = 0x000C; //Samples AN3 and AN4	~
