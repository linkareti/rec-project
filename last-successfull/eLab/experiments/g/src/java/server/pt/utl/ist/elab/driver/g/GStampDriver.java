...
import pt.utl.ist.elab.driver.g.translators.StampConfigTranslator;
...
public class GStampDriver extends AbstractStampDriver {
	...
	public void configure(HardwareAcquisitionConfig config, HardwareInfo info) throws WrongConfigurationException {
		...
		stampConfig.addCommandData(StampConfigTranslator.POWER_STR, new Integer(Defaults.defaultIfEmpty(config
				.getSelectedHardwareParameterValue(StampConfigTranslator.POWER_STR), info
				.getHardwareParameterValue(StampConfigTranslator.POWER_STR))));
	...
	public Object getHardwareInfo() {
		...
		String baseHardwareInfoFile = "recresource://pt/utl/ist/elab/driver/g/GBaseHardwareInfo.xml";
	...
	protected void loadExtraCommandHandlers() {
		...
		StampTranslatorProcessorManager.initStampProcessorsTranslators(new String[] {
				packageName + "processors.StampGProcessor", packageName + "translators.StampConfigTranslator", });
	}
