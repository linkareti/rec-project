...
/*
 * WPPlanetariumCustomizerPanel.java
 *
...
import pt.utl.ist.elab.client.wpplanetarium.WPPlanetariumCustomizerPanel;
 ...
 * @author npadriano
 */
public class WPPlanetariumCustomizerPanel extends AbstractCustomizer {
	...
	public static final float PERIOD = 3.3f;
        ...
        /** Creates new form WPPlanetariumCustomizerPanel */
	public WPPlanetariumCustomizerPanel() {
		labelBegin = ReCResourceBundle.findStringOrDefault("wpplanetarium$jLabelEstimatedTime.text.beggining","Estimated time is");
                labelEnd = ReCResourceBundle.findStringOrDefault("wpplanetarium$jLabelEstimatedTime.text.end","minutes");
    ...
    private void initComponents() {
        ...
        jTabbedPaneWPPlanetarium = new javax.swing.JTabbedPane();
        ...
        setName("WPPlanetariumCustomizer"); // NOI18N
        setPreferredSize(new java.awt.Dimension(350, 350));
        setRequestFocusEnabled(false);
        setLayout(new java.awt.BorderLayout());

        jTabbedPaneWPPlanetarium.setName("jTabbedPaneWPPlanetarium"); // NOI18N
        jTabbedPaneWPPlanetarium.addChangeListener(new javax.swing.event.ChangeListener() {
            public void stateChanged(javax.swing.event.ChangeEvent evt) {
                jTabbedPaneWPPlanetariumStateChanged(evt);
            }
        });
        ...
        jPanelPenduloDisplacement.setBorder(javax.swing.BorderFactory.createTitledBorder(ReCResourceBundle.findStringOrDefault("wpplanetarium$jPanelPenduloDisplacement.border.title","Initial Displacement")));
        ...
        jSliderDisplacement.setToolTipText(ReCResourceBundle.findStringOrDefault("wpplanetarium$jSliderDisplacement.toolTipText","Initial Displacement"));
        ...
        org.jdesktop.application.ResourceMap resourceMap = org.jdesktop.application.Application.getInstance().getContext().getResourceMap(WPPlanetariumCustomizerPanel.class);
        ...
        jSliderDisplacement.getAccessibleContext().setAccessibleName(ReCResourceBundle.findStringOrDefault("wpplanetarium$jSliderDisplacement.toolTipText","Deslocamento"));
        jSliderDisplacement.getAccessibleContext().setAccessibleDescription(ReCResourceBundle.findStringOrDefault("wpplanetarium$jSliderDisplacement.toolTipText","Deslocamento"));
        jFormattedTextFieldDisplacement.getAccessibleContext().setAccessibleDescription(ReCResourceBundle.findStringOrDefault("wpplanetarium$jSliderDisplacement.toolTipText","Deslocamento"));

        jPanelNrPoints.setBorder(javax.swing.BorderFactory.createTitledBorder(ReCResourceBundle.findStringOrDefault("wpplanetarium$jPanelNrPoints.border.title","Samples")));
        ...
        jSliderNrPoints.getAccessibleContext().setAccessibleDescription(ReCResourceBundle.findStringOrDefault("wpplanetarium$jFormattedTextFieldNrPoints.toolTipText","Amostras"));
        jFormattedTextFieldNrPoints.getAccessibleContext().setAccessibleDescription(ReCResourceBundle.findStringOrDefault("wpplanetarium$jFormattedTextFieldNrPoints.toolTipText","Amostras"));
        ...
        jPanelPenduloDisplacement.getAccessibleContext().setAccessibleName(ReCResourceBundle.findStringOrDefault("wpplanetarium$jPanelPenduloDisplacement.border.title","Initial Displacement"));
        jPanelPenduloDisplacement.getAccessibleContext().setAccessibleDescription(ReCResourceBundle.findStringOrDefault("wpplanetarium$jPanelPenduloDisplacement.border.title","Initial Displacement"));
        jPanelNrPoints.getAccessibleContext().setAccessibleName(ReCResourceBundle.findStringOrDefault("wpplanetarium$jPanelNrPoints.border.title","Samples"));
        jPanelNrPoints.getAccessibleContext().setAccessibleDescription(ReCResourceBundle.findStringOrDefault("wpplanetarium$jPanelNrPoints.border.title","Samples"));
        jLabelEstimatedTime.getAccessibleContext().setAccessibleName(ReCResourceBundle.findStringOrDefault("wpplanetarium$jLabelEstimatedTime.text","Tempo Estimado"));
        jLabelEstimatedTime.getAccessibleContext().setAccessibleDescription(ReCResourceBundle.findStringOrDefault("wpplanetarium$jLabelEstimatedTime.text","Tempo Estimado"));

        jTabbedPaneWPPlanetarium.addTab(ReCResourceBundle.findStringOrDefault("wpplanetarium$jPanelPendulumConfig.TabConstraints.tabTitle","Configure"), null, jPanelPendulumConfig, resourceMap.getString("jPanelPendulumConfig.TabConstraints.tabToolTip")); // NOI18N

        add(jTabbedPaneWPPlanetarium, java.awt.BorderLayout.CENTER);
        jTabbedPaneWPPlanetarium.getAccessibleContext().setAccessibleName(ReCResourceBundle.findStringOrDefault("wpplanetarium$jPanelPendulumConfig.TabConstraints.tabTitle","Configure"));
        ...
        jButtonCancel.setText(ReCResourceBundle.findStringOrDefault("wpplanetarium$Cancel.label","Cancel"));
        ...
        jButtonDefaultConfig.setText(ReCResourceBundle.findStringOrDefault("wpplanetarium$DefaultConfig.label","Default Config"));
        ...
        jButtonCancel.getAccessibleContext().setAccessibleName(ReCResourceBundle.findStringOrDefault("wpplanetarium$jButtonCancel.AccessibleContext.accessibleName","Cancel"));
        jButtonDefaultConfig.getAccessibleContext().setAccessibleName(ReCResourceBundle.findStringOrDefault("wpplanetarium$jButtonDefaultConfig.AccessibleContext.accessibleName","Default Config"));

        add(jPanelControlButtons, java.awt.BorderLayout.PAGE_END);
    }// </editor-fold>//GEN-END:initComponents

private void jTabbedPaneWPPlanetariumStateChanged(javax.swing.event.ChangeEvent evt) {//GEN-FIRST:event_jTabbedPaneWPPlanetariumStateChanged
    validateScreen();
}//GEN-LAST:event_jTabbedPaneWPPlanetariumStateChanged
...
private void jFormattedTextFieldNrPointsFocusLost(java.awt.event.FocusEvent evt) {//GEN-FIRST:event_jFormattedTextFieldNrPointsFocusLost
	...
	private void jButtonOkActionPerformed(final java.awt.event.ActionEvent evt) {// GEN-FIRST:event_jButtonOkActionPerformed
		...
		Frequency freq = null;                
            ...
            final int time = (int) Math.ceil((WPPlanetariumCustomizerPanel.PERIOD * nsamples*(1.1) / nsamples));
            ...
            getAcquisitionConfig().getSelectedHardwareParameter("wpplanetarium$parameter.displacement").setParameterValue(String.valueOf(displacement));
            getAcquisitionConfig().getSelectedHardwareParameter("wpplanetarium$parameter.nrpoints").setParameterValue(String.valueOf(nsamples));        
    ...
    private javax.swing.JTabbedPane jTabbedPaneWPPlanetarium;
	...
	public void setHardwareAcquisitionConfig(final HardwareAcquisitionConfig acqConfig) {
		super.setHardwareAcquisitionConfig(acqConfig);
                ...
                if (acqConfig != null) {
			System.out.println("WPPlanetariumCustomizer.setHardwareAcquisitionConfig(HardwareAcquisitionConfig  acqConfig)");
	...
	public javax.swing.ImageIcon getCustomizerIcon() {
		return new javax.swing.ImageIcon(getClass().getResource(
				"/pt/utl/ist/elab/client/wpplanetarium/resources/wpplanetarium_iconified.gif"));
	}

	@Override
	public String getCustomizerTitle() {
		return ReCResourceBundle.findStringOrDefault("wpplanetarium$rec.exp.wpplanetarium.customizer.title","wpplanetarium$rec.exp.wpplanetarium.customizer.title");
	}
