		...
		try {
			eventSets[EVENT_apparatusConnectorListener] = new EventSetDescriptor(
					...
					com.linkare.rec.impl.client.apparatus.ApparatusConnectorListener.class, new String[] {
							...
							"apparatusDisconnecting", "apparatusIncorrectState", "apparatusLockable",
							"apparatusLocked", "apparatusMaxUsers", "apparatusNotAuthorized", "apparatusNotOwner",
							"apparatusNotRegistered", "apparatusStateConfigError", "apparatusStateConfigured",
							"apparatusStateConfiguring", "apparatusStateReseted", "apparatusStateReseting",
