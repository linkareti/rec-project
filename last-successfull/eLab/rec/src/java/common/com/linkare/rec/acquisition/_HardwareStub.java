...
public class _HardwareStub extends org.omg.CORBA.portable.ObjectImpl implements com.linkare.rec.acquisition.Hardware {
	...
	public com.linkare.rec.data.metadata.HardwareInfo getHardwareInfo() {
		...
		try {
			...
			$in = _invoke($out);
			com.linkare.rec.data.metadata.HardwareInfo $result = com.linkare.rec.data.metadata.HardwareInfoHelper
					.read($in);
			return $result;
	...
	public com.linkare.rec.acquisition.HardwareState getHardwareState() {
		...
		try {
			...
			$in = _invoke($out);
			com.linkare.rec.acquisition.HardwareState $result = com.linkare.rec.acquisition.HardwareStateHelper
					.read($in);
			return $result;
		} catch (org.omg.CORBA.portable.ApplicationException $ex) {
			$in = $ex.getInputStream();
