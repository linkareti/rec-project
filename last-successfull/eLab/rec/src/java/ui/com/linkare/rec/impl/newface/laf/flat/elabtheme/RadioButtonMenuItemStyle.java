...
public class RadioButtonMenuItemStyle extends DefaultStyle {
	...
	protected String defineStyleId() {
		return RadioButtonMenuItemStyle.ID;
	}
	...
	public void updatePropertyMap(final Map<String, Object> map) {
		...
		map.put(AbstractStyle.FOREGROUND, RadioButtonMenuItemStyle.COLOR_MENU_ITEM_FG);
		map.put(AbstractStyle.BACKGROUND, RadioButtonMenuItemStyle.COLOR_MENU_ITEM_BG);
		map.put(RadioButtonMenuItemStyle.PT_MENU_SELECTION_FG, RadioButtonMenuItemStyle.COLOR_MENU_ITEM_BG);
		map.put(RadioButtonMenuItemStyle.PT_MENU_SELECTION_BG, RadioButtonMenuItemStyle.PT_MENU_SELECTION_FG);
		map.put(AbstractStyle.FONT, RadioButtonMenuItemStyle.FONT_MENU);
		map.put(RadioButtonMenuItemStyle.PT_FONT_ACCELERATOR, RadioButtonMenuItemStyle.FONT_MENU);
		map.put(RadioButtonMenuItemStyle.PT_MENU_ACCELERATOR_FG, RadioButtonMenuItemStyle.COLOR_MENU_ACCELERATOR_FG);
	}
