...
package com.linkare.rec.impl.ui.display;
 ...
 */
public class SensorDisplay extends javax.swing.JPanel implements com.linkare.rec.impl.client.experiment.ExpDataDisplay,
		ExpDataModelListener, java.io.Externalizable {
	 ...
	 * os.writeObject(getForeground()); os.writeObject(getBackground());
	 * os.writeObject(icon); os.writeUTF(getName());
	 * os.writeInt(getChannelIndexDisplay()); }
	 * 
	 * public void readObject(ObjectInputStream is) throws IOException { try {
	 * setForeground((Color)is.readObject()); }catch(ClassNotFoundException e) {
	 * } try { setBackground((Color)is.readObject());
	 * }catch(ClassNotFoundException e) { } try {
	 * setIcon((Icon)is.readObject()); }catch(ClassNotFoundException e) { }
	 * setName(is.readUTF()); setChannelIndexDisplay(is.readInt()); }
	 */
