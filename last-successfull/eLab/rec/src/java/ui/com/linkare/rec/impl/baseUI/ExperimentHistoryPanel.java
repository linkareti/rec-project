...
public class ExperimentHistoryPanel extends javax.swing.JPanel {
	...
	private static final String EXP_STR = ReCResourceBundle.findStringOrDefault("ReCBaseUI$rec.bui.lbl.experiment",
			"Experiment");
	private static final String CONFIRM_STR = ReCResourceBundle.findStringOrDefault(
	...
	public ExperimentHistoryPanel(ExpHistoryPanelNew panelExp, ExpHistoryUINode value) {
		...
		if (value.isLocallyOwned()) {
			...
			// "Current experiment is owned by me... Should appear in color: "+UIManager.getColor("Table.focusCellBackground"));
			setOpaque(true);
	...
	private void initComponents()// GEN-BEGIN:initComponents
	{
		...
		setOpaque(false);
		lblCount.setIcon(ReCResourceBundle.findImageIconOrDefault("ReCBaseUI$rec.bui.icon.apparatus", new ImageIcon(
				getClass().getResource("/com/linkare/rec/impl/baseUI/resources/hcontrol16.gif"))));
		lblCount.setText("1.");
		add(lblCount);

		btnExpInfo.setIcon(ReCResourceBundle.findImageIconOrDefault("ReCBaseUI$rec.bui.icon.hwInfo", new ImageIcon(
				getClass().getResource("/com/linkare/rec/impl/baseUI/resources/hwinfo16.gif"))));
		btnExpInfo.setToolTipText(ReCResourceBundle.findStringOrDefault("ReCBaseUI$rec.bui.tip.infoData",
		...
		btnExpPlay.setIcon(ReCResourceBundle.findImageIconOrDefault("ReCBaseUI$rec.bui.icon.openExp", new ImageIcon(
				getClass().getResource("/com/linkare/rec/impl/baseUI/resources/openExperiment16.gif"))));
		btnExpPlay.setToolTipText(ReCResourceBundle.findStringOrDefault("ReCBaseUI$rec.bui.tip.downloadData",
		...
		btnExpDelete.setIcon(ReCResourceBundle.findImageIconOrDefault("ReCBaseUI$rec.bui.icon.delete", new ImageIcon(
				getClass().getResource("/com/linkare/rec/impl/baseUI/resources/Delete16.gif"))));
		btnExpDelete.setToolTipText(ReCResourceBundle.findStringOrDefault("ReCBaseUI$rec.bui.tip.deleteData",
