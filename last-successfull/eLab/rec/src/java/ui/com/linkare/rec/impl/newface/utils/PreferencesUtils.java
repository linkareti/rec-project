...
public class PreferencesUtils {
	 ...
	 * 
	 * @param key
	 * @return A string containing the value of the property for the given key.
	 *         If there is not a user preference for the given key, null is
	 *         returned instead.
	 */
	public static String readUserPreference(final String key) {
	 ...
	 * 
	 * @param key The key name of the preference to save.
	 * @param value The new value to set the given key.
	 */
	public static void writeUserPreference(final String key, final String value) {
		...
		try {
			...
			PreferencesUtils.log.severe("Error writing preference " + key + "with value " + value + ": "
					+ e.getMessage());
		}
	}
	...
	public static void removeUserPreference(final String key) {
		...
		try {
			...
			PreferencesUtils.log.severe("Error removing preference " + key + ": " + e.getMessage());
		}
	}
}
