...
set PROCESSINGMANAGER_SYSPROPS=-DReC.MultiCast.ProcessingManager.MinThreadPool.Coresize=@rec.processingmanager.minthreadpool.coresize@ -DReC.MultiCast.ProcessingManager.MinThreadPool.Maxsize=@rec.processingmanager.minthreadpool.maxsize@ -DReC.MultiCast.ProcessingManager.MediumThreadPool.Coresize=@rec.processingmanager.mediumthreadpool.coresize@ -DReC.MultiCast.ProcessingManager.MediumThreadPool.Maxsize=@rec.processingmanager.mediumthreadpool.maxsize@ -DReC.MultiCast.ProcessingManager.MaxThreadPool.Coresize=@rec.processingmanager.maxthreadpool.coresize@ -DReC.MultiCast.ProcessingManager.MaxThreadPool.Maxsize=@rec.processingmanager.maxthreadpool.maxsize@ -DReC.MultiCast.ProcessingManager.Thread.Idletime=@rec.processingmanager.thread.idletime@
...
set REPOSITORY_SYSPROPS="-DReC.MultiCast.Repository=@rec.experiment.repository@"
...
java %BOOTCLASSPATH% -classpath %RECCLASSPATH%;%MULTICAST_CLASSPATH% %GENERIC_ORB_SYSPROPS% %SECURITYMANAGER_SYSPROPS% %SECURITYMANAGER_TIMES_SYSPROPS% %ALLOCATIONMANAGER_SYSPROPS% %PROCESSINGMANAGER_SYSPROPS% %JMX_SYSPROPS% %REPOSITORY_SYSPROPS% %MULTICAST_ORB_SYSPROPS% %LOG_SYSPROPS% %MEM_SYSPROPS% %TOOLKIT_SYSPROPS% %DEBUG% com.linkare.rec.impl.multicast.startup.MultiCastControllerMain
