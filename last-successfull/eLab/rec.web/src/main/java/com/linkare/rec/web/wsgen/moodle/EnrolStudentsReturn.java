...
public class EnrolStudentsReturn  implements java.io.Serializable {
    private com.linkare.rec.web.wsgen.moodle.EnrolRecord[] students;

    public EnrolStudentsReturn() {
    }

    public EnrolStudentsReturn(
           com.linkare.rec.web.wsgen.moodle.EnrolRecord[] students) {
     ...
     * @return students
     */
    public com.linkare.rec.web.wsgen.moodle.EnrolRecord[] getStudents() {
        return students;
    }
     ...
     * @param students
     */
    public void setStudents(com.linkare.rec.web.wsgen.moodle.EnrolRecord[] students) {
        this.students = students;
    }
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("http://elab.ist.utl.pt/moodle/wspp/wsdl", "enrolStudentsReturn"));
        org.apache.axis.description.ElementDesc elemField = new org.apache.axis.description.ElementDesc();
        elemField.setFieldName("students");
        elemField.setXmlName(new javax.xml.namespace.QName("", "students"));
        elemField.setXmlType(new javax.xml.namespace.QName("http://elab.ist.utl.pt/moodle/wspp/wsdl", "enrolRecord"));
