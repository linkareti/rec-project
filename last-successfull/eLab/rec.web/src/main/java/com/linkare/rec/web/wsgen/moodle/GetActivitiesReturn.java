...
public class GetActivitiesReturn  implements java.io.Serializable {
    private com.linkare.rec.web.wsgen.moodle.ActivityRecord[] activities;

    public GetActivitiesReturn() {
    }

    public GetActivitiesReturn(
           com.linkare.rec.web.wsgen.moodle.ActivityRecord[] activities) {
     ...
     * @return activities
     */
    public com.linkare.rec.web.wsgen.moodle.ActivityRecord[] getActivities() {
        return activities;
    }
     ...
     * @param activities
     */
    public void setActivities(com.linkare.rec.web.wsgen.moodle.ActivityRecord[] activities) {
        this.activities = activities;
    }
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("http://elab.ist.utl.pt/moodle/wspp/wsdl", "getActivitiesReturn"));
        org.apache.axis.description.ElementDesc elemField = new org.apache.axis.description.ElementDesc();
        elemField.setFieldName("activities");
        elemField.setXmlName(new javax.xml.namespace.QName("", "activities"));
        elemField.setXmlType(new javax.xml.namespace.QName("http://elab.ist.utl.pt/moodle/wspp/wsdl", "activityRecord"));
