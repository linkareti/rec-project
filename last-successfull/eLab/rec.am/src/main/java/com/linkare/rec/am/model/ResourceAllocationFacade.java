...
public class ResourceAllocationFacade implements ResourceAllocationFacadeInterface {
    ...
    @Override
    public final List<String> getReservations(String laboratory, String experimentName, Date startDate, Date endDate) throws BusinessException {
    ...
    private void validaDados(String laboratory, String experiment, Date startDate, Date endDate) throws BusinessException {
