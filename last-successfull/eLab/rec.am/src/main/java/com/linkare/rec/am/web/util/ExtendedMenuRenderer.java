...
/**
 * Extended menu renderer which renders the 'optionClasses' attribute above the standard menu renderer. To use it, define it as follows in the render-kit tag of
 * faces-config.xml.
 * 
 * <pre>
 * &lt;renderer&gt;
 ...
 * </pre>
 * 
 * And define the 'optionClasses' attribute as a f:attribute of the h:selectOneMenu or h:selectManyMenu as follows:
 * 
 * <pre>
 * &lt;f:attribute name="optionClasses" value="option1,option2,option3" /&gt;
 * </pre>
 * 
 * It accepts a comma separated string of CSS class names which are to be applied on the options repeatedly (the same way as you use rowClasses in h:dataTable).
 * The optionClasses will be rendered only if there is no 'disabledClass' or 'enabledClass' being set as an attribute.
 * 
 * @author BalusC
...
public class ExtendedMenuRenderer extends MenuRenderer {
    ...
    /**
     * @see com.sun.faces.renderkit.html_basic.MenuRenderer#renderOption(javax.faces.context.FacesContext, javax.faces.component.UIComponent,
     *      javax.faces.convert.Converter, javax.faces.model.SelectItem, java.lang.Object, java.lang.Object[])
     */
    protected final void renderOption(FacesContext context, UIComponent component, Converter converter, SelectItem currentItem, Object currentSelections,
