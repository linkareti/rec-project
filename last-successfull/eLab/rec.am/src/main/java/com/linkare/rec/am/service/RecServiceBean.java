...
public class RecServiceBean implements  RecServiceRemote{
    ...
    @Override
      public List<BadWordDTO> getBadWordRegexByLocale(String locale) throws RemoteException {
        ...
        final List<BadWord> badWords = entityManager.createNamedQuery(BadWord.FIND_FOR_LOCALE_QUERYNAME)
                                                           .setParameter(BadWord.QUERY_PARAM_LOCALE,locale).getResultList();
