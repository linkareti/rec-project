...
public class UserDatum  implements java.io.Serializable {
    ...
    public synchronized boolean equals(java.lang.Object obj) {
        if (!(obj instanceof UserDatum)) return false;
        UserDatum other = (UserDatum) obj;
        ...
        _equals = true && 
            ...
            ((this.passwordmd5==null && other.getPasswordmd5()==null) || 
             (this.passwordmd5!=null &&
              this.passwordmd5.equals(other.getPasswordmd5()))) &&
    ...
    public synchronized int hashCode() {
        ...
        if (getPasswordmd5() != null) {
            _hashCode += getPasswordmd5().hashCode();
        }
        if (getIdnumber() != null) {
    ...
    private static org.apache.axis.description.TypeDesc typeDesc =
        new org.apache.axis.description.TypeDesc(UserDatum.class, true);

    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("http://localhost/moodle/wspp/wsdl", "userDatum"));
        ...
        typeDesc.addFieldDesc(elemField);
        elemField = new org.apache.axis.description.ElementDesc();
        elemField.setFieldName("passwordmd5");
        elemField.setXmlName(new javax.xml.namespace.QName("", "passwordmd5"));
        elemField.setXmlType(new javax.xml.namespace.QName("http://www.w3.org/2001/XMLSchema", "string"));
        elemField.setNillable(false);
        typeDesc.addFieldDesc(elemField);
        elemField = new org.apache.axis.description.ElementDesc();
