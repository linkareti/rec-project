...
public class GetResourcesReturn  implements java.io.Serializable {
    private com.linkare.rec.am.wsgen.moodle.ResourceRecord[] resources;

    public GetResourcesReturn() {
    }

    public GetResourcesReturn(
           com.linkare.rec.am.wsgen.moodle.ResourceRecord[] resources) {
     ...
     * @return resources
     */
    public com.linkare.rec.am.wsgen.moodle.ResourceRecord[] getResources() {
        return resources;
    }
     ...
     * @param resources
     */
    public void setResources(com.linkare.rec.am.wsgen.moodle.ResourceRecord[] resources) {
        this.resources = resources;
    }
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("http://localhost/moodle/wspp/wsdl", "getResourcesReturn"));
        org.apache.axis.description.ElementDesc elemField = new org.apache.axis.description.ElementDesc();
        elemField.setFieldName("resources");
        elemField.setXmlName(new javax.xml.namespace.QName("", "resources"));
        elemField.setXmlType(new javax.xml.namespace.QName("http://localhost/moodle/wspp/wsdl", "resourceRecord"));
