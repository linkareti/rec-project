...
/** A classe QMethods disponibiliza uma serie de metodos para facilitar a utilizacao do Java.
...
public class QMethods {
	...
	/** Arredonda um dado numero com as casas decimais desejadas.
	  ...
	  * <pre> QMethods.arredondar(double a, int x); </pre>
    ...
    /** Arredonda um dado numero com as casas decimais desejadas.
	  * O numero e' arredondado 'a x-esima casa.
	  * <pre> QMethods.arredondar(float a, int x); </pre>
	  * Devolve um float que e' o float <i>a</i> fornecido arredondado a <i>x</i> casas.
  	  * @param a numero a arredondar.
      * @param x numero de casas desejadas.
      * @return O numero a arredondado as casas desejadas.
	  */
    ...
    /** Arredonda um dado numero a 0 casas decimais, ou seja, ao inteiro mais proximo.
	  * O numero e' arredondado ao inteiro mais proximo.
	  * <pre> QMethods.arredondarInt(double a); </pre>
	  * Devolve um int que e' o double <i>a</i> fornecido arredondado 'as 0 casas decimais, ou seja, ao inteiro mais proximo.
  	  * @param a numero a arredondar.
