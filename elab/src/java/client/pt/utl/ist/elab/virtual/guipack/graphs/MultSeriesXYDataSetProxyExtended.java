 ...
 * @author  Andre
 */
public class MultSeriesXYDataSetProxyExtended extends org.jfree.data.general.AbstractDataset implements org.jfree.data.xy.XYDataset, com.linkare.rec.impl.client.experiment.ExpDataModelListener
{
    ...
    public MultSeriesXYDataSetProxyExtended(GraphSamplesFunction function)
    {
        func = function;
    }
