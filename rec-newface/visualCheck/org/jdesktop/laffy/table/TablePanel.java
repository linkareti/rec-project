...
public class TablePanel extends OptionsSettablePanel {
	...
	jTable1.setModel(new javax.swing.table.DefaultTableModel(
		new Object[][] {
			/*
			 * {new Integer(234523), "Rupert", new Double(253.23), null}, {new Integer(392923), "Clara", new
			 * Double(-98.78), new Boolean(true)}, {new Integer(811233), "Nick", new Double(-88.45), new
			 * Boolean(true)}
			 */
			...
			I18nResourceHandler.getMessage("ID"), I18nResourceHandler.getMessage("Name"),
			I18nResourceHandler.getMessage("Balance"), I18nResourceHandler.getMessage("Boolean") }) {
	...
	{ new Integer(234523), I18nResourceHandler.getMessage("Rupert"), new Double(253.23) },
		...
		//"ID", "Name", "Balance"
		I18nResourceHandler.getMessage("ID"), I18nResourceHandler.getMessage("Name"),
		I18nResourceHandler.getMessage("Balance") }) {
	    Class[] types = new Class[] { java.lang.Integer.class, java.lang.String.class, java.lang.Double.class };
