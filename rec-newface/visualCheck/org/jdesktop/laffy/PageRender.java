...
public class PageRender {
     ...
     *
     * @param pages        The list of pages to create previews for
     * @param splashWindow The splash window to use as a parent for the CellRendererPane and to update with progress
     */
    public void loadPages(List<Page> pages, final SplashWindow splashWindow) {
        try {
            ...
            for (int i = 0; i < pages.size(); i++) {
                final Page page = (Page) pages.get(i);
    ...
    private BufferedImage scaleDown(BufferedImage src) {
        ...
        BufferedImage img =
                GraphicsUtilities.createCompatibleTranslucentImage(src.getWidth() >> 1, src.getHeight() >> 1);
