...
public class OptionPanePageFactory {
    ...
    private static final String message = I18nResourceHandler.getMessage("_This_is_a_long_message_that_you_coild_put_in_a_option_pane_dialog.");
    /*
     private static final String htmlMessage = I18nResourceHandler.getMessage("HTML_H2_Html_Header_H2_This_is_a_long_message_that_you_") +
            I18nResourceHandler.getMessage("coild_put_in_a_option_pane_dialog._BR_It_is_written_using_HTML_so_it_can_have_mutiple_lines_and_") +
    ...
    public static Page createPage() {
        ...
        DialogSection info = new DialogSection(I18nResourceHandler.getMessage("Info_Message")) {
            protected void showDialog() {
                JOptionPane.showMessageDialog(Laffy.getInstance().getFrame(), message, getName(),
                        JOptionPane.INFORMATION_MESSAGE);
            }

            protected JComponent getDialogContent() {
                JOptionPane optionPane =
                        new JOptionPane(message, JOptionPane.INFORMATION_MESSAGE, JOptionPane.OK_OPTION);
                return optionPane;
            }
        };
        ...
        DialogSection confirm = new DialogSection(I18nResourceHandler.getMessage("Confirm")) {
            ...
            protected JComponent getDialogContent() {
                JOptionPane optionPane =
                        new JOptionPane(message, JOptionPane.QUESTION_MESSAGE, JOptionPane.YES_NO_CANCEL_OPTION);
                return optionPane;
            }
        };
        ...
        DialogSection choiceInput = new DialogSection(I18nResourceHandler.getMessage("Choice_Input")) {
            protected void showDialog() {
                JOptionPane.showInputDialog(Laffy.getInstance().getFrame(), message,
                        getName(), JOptionPane.QUESTION_MESSAGE, null,
                        /*
                        new Object[]{
                                "Option A", "Option B", "Option C", "Option D", "Option E", "Option F"
                         */
                        new Object[]{
                                I18nResourceHandler.getMessage("Option_A"), I18nResourceHandler.getMessage("Option_B"), I18nResourceHandler.getMessage("Option_C"), I18nResourceHandler.getMessage("Option_D"), I18nResourceHandler.getMessage("Option_E"), I18nResourceHandler.getMessage("Option_F")
                        }, null);
            }
        ...
        DialogSection warning = new DialogSection(I18nResourceHandler.getMessage("Warning_Message")) {
            protected void showDialog() {
                 JOptionPane.showMessageDialog(Laffy.getInstance().getFrame(), htmlMessage, getName(),
                        JOptionPane.WARNING_MESSAGE);
            }

            protected JComponent getDialogContent() {
                JOptionPane optionPane =
                        new JOptionPane(htmlMessage, JOptionPane.WARNING_MESSAGE, JOptionPane.DEFAULT_OPTION);
                return optionPane;
            }
        };
        ...
        DialogSection error = new DialogSection(I18nResourceHandler.getMessage("Error_Message_with_custom_content")) {
            protected void showDialog() {
                ...
                JOptionPane.showOptionDialog(Laffy.getInstance().getFrame(), panel, getName(),
