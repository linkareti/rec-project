...
public class OptionPanePageFactory {
    ...
    private static final String waitMessage = I18nResourceHandler
	    .getMessage("Its_a_slow_day_this_may_takee_a_while....");
	...
	DialogSection choiceInput = new DialogSection(I18nResourceHandler.getMessage("Choice_Input")) {
	    protected void showDialog() {
		JOptionPane.showInputDialog(Laffy.getInstance().getFrame(), message, getName(),
			JOptionPane.QUESTION_MESSAGE, null,
			/*
			 * new Object[]{ "Option A", "Option B", "Option C", "Option D", "Option E", "Option F"
			 */
			new Object[] { I18nResourceHandler.getMessage("Option_A"),
				I18nResourceHandler.getMessage("Option_B"), I18nResourceHandler.getMessage("Option_C"),
				I18nResourceHandler.getMessage("Option_D"), I18nResourceHandler.getMessage("Option_E"),
				I18nResourceHandler.getMessage("Option_F") }, null);
	    }
	...
	DialogSection warning = new DialogSection(I18nResourceHandler.getMessage("Warning_Message")) {
	    ...
	    protected JComponent getDialogContent() {
		JOptionPane optionPane = new JOptionPane(htmlMessage, JOptionPane.WARNING_MESSAGE,
	...
	DialogSection error = new DialogSection(I18nResourceHandler.getMessage("Error_Message_with_custom_content")) {
		...
		JOptionPane.showOptionDialog(Laffy.getInstance().getFrame(), panel, getName(),
			...
			null, new Object[] { I18nResourceHandler.getMessage("Cancel") }, I18nResourceHandler
				.getMessage("Cancel"));
	    }
	...
	return new Page(I18nResourceHandler.getMessage("Option_Panes"), info, confirm, input, choiceInput, warning,
		error);
    }
