...
public class InternalFramesPanel extends JPanel {
	...
	JInternalFrame controlsFrame = new JInternalFrame(I18nResourceHandler.getMessage("Controls"), false, false,
		true, true);
	...
	JInternalFrame frame1 = new JInternalFrame(I18nResourceHandler.getMessage("Frame_") + index, true, true, true,
		true);
	desktop.add(frame1);
	...
	JToolBar toolBar = new JToolBar(
		(toolBarSide == BorderLayout.EAST || toolBarSide == BorderLayout.WEST) ? JToolBar.VERTICAL
			: JToolBar.HORIZONTAL);
