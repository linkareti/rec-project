...
public class ComboPanel extends OptionsSettablePanel {
	...
	jComboBox1.setModel(new javax.swing.DefaultComboBoxModel(new String[] {
		...
		I18nResourceHandler.getMessage("Item_3"), I18nResourceHandler.getMessage("Item_4") }));
	gridBagConstraints = new java.awt.GridBagConstraints();
	gridBagConstraints.gridx = 1;
	gridBagConstraints.gridy = 3;
	...
	smallIconComboBox.setModel(new javax.swing.DefaultComboBoxModel(new String[] {
		I18nResourceHandler.getMessage("Item_1"), I18nResourceHandler.getMessage("Item_2"),
		I18nResourceHandler.getMessage("Item_3"), I18nResourceHandler.getMessage("Item_4") }));
	gridBagConstraints = new java.awt.GridBagConstraints();
	gridBagConstraints.gridx = 1;
	...
	largeIconComboBox.setModel(new javax.swing.DefaultComboBoxModel(new String[] {
		I18nResourceHandler.getMessage("Item_1"), I18nResourceHandler.getMessage("Item_2"),
		I18nResourceHandler.getMessage("Item_3"), I18nResourceHandler.getMessage("Item_4") }));
	gridBagConstraints = new java.awt.GridBagConstraints();
	gridBagConstraints.gridx = 1;
