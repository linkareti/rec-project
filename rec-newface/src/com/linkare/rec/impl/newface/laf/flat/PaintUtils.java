...
public class PaintUtils {
    ...
    public static void tileStretchPaint(Graphics g,
        ...
        g2d.clipRect(pos.x - left, pos.y - top, 
        		pos.x + comp.getWidth() + right, pos.y + comp.getHeight() + bottom);
        ...
        g2d.drawImage(img,
                pos.x, pos.y - top,
                pos.x + comp.getWidth(), pos.y,
                left, 0,
                img.getWidth() - right, top,
                null);
        g2d.drawImage(img,
                pos.x + comp.getWidth(), pos.y - top,
                pos.x + comp.getWidth() + right, pos.y,
        ...
        g2d.drawImage(img,
                pos.x + comp.getWidth(), pos.y,
                pos.x + comp.getWidth() + right, pos.y + comp.getHeight(),
                img.getWidth() - right, top,
        ...
        // bottom
        g2d.drawImage(img,
                pos.x - left, pos.y + comp.getHeight(),
                pos.x, pos.y + comp.getHeight() + bottom,
                0, img.getHeight() - bottom,
                left, img.getHeight(),
                null);
        g2d.drawImage(img,
                pos.x, pos.y + comp.getHeight(),
                pos.x + comp.getWidth(), pos.y + comp.getHeight() + bottom,
                left, img.getHeight() - bottom,
                img.getWidth() - right, img.getHeight(),
                null);
        g2d.drawImage(img,
                pos.x + comp.getWidth(), pos.y + comp.getHeight(),
                pos.x + comp.getWidth() + right, pos.y + comp.getHeight() + bottom,
                img.getWidth() - right, img.getHeight() - bottom,
