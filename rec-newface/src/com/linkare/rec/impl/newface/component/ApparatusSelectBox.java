...
public class ApparatusSelectBox extends AbstractContentPane {
	...
	public void toggleApparatusStateActionData(boolean connected) {
		...
		javax.swing.Action toggleApparatusStateAction = getContext().getActionMap(ReCApplication.class, getRecApplication()).get(
		...
		toggleApparatusStateAction.putValue(javax.swing.Action.SHORT_DESCRIPTION, getContext().getResourceMap().getString(
				"toggleApparatusState" + (connected ? "" : "Disconnect") + ".Action.shortDescription"));
	...
	private void initComponents() {
		...
		lblChooseApparatus.setFont(lblChooseApparatus.getFont()
				.deriveFont(lblChooseApparatus.getFont().getStyle() | java.awt.Font.BOLD, 11));
		org.jdesktop.application.ResourceMap resourceMap = org.jdesktop.application.Application.getInstance(
				com.linkare.rec.impl.newface.ReCApplication.class).getContext().getResourceMap(ApparatusSelectBox.class);
		...
		javax.swing.ActionMap actionMap = org.jdesktop.application.Application.getInstance(
				com.linkare.rec.impl.newface.ReCApplication.class).getContext().getActionMap(ApparatusSelectBox.class, this);
		...
		layout.setHorizontalGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING).addGroup(
				layout.createSequentialGroup().addContainerGap().addGroup(
						layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING).addComponent(apparatusCombo,
								javax.swing.GroupLayout.DEFAULT_SIZE, 236, Short.MAX_VALUE).addComponent(lblChooseApparatus).addGroup(
								layout.createSequentialGroup().addComponent(btnToggleEnter, javax.swing.GroupLayout.PREFERRED_SIZE,
		...
		layout.setVerticalGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING).addGroup(
				layout.createSequentialGroup().addContainerGap().addComponent(lblChooseApparatus).addPreferredGap(
						...
						.addGroup(
								layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false).addComponent(progressCicle,
