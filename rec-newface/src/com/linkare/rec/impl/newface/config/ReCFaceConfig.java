...
public class ReCFaceConfig extends AbstractConfigBean {
	...
	if ((this.aboutPageLocationBundleKey == null) ? (other.aboutPageLocationBundleKey != null)
		: !this.aboutPageLocationBundleKey.equals(other.aboutPageLocationBundleKey)) {
	    return false;
	}
	if ((this.splashIconLocationBundleKey == null) ? (other.splashIconLocationBundleKey != null)
		: !this.splashIconLocationBundleKey.equals(other.splashIconLocationBundleKey)) {
	    return false;
	}
	...
	if ((this.iconSponsorLocationBundleKey == null) ? (other.iconSponsorLocationBundleKey != null)
		: !this.iconSponsorLocationBundleKey.equals(other.iconSponsorLocationBundleKey)) {
	    return false;
	}
	if ((this.helpPageLocationBundleKey == null) ? (other.helpPageLocationBundleKey != null)
		: !this.helpPageLocationBundleKey.equals(other.helpPageLocationBundleKey)) {
	    return false;
	}
	//Delete
	...
	if (this.localizationBundleList != other.localizationBundleList
		&& (this.localizationBundleList == null || !this.localizationBundleList
	...
	hash = 59 * hash
		+ (this.iconSponsorLocationBundleKey != null ? this.iconSponsorLocationBundleKey.hashCode() : 0);
