...
//TODO  falta rever o que esta comentado

package pt.utl.ist.elab.driver.condensador.translators;
...
public class StampConfigTranslator extends AbstractStampTranslator {
	...
	public boolean translate(StampCommand command) {
		...
		// int dt =
		// ((Integer)command.getCommandData(FREQ_INTERBAL_STR)).intValue();

		// TODO actualizar valores máximos e mínimos
		...
		/*
		 * String dtStr=""+(dt-1); while(dtStr.length()<4) dtStr="0"+dtStr;
		 */
