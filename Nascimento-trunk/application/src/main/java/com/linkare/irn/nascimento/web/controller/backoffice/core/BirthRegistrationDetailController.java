...
public class BirthRegistrationDetailController extends BaseProtectedController
	...
	public String civilRegistrationOfficeAcceptSubmission() {
		try {
			birthRegistrationService.civilRegistrationOfficeAcceptBirthRegistration(getBirthRegistration());
			JsfUtils.addGlobalInfoMessage(
	...
	public String civilRegistrationOfficeEffectuateSubmission() {
		try {
			birthRegistrationService.civilRegistrationOfficeEffectuateBirthRegistration(getBirthRegistration());
			JsfUtils.addGlobalInfoMessage(
	...
	public String civilRegistrationOfficeRejectSubmission() {
		try {
			birthRegistrationService.civilRegistrationOfficeRejectBirthRegistration(getBirthRegistration());
			JsfUtils.addGlobalInfoMessage(
