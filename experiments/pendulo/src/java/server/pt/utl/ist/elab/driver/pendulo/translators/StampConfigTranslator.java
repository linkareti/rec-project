...
package pt.utl.ist.elab.driver.pendulo.translators;
...
public class StampConfigTranslator extends AbstractStampTranslator {
	...
	public boolean translate(final StampCommand command) {
		...
		final int height = ((Integer) command.getCommandData(StampConfigTranslator.HEIGHT_INIT_STR)).intValue();
		int teta = ((Integer) command.getCommandData(StampConfigTranslator.TETA_INIT_STR)).intValue();
		final int freq = ((Integer) command.getCommandData(StampConfigTranslator.FREQ_INTERBAL_STR)).intValue();
		...
		String status = (String) command.getCommandData(StampConfigTranslator.FRICTION_STR);
