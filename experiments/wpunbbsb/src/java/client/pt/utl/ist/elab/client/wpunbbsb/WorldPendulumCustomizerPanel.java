...
public class WorldPendulumCustomizerPanel extends AbstractCustomizer {
	...
	public WorldPendulumCustomizerPanel() {
		labelBegin = ReCResourceBundle.findStringOrDefault("wpunbbsb$jLabelEstimatedTime.text.beggining","Estimated time is");
                labelEnd = ReCResourceBundle.findStringOrDefault("wpunbbsb$jLabelEstimatedTime.text.end","minutes");
    ...
    private void initComponents() {
        ...
        jPanelPenduloDisplacement.setBorder(javax.swing.BorderFactory.createTitledBorder(ReCResourceBundle.findStringOrDefault("wpunbbsb$jPanelPenduloDisplacement.border.title","Initial Displacement")));
        ...
        jSliderDisplacement.setToolTipText(ReCResourceBundle.findStringOrDefault("wpunbbsb$jSliderDisplacement.toolTipText","Initial Displacement"));
        ...
        jSliderDisplacement.getAccessibleContext().setAccessibleName(ReCResourceBundle.findStringOrDefault("wpunbbsb$jSliderDisplacement.toolTipText","Deslocamento"));
        jSliderDisplacement.getAccessibleContext().setAccessibleDescription(ReCResourceBundle.findStringOrDefault("wpunbbsb$jSliderDisplacement.toolTipText","Deslocamento"));
        jFormattedTextFieldDisplacement.getAccessibleContext().setAccessibleDescription(ReCResourceBundle.findStringOrDefault("wpunbbsb$jSliderDisplacement.toolTipText","Deslocamento"));

        jPanelNrPoints.setBorder(javax.swing.BorderFactory.createTitledBorder(ReCResourceBundle.findStringOrDefault("wpunbbsb$jPanelNrPoints.border.title","Samples")));
        ...
        jSliderNrPoints.getAccessibleContext().setAccessibleDescription(ReCResourceBundle.findStringOrDefault("wpunbbsb$jFormattedTextFieldNrPoints.toolTipText","Amostras"));
        jFormattedTextFieldNrPoints.getAccessibleContext().setAccessibleDescription(ReCResourceBundle.findStringOrDefault("wpunbbsb$jFormattedTextFieldNrPoints.toolTipText","Amostras"));
        ...
        jPanelPenduloDisplacement.getAccessibleContext().setAccessibleName(ReCResourceBundle.findStringOrDefault("wpunbbsb$jPanelPenduloDisplacement.border.title","Initial Displacement"));
        jPanelPenduloDisplacement.getAccessibleContext().setAccessibleDescription(ReCResourceBundle.findStringOrDefault("wpunbbsb$jPanelPenduloDisplacement.border.title","Initial Displacement"));
        jPanelNrPoints.getAccessibleContext().setAccessibleName(ReCResourceBundle.findStringOrDefault("wpunbbsb$jPanelNrPoints.border.title","Samples"));
        jPanelNrPoints.getAccessibleContext().setAccessibleDescription(ReCResourceBundle.findStringOrDefault("wpunbbsb$jPanelNrPoints.border.title","Samples"));
        jLabelEstimatedTime.getAccessibleContext().setAccessibleName(ReCResourceBundle.findStringOrDefault("wpunbbsb$jLabelEstimatedTime.text","Tempo Estimado"));
        jLabelEstimatedTime.getAccessibleContext().setAccessibleDescription(ReCResourceBundle.findStringOrDefault("wpunbbsb$jLabelEstimatedTime.text","Tempo Estimado"));

        jTabbedPaneWorldPendulum.addTab(ReCResourceBundle.findStringOrDefault("wpunbbsb$jPanelPendulumConfig.TabConstraints.tabTitle","Configure"), null, jPanelPendulumConfig, resourceMap.getString("jPanelPendulumConfig.TabConstraints.tabToolTip")); // NOI18N

        add(jTabbedPaneWorldPendulum, java.awt.BorderLayout.CENTER);
        jTabbedPaneWorldPendulum.getAccessibleContext().setAccessibleName(ReCResourceBundle.findStringOrDefault("wpunbbsb$jPanelPendulumConfig.TabConstraints.tabTitle","Configure"));
        ...
        jButtonCancel.setText(ReCResourceBundle.findStringOrDefault("wpunbbsb$Cancel.label","Cancel"));
        ...
        jButtonDefaultConfig.setText(ReCResourceBundle.findStringOrDefault("wpunbbsb$DefaultConfig.label","Default Config"));
        ...
        jButtonCancel.getAccessibleContext().setAccessibleName(ReCResourceBundle.findStringOrDefault("wpunbbsb$jButtonCancel.AccessibleContext.accessibleName","Cancel"));
        jButtonDefaultConfig.getAccessibleContext().setAccessibleName(ReCResourceBundle.findStringOrDefault("wpunbbsb$jButtonDefaultConfig.AccessibleContext.accessibleName","Default Config"));
...
private void jFormattedTextFieldNrPointsFocusLost(java.awt.event.FocusEvent evt) {//GEN-FIRST:event_jFormattedTextFieldNrPointsFocusLost
	...
	private void jButtonOkActionPerformed(final java.awt.event.ActionEvent evt) {// GEN-FIRST:event_jButtonOkActionPerformed
		...
		Frequency freq = null;                
            ...
            getAcquisitionConfig().getSelectedHardwareParameter("wpunbbsb$parameter.displacement").setParameterValue(String.valueOf(displacement));
            getAcquisitionConfig().getSelectedHardwareParameter("wpunbbsb$parameter.nrpoints").setParameterValue(String.valueOf(nsamples));        
	...
	public javax.swing.ImageIcon getCustomizerIcon() {
		return new javax.swing.ImageIcon(getClass().getResource(
				"/pt/utl/ist/elab/client/wpunbbsb/resources/wpunbbsb_iconified.gif"));
	}

	@Override
	public String getCustomizerTitle() {
		return ReCResourceBundle.findStringOrDefault("wpunbbsb$rec.exp.wpunbbsb.customizer.title","wpunbbsb$rec.exp.wpunbbsb.customizer.title");
	}
