...
public class Esquerda extends pt.utl.ist.elab.client.webrobot.customizer.Comps.Block {
	 ...
	 * 
	 */
	private static final long serialVersionUID = -1229883199646565195L;
	...
	private String text;
	private final String fullNameDescription = "Roda a esquerda";
	...
	public Esquerda(final pt.utl.ist.elab.client.webrobot.customizer.Models.ModelEsquerda model) {
		super();
		setCancel(false);
	...
	public void setDataModel(final pt.utl.ist.elab.client.webrobot.customizer.Models.ModelEsquerda model) {
		this.model = model;
	}
