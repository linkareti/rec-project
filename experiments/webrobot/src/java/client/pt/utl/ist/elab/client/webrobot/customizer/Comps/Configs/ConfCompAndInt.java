...
public class ConfCompAndInt extends javax.swing.JDialog {
    ...
    public ConfCompAndInt(java.awt.Frame parent, boolean modal, pt.utl.ist.elab.client.webrobot.customizer.Models.ModelCompAndInt model) 
    {
        super(parent, modal);
        this.model = model;
        initComponents();
    ...
    private void initComponents() {//GEN-BEGIN:initComponents
        ...
        jPanelOpts.setMinimumSize(new java.awt.Dimension(320, 57));
        jPanelOpts.setPreferredSize(new java.awt.Dimension(320, 57));
        jComboBoxD1.setForeground(new java.awt.Color(51, 0, 102));
        jComboBoxD1.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "A1", "A2", "A3", "A4", "I0", "I1", "I2", "I3", "I4", "I5", "I6", "I7", "V1", "V2", "V3", "V4", "V5" }));
        ...
        jComboBoxD2.setSelectedItem(model.getD2());
        ...
        jComboBoxD3.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "A1", "A2", "A3", "A4", "I0", "I1", "I2", "I3", "I4", "I5", "I6", "I7", "V1", "V2", "V3", "V4", "V5" }));
        ...
        jLabel1.setIcon(new javax.swing.ImageIcon(getClass().getResource("/pt/utl/ist/elab/client/webrobot/customizer/Comps/Icons/compAndInt.gif")));
    ...
    public static void main(String args[]) {
        new ConfCompAndInt(new javax.swing.JFrame(), true).show();
    }*/
    ...
    public pt.utl.ist.elab.client.webrobot.customizer.Models.ModelCompAndInt getModel()
    {
        return model;
    }
