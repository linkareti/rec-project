...
public class ConfCompBin extends javax.swing.JDialog {
	 ...
	 * 
	 */
	private static final long serialVersionUID = -1544112769671504196L;

	/** Creates new form ConfCompBin */
	public ConfCompBin(final java.awt.Frame parent, final boolean modal,
			final pt.utl.ist.elab.client.webrobot.customizer.Models.ModelCompBin model) {
		super(parent, modal);
		this.model = model;
		initComponents();
		readModel();
	 ...
	 * 
	 *            public static void main(String args[]) { new ConfCompBin(new
	...
	// My variables
	private final pt.utl.ist.elab.client.webrobot.customizer.Models.ModelCompBin model;
