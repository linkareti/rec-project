...
public class IRTableDisplay extends javax.swing.JPanel implements ExpDataDisplay {
	 ...
	 * 
	 */
	private static final long serialVersionUID = 2013033202761803717L;
	...
	private void iRTableModelProxyTableChanged(final javax.swing.event.TableModelEvent evt) {// GEN-FIRST:event_iRTableModelProxyTableChanged
	...
	public void saveTable(final java.io.File saveFile, final boolean append) {
		try {
			...
			fileWriter.write(ReCSystemProperty.LINE_SEPARATOR.getValue());
	...
	private final javax.swing.ImageIcon icon = new javax.swing.ImageIcon(getClass().getResource(
			"/pt/utl/ist/elab/client/webrobot/displays/resources/JTableIV16.gif"));
