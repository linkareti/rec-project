 ...
 * @author  Andr�
 */
public class ConfEsquerda extends javax.swing.JDialog {
    
    /** Creates new form ConfCompBin */
    public ConfEsquerda(java.awt.Frame parent, boolean modal, pt.utl.ist.elab.client.webrobot.customizer.Models.ModelEsquerda model)
    {
        super(parent, modal);
        this.model=model;
        initComponents();
    ...
    private void initComponents() {//GEN-BEGIN:initComponents
        ...
        setTitle("Roda esquerda durante(per\u00edodos x 0.25s)");
        setResizable(false);
        ...
        jPanelOpts.setMinimumSize(new java.awt.Dimension(295, 80));
        jPanelOpts.setPreferredSize(new java.awt.Dimension(295, 80));
        ...
        jLabel1.setIcon(new javax.swing.ImageIcon(getClass().getResource("/pt/utl/ist/elab/client/webrobot/customizer/Comps/Icons/esquerda.gif")));
    ...
    public static void main(String args[]) {
        new ConfEsquerda(new javax.swing.JFrame(), true).show();
    }*/
    ...
    public pt.utl.ist.elab.client.webrobot.customizer.Models.ModelEsquerda getModel()
    {
        return model;
    }
