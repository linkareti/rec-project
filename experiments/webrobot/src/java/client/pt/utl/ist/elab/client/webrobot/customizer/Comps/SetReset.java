...
public class SetReset extends pt.utl.ist.elab.client.webrobot.customizer.Comps.Block {
	 ...
	 * 
	 */
	private static final long serialVersionUID = -6028392268517687122L;
	...
	private String text;
	private final String fullNameDescription = "Set/Reset saida digital";
	...
	public SetReset(final pt.utl.ist.elab.client.webrobot.customizer.Models.ModelSetReset model) {
		super();
		setCancel(false);
	...
	public void setDataModel(final pt.utl.ist.elab.client.webrobot.customizer.Models.ModelSetReset model) {
		this.model = model;
	}
