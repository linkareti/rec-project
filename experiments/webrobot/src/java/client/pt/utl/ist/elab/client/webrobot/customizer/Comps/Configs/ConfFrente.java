...
public class ConfFrente extends javax.swing.JDialog {
	 ...
	 * 
	 */
	private static final long serialVersionUID = 3565217291106884644L;
	 ...
	 * @param model
	 */
	public ConfFrente(final java.awt.Frame parent, final boolean modal,
			final pt.utl.ist.elab.client.webrobot.customizer.Models.ModelFrente model) {
		super(parent, modal);
		this.model = model;
		initComponents();
		readModel();
	 ...
	 * 
	 *            public static void main(String args[]) { new ConfFrente(new
	...
	// My variables
	private final pt.utl.ist.elab.client.webrobot.customizer.Models.ModelFrente model;
