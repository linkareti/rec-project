...
public class ConfIVPWM extends javax.swing.JDialog {
    ...
    public ConfIVPWM(java.awt.Frame parent, boolean modal, pt.utl.ist.elab.client.webrobot.customizer.Models.ModelIVPWM model)
    {
        super(parent, modal);
        this.model=model;
        initComponents();
    ...
    private void initComponents() {//GEN-BEGIN:initComponents
        ...
        defaultTableModel.addTableModelListener(new pt.utl.ist.elab.client.webrobot.customizer.Utils.TableModelAdapter(){
            public void tableChanged(javax.swing.event.TableModelEvent evt){
                jTableChanged(evt);
            }
        });
        listSelectionModel.addListSelectionListener(new pt.utl.ist.elab.client.webrobot.customizer.Utils.ListSelectionAdapter(){
        ...
        jPanelSliders.setBorder(new javax.swing.border.TitledBorder(null, "N\u00edveis", javax.swing.border.TitledBorder.CENTER, javax.swing.border.TitledBorder.DEFAULT_POSITION, new java.awt.Font("Dialog", 0, 11), new java.awt.Color(51, 0, 102)));
        ...
        jLabel1.setIcon(new javax.swing.ImageIcon(getClass().getResource("/pt/utl/ist/elab/client/webrobot/customizer/Comps/Icons/ivpwm.gif")));
    ...
    private void jButtonNewElemMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jButtonNewElemMouseClicked
        ...
        confAddNewElement = new pt.utl.ist.elab.client.webrobot.customizer.Comps.Configs.ConfAddNewElement(this,true,jRadioButtonI0.isSelected(),
                                                                                jRadioButtonI1.isSelected(), jRadioButtonI2.isSelected(),
                                                                                jRadioButtonI3.isSelected(), jRadioButtonI4.isSelected(),
                                                                                jRadioButtonI5.isSelected(),jRadioButtonI6.isSelected(),
                                                                                jRadioButtonI7.isSelected(),send);
    ...
    public static void main(String args[]) {
        new ConfIVPWM(new javax.swing.JFrame(), true).show();
    }*/
    ...
    private void reOrderTable()
    {
         ...
         *Primeiro come�o por criar uma tabela com os valores binarios em decimal
         *e a escrevo ainda nessa tabela, para cada valor, a sua linha
         *depois ordeno essa tabela em fun��o dos valores
         *De seguida vou juntar estas novas linhas criadas ao fim da tabela original
         *e apago a tabela original...MUITO MAL EXPLICADO...MELHOR EXP:
         *5  linha 0
         *3  linha 1
         *4  linha 2
         *1  linha 3
         ...
         *4  linha 2
         *5  linha 0
         *� tabela � ent�o adicionada uma primeira linha com o valor 1, que vai buscar
         *� linha 3 da tabela antiga, a linha seguinte vai buscar � linha 1 antiga, depois linha 2 e linha 0
         *Agora que j� tenho uma nova tabela ordenada, apago a antiga*/
        ...
        for(int i=0; i<defaultTableModel.getRowCount(); i++)
        {
            ...
            orderTable[i][0]=new Integer(temp.substring(7,8)).intValue()*1+new Integer(temp.substring(6,7)).intValue()*2+new Integer(temp.substring(5,6)).intValue()*4+new Integer(temp.substring(4,5)).intValue()*8+new Integer(temp.substring(3,4)).intValue()*16+new Integer(temp.substring(2,3)).intValue()*32+new Integer(temp.substring(1,2)).intValue()*64+new Integer(temp.substring(0,1)).intValue()*128;
            orderTable[i][1]=i;
        }
    ...
    private javax.swing.event.ListSelectionEvent tempListEvt=null;//for double-click
