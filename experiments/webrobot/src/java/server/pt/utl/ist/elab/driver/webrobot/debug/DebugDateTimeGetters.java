...
public class DebugDateTimeGetters {
	...
	public DebugDateTimeGetters() {
		java.util.GregorianCalendar gst = new java.util.GregorianCalendar(2002, java.util.GregorianCalendar.DECEMBER,
				31);
	...
	public long getTotalMilis(com.linkare.rec.data.synch.DateTime start, com.linkare.rec.data.synch.DateTime current) {
		...
		short currentDay = getDayOfYear(current.getDate().getDay(), current.getDate().getMonth(), current.getDate()
				.getYear());
		...
		int currentLongTime = (currentYearTotalDays + currentDay - 1) * 24 * 3600 * 1000 + currentHour * 3600 * 1000
				+ currentMinute * 60 * 1000 + currentSecond * 1000 + currentMilis;
		int startLongTime = (startYearTotalDays + startDay - 1) * 24 * 3600 * 1000 + startHour * 3600 * 1000
