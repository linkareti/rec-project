...
public class WorldPendulumCustomizerPanel extends AbstractCustomizer {
    ...
    private void initComponents() {
        ...
        jTabbedPaneWorldPendulum.addTab(ReCResourceBundle.findStringOrDefault("wpilheus$jPanelPendulumConfig.TabConstraints.tabTitle","Configure"), null, jPanelPendulumConfig, resourceMap.getString("jPanelPendulumConfig.TabConstraints.tabToolTip")); // NOI18N

        add(jTabbedPaneWorldPendulum, java.awt.BorderLayout.CENTER);
        jTabbedPaneWorldPendulum.getAccessibleContext().setAccessibleName(ReCResourceBundle.findStringOrDefault("wpilheus$jPanelPendulumConfig.TabConstraints.tabTitle","Configure"));
