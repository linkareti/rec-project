...
public class Animation extends CartPole implements ExpDataDisplay, ExpDataModelListener {
    ...
    //TESTE
    /*public void start(){
        CartPoleDataProducer data = new CartPoleDataProducer(0,0,1e-3,0,new double[]{5e-4,2e-6},new double[]{1,1e-1},9.8,1,0,100,500);
        data.initializePID(0,0,0);
        data.initializeFailure(1,300,20,5);
        data.initializeSuccess(12, 5);
        data.start(this);
    }*/
    ...
    public void dataModelStartedNoData() {
        ...
        setXLimit(xMax);
        config(x,theta,xdot,thetadot,poleLength,mCart,mPole,action,Math.toRadians(Integer.parseInt(header.getSelectedHardwareParameterValue("sucAngle"))));
        measure();
    }
    ...
    public void newSamples(NewExpDataEvent evt) {
        for(int i=evt.getSamplesStartIndex(); i<=evt.getSamplesEndIndex(); i++) {
            //sample, canal
            if (model.getValueAt(i,0) != null && model.getValueAt(i,1) != null && model.getValueAt(i,2) != null && model.getValueAt(i,3) != null && model.getValueAt(i,4) != null && model.getValueAt(i,5) != null)
                move(model.getValueAt(i,0).getValue().getFloatValue(), model.getValueAt(i,1).getValue().getFloatValue(), model.getValueAt(i,2).getValue().getFloatValue(), model.getValueAt(i,3).getValue().getFloatValue(),model.getValueAt(i,5).getValue().getFloatValue(),model.getValueAt(i,4).getValue().getFloatValue());
            else if (model.getValueAt(i,6) != null)
                messageDialog(java.util.ResourceBundle.getBundle("pt/utl/ist/elab/virtual/client/cartpole/resources/ReCExpCartPole").getString("rec.exp.customizer.title.35"),
                java.util.ResourceBundle.getBundle("pt/utl/ist/elab/virtual/client/cartpole/resources/ReCExpCartPole").getString("rec.exp.displays.dialog.tip.3"),
                java.util.ResourceBundle.getBundle("pt/utl/ist/elab/virtual/client/cartpole/resources/ReCExpCartPole").getString("rec.exp.displays.dialog.title.3"),
                null,
                java.util.ResourceBundle.getBundle("pt/utl/ist/elab/virtual/client/cartpole/resources/ReCExpCartPole").getString("rec.exp.displays.dialog.title.1"),
                java.util.ResourceBundle.getBundle("pt/utl/ist/elab/virtual/client/cartpole/resources/ReCExpCartPole").getString("rec.exp.displays.dialog.tip.1"),
                java.util.ResourceBundle.getBundle("pt/utl/ist/elab/virtual/client/cartpole/resources/ReCExpCartPole").getString("rec.exp.displays.dialog.title.2"),
                java.util.ResourceBundle.getBundle("pt/utl/ist/elab/virtual/client/cartpole/resources/ReCExpCartPole").getString("rec.exp.displays.dialog.tip.2")
                );
            else if (model.getValueAt(i,7) != null)
                messageDialog(java.util.ResourceBundle.getBundle("pt/utl/ist/elab/virtual/client/cartpole/resources/ReCExpCartPole").getString("rec.exp.customizer.title.36"),
                java.util.ResourceBundle.getBundle("pt/utl/ist/elab/virtual/client/cartpole/resources/ReCExpCartPole").getString("rec.exp.displays.dialog.tip.4"),
                java.util.ResourceBundle.getBundle("pt/utl/ist/elab/virtual/client/cartpole/resources/ReCExpCartPole").getString("rec.exp.displays.dialog.title.3"),
                null,
                java.util.ResourceBundle.getBundle("pt/utl/ist/elab/virtual/client/cartpole/resources/ReCExpCartPole").getString("rec.exp.displays.dialog.title.1"),
                java.util.ResourceBundle.getBundle("pt/utl/ist/elab/virtual/client/cartpole/resources/ReCExpCartPole").getString("rec.exp.displays.dialog.tip.1"),
