...
public class QuantumCustomizer extends javax.swing.JPanel implements com.linkare.rec.impl.client.customizer.ICustomizer, InteractiveMenu {
    ...
    private void initComponents() {//GEN-BEGIN:initComponents
        ...
        okButton.setText(java.util.ResourceBundle.getBundle("pt/utl/ist/elab/virtual/client/quantum/resources/ReCExpQuantum").getString("rec.exp.customizer.title.ok"));
        okButton.setToolTipText(java.util.ResourceBundle.getBundle("pt/utl/ist/elab/virtual/client/quantum/resources/ReCExpQuantum").getString("rec.exp.customizer.tip.ok"));
        ...
        cancelButton.setText(java.util.ResourceBundle.getBundle("pt/utl/ist/elab/virtual/client/quantum/resources/ReCExpQuantum").getString("rec.exp.customizer.title.cancel"));
        cancelButton.setToolTipText(java.util.ResourceBundle.getBundle("pt/utl/ist/elab/virtual/client/quantum/resources/ReCExpQuantum").getString("rec.exp.customizer.tip.cancel"));
        ...
        defaultButton.setText(java.util.ResourceBundle.getBundle("pt/utl/ist/elab/virtual/client/quantum/resources/ReCExpQuantum").getString("rec.exp.customizer.title.dfc"));
        defaultButton.setToolTipText(java.util.ResourceBundle.getBundle("pt/utl/ist/elab/virtual/client/quantum/resources/ReCExpQuantum").getString("rec.exp.customizer.tip.dfc"));
        ...
        mainEditPanel.setBorder(new javax.swing.border.BevelBorder(javax.swing.border.BevelBorder.RAISED, new java.awt.Color(102, 102, 102), new java.awt.Color(102, 102, 102), new java.awt.Color(102, 102, 102), new java.awt.Color(102, 102, 102)));
        mainEditPanel.setToolTipText(java.util.ResourceBundle.getBundle("pt/utl/ist/elab/virtual/client/quantum/resources/ReCExpQuantum").getString("rec.exp.customizer.tip.22"));
        ...
        editLabel.setText(java.util.ResourceBundle.getBundle("pt/utl/ist/elab/virtual/client/quantum/resources/ReCExpQuantum").getString("rec.exp.customizer.title.23"));
        editLabel.setToolTipText(java.util.ResourceBundle.getBundle("pt/utl/ist/elab/virtual/client/quantum/resources/ReCExpQuantum").getString("rec.exp.customizer.tip.23"));
        ...
        vWidthPanel.setBorder(new javax.swing.border.TitledBorder(java.util.ResourceBundle.getBundle("pt/utl/ist/elab/virtual/client/quantum/resources/ReCExpQuantum").getString("rec.exp.customizer.title.29")));
        vWidthPanel.setToolTipText(java.util.ResourceBundle.getBundle("pt/utl/ist/elab/virtual/client/quantum/resources/ReCExpQuantum").getString("rec.exp.customizer.tip.29"));
        ...
        vWidthSlider.setToolTipText(java.util.ResourceBundle.getBundle("pt/utl/ist/elab/virtual/client/quantum/resources/ReCExpQuantum").getString("rec.exp.customizer.tip.29"));
        ...
        vWidthTextField.setToolTipText(java.util.ResourceBundle.getBundle("pt/utl/ist/elab/virtual/client/quantum/resources/ReCExpQuantum").getString("rec.exp.customizer.tip.29"));
        ...
        vFuncPanel.setBorder(new javax.swing.border.TitledBorder(java.util.ResourceBundle.getBundle("pt/utl/ist/elab/virtual/client/quantum/resources/ReCExpQuantum").getString("rec.exp.customizer.title.30")));
        vFuncPanel.setToolTipText(java.util.ResourceBundle.getBundle("pt/utl/ist/elab/virtual/client/quantum/resources/ReCExpQuantum").getString("rec.exp.customizer.tip.30"));
        ...
        vFuncTextField.setToolTipText(java.util.ResourceBundle.getBundle("pt/utl/ist/elab/virtual/client/quantum/resources/ReCExpQuantum").getString("rec.exp.customizer.tip.30"));
        ...
        avgVPanel.setBorder(new javax.swing.border.TitledBorder(java.util.ResourceBundle.getBundle("pt/utl/ist/elab/virtual/client/quantum/resources/ReCExpQuantum").getString("rec.exp.customizer.title.31")));
        avgVPanel.setToolTipText(java.util.ResourceBundle.getBundle("pt/utl/ist/elab/virtual/client/quantum/resources/ReCExpQuantum").getString("rec.exp.customizer.tip.31"));
        ...
        avgVCheckBox.setText(java.util.ResourceBundle.getBundle("pt/utl/ist/elab/virtual/client/quantum/resources/ReCExpQuantum").getString("rec.exp.customizer.title.31"));
        avgVCheckBox.setToolTipText(java.util.ResourceBundle.getBundle("pt/utl/ist/elab/virtual/client/quantum/resources/ReCExpQuantum").getString("rec.exp.customizer.tip.31"));
        ...
        addEditVButton.setText(java.util.ResourceBundle.getBundle("pt/utl/ist/elab/virtual/client/quantum/resources/ReCExpQuantum").getString("rec.exp.customizer.title.32"));
        addEditVButton.setToolTipText(java.util.ResourceBundle.getBundle("pt/utl/ist/elab/virtual/client/quantum/resources/ReCExpQuantum").getString("rec.exp.customizer.tip.32"));
        ...
        mainTabbedPane.addTab(java.util.ResourceBundle.getBundle("pt/utl/ist/elab/virtual/client/quantum/resources/ReCExpQuantum").getString("rec.exp.customizer.title.34"), mainEditPanel);

        electronPanel.setLayout(new java.awt.GridBagLayout());

        electronPanel.setBorder(new javax.swing.border.BevelBorder(javax.swing.border.BevelBorder.RAISED, new java.awt.Color(255, 204, 0), new java.awt.Color(255, 204, 0), new java.awt.Color(255, 204, 0), new java.awt.Color(255, 204, 0)));
        dX0Panel.setLayout(new java.awt.GridBagLayout());

        dX0Panel.setBorder(new javax.swing.border.TitledBorder(java.util.ResourceBundle.getBundle("pt/utl/ist/elab/virtual/client/quantum/resources/ReCExpQuantum").getString("rec.exp.customizer.title.1")));
        dX0Panel.setToolTipText(java.util.ResourceBundle.getBundle("pt/utl/ist/elab/virtual/client/quantum/resources/ReCExpQuantum").getString("rec.exp.customizer.tip.1"));
        ...
        dX0Slider.setToolTipText(java.util.ResourceBundle.getBundle("pt/utl/ist/elab/virtual/client/quantum/resources/ReCExpQuantum").getString("rec.exp.customizer.tip.1"));
        ...
        dX0TextField.setToolTipText(java.util.ResourceBundle.getBundle("pt/utl/ist/elab/virtual/client/quantum/resources/ReCExpQuantum").getString("rec.exp.customizer.tip.1"));
        ...
        nPanel.setBorder(new javax.swing.border.TitledBorder(java.util.ResourceBundle.getBundle("pt/utl/ist/elab/virtual/client/quantum/resources/ReCExpQuantum").getString("rec.exp.customizer.title.3")));
        nPanel.setToolTipText(java.util.ResourceBundle.getBundle("pt/utl/ist/elab/virtual/client/quantum/resources/ReCExpQuantum").getString("rec.exp.customizer.tip.3"));
        ...
        nSlider.setToolTipText(java.util.ResourceBundle.getBundle("pt/utl/ist/elab/virtual/client/quantum/resources/ReCExpQuantum").getString("rec.exp.customizer.tip.3"));
        nSlider.setValue(11);
        ...
        nTextField.setToolTipText(java.util.ResourceBundle.getBundle("pt/utl/ist/elab/virtual/client/quantum/resources/ReCExpQuantum").getString("rec.exp.customizer.tip.3"));
        ...
        deltaXPanel.setBorder(new javax.swing.border.TitledBorder(java.util.ResourceBundle.getBundle("pt/utl/ist/elab/virtual/client/quantum/resources/ReCExpQuantum").getString("rec.exp.customizer.title.2")));
        deltaXPanel.setToolTipText(java.util.ResourceBundle.getBundle("pt/utl/ist/elab/virtual/client/quantum/resources/ReCExpQuantum").getString("rec.exp.customizer.tip.2"));
        ...
        deltaXSlider.setToolTipText(java.util.ResourceBundle.getBundle("pt/utl/ist/elab/virtual/client/quantum/resources/ReCExpQuantum").getString("rec.exp.customizer.tip.2"));
        ...
        deltaXTextField.setToolTipText(java.util.ResourceBundle.getBundle("pt/utl/ist/elab/virtual/client/quantum/resources/ReCExpQuantum").getString("rec.exp.customizer.tip.2"));
        ...
        mainTabbedPane.addTab(java.util.ResourceBundle.getBundle("pt/utl/ist/elab/virtual/client/quantum/resources/ReCExpQuantum").getString("rec.exp.customizer.title.4"), null, electronPanel, java.util.ResourceBundle.getBundle("pt/utl/ist/elab/virtual/client/quantum/resources/ReCExpQuantum").getString("rec.exp.customizer.tip.4"));

        electronPanel2.setLayout(new java.awt.GridBagLayout());

        electronPanel2.setBorder(new javax.swing.border.BevelBorder(javax.swing.border.BevelBorder.RAISED, new java.awt.Color(255, 0, 0), new java.awt.Color(255, 0, 0), new java.awt.Color(255, 0, 0), new java.awt.Color(255, 0, 0)));
        ePanel.setLayout(new java.awt.GridBagLayout());

        ePanel.setBorder(new javax.swing.border.TitledBorder(java.util.ResourceBundle.getBundle("pt/utl/ist/elab/virtual/client/quantum/resources/ReCExpQuantum").getString("rec.exp.customizer.title.24")));
        ePanel.setToolTipText(java.util.ResourceBundle.getBundle("pt/utl/ist/elab/virtual/client/quantum/resources/ReCExpQuantum").getString("rec.exp.customizer.tip.24"));
        ...
        xESlider.setToolTipText(java.util.ResourceBundle.getBundle("pt/utl/ist/elab/virtual/client/quantum/resources/ReCExpQuantum").getString("rec.exp.customizer.tip.25"));
        xESlider.setValue(2);
        ...
        nESlider.setToolTipText(java.util.ResourceBundle.getBundle("pt/utl/ist/elab/virtual/client/quantum/resources/ReCExpQuantum").getString("rec.exp.customizer.tip.25"));
        nESlider.setValue(2);
        ...
        tolPanel.setBorder(new javax.swing.border.TitledBorder(java.util.ResourceBundle.getBundle("pt/utl/ist/elab/virtual/client/quantum/resources/ReCExpQuantum").getString("rec.exp.customizer.title.27")));
        tolPanel.setToolTipText(java.util.ResourceBundle.getBundle("pt/utl/ist/elab/virtual/client/quantum/resources/ReCExpQuantum").getString("rec.exp.customizer.tip.27"));
        ...
        tolSlider.setToolTipText(java.util.ResourceBundle.getBundle("pt/utl/ist/elab/virtual/client/quantum/resources/ReCExpQuantum").getString("rec.exp.customizer.tip.27"));
        ...
        tolTextField.setToolTipText(java.util.ResourceBundle.getBundle("pt/utl/ist/elab/virtual/client/quantum/resources/ReCExpQuantum").getString("rec.exp.customizer.tip.27"));
        ...
        dtPanel.setBorder(new javax.swing.border.TitledBorder(java.util.ResourceBundle.getBundle("pt/utl/ist/elab/virtual/client/quantum/resources/ReCExpQuantum").getString("rec.exp.customizer.title.25")));
        dtPanel.setToolTipText(java.util.ResourceBundle.getBundle("pt/utl/ist/elab/virtual/client/quantum/resources/ReCExpQuantum").getString("rec.exp.customizer.tip.25"));
        ...
        xDtSlider.setToolTipText(java.util.ResourceBundle.getBundle("pt/utl/ist/elab/virtual/client/quantum/resources/ReCExpQuantum").getString("rec.exp.customizer.tip.25"));
        ...
        nDtSlider.setToolTipText(java.util.ResourceBundle.getBundle("pt/utl/ist/elab/virtual/client/quantum/resources/ReCExpQuantum").getString("rec.exp.customizer.tip.25"));
        ...
        mainTabbedPane.addTab(java.util.ResourceBundle.getBundle("pt/utl/ist/elab/virtual/client/quantum/resources/ReCExpQuantum").getString("rec.exp.customizer.title.26"), null, electronPanel2, java.util.ResourceBundle.getBundle("pt/utl/ist/elab/virtual/client/quantum/resources/ReCExpQuantum").getString("rec.exp.customizer.tip.26"));

        simulSettingsPanel.setLayout(new java.awt.GridBagLayout());

        simulSettingsPanel.setBorder(new javax.swing.border.BevelBorder(javax.swing.border.BevelBorder.RAISED, new java.awt.Color(0, 102, 255), new java.awt.Color(0, 102, 255), new java.awt.Color(0, 102, 255), new java.awt.Color(0, 102, 255)));
        tbsPanel.setLayout(new java.awt.GridBagLayout());

        tbsPanel.setBorder(new javax.swing.border.TitledBorder(java.util.ResourceBundle.getBundle("pt/utl/ist/elab/virtual/client/quantum/resources/ReCExpQuantum").getString("rec.exp.customizer.title.tbs")));
        tbsPanel.setToolTipText(java.util.ResourceBundle.getBundle("pt/utl/ist/elab/virtual/client/quantum/resources/ReCExpQuantum").getString("rec.exp.customizer.tip.tbs"));
        ...
        xTbsSlider.setToolTipText(java.util.ResourceBundle.getBundle("pt/utl/ist/elab/virtual/client/quantum/resources/ReCExpQuantum").getString("rec.exp.customizer.tip.25"));
        ...
        nTbsSlider.setToolTipText(java.util.ResourceBundle.getBundle("pt/utl/ist/elab/virtual/client/quantum/resources/ReCExpQuantum").getString("rec.exp.customizer.tip.25"));
        ...
        samplesPanel.setBorder(new javax.swing.border.TitledBorder(java.util.ResourceBundle.getBundle("pt/utl/ist/elab/virtual/client/quantum/resources/ReCExpQuantum").getString("rec.exp.customizer.title.samples")));
        samplesPanel.setToolTipText(java.util.ResourceBundle.getBundle("pt/utl/ist/elab/virtual/client/quantum/resources/ReCExpQuantum").getString("rec.exp.customizer.tip.samples"));
        ...
        samplesSlider.setToolTipText(java.util.ResourceBundle.getBundle("pt/utl/ist/elab/virtual/client/quantum/resources/ReCExpQuantum").getString("rec.exp.customizer.tip.samples"));
        ...
        samplesTextField.setToolTipText(java.util.ResourceBundle.getBundle("pt/utl/ist/elab/virtual/client/quantum/resources/ReCExpQuantum").getString("rec.exp.customizer.tip.samples"));
        ...
        tunnelingCheckBox.setText(java.util.ResourceBundle.getBundle("pt/utl/ist/elab/virtual/client/quantum/resources/ReCExpQuantum").getString("rec.exp.customizer.title.37"));
        tunnelingCheckBox.setToolTipText(java.util.ResourceBundle.getBundle("pt/utl/ist/elab/virtual/client/quantum/resources/ReCExpQuantum").getString("rec.exp.customizer.tip.37"));
        compSettingsPanel.add(tunnelingCheckBox);

        wraparoundKSCheckBox.setText(java.util.ResourceBundle.getBundle("pt/utl/ist/elab/virtual/client/quantum/resources/ReCExpQuantum").getString("rec.exp.customizer.title.35"));
        wraparoundKSCheckBox.setToolTipText(java.util.ResourceBundle.getBundle("pt/utl/ist/elab/virtual/client/quantum/resources/ReCExpQuantum").getString("rec.exp.customizer.tip.35"));
        compSettingsPanel.add(wraparoundKSCheckBox);

        wraparoundXSCheckBox.setSelected(true);
        wraparoundXSCheckBox.setText(java.util.ResourceBundle.getBundle("pt/utl/ist/elab/virtual/client/quantum/resources/ReCExpQuantum").getString("rec.exp.customizer.title.36"));
        wraparoundXSCheckBox.setToolTipText(java.util.ResourceBundle.getBundle("pt/utl/ist/elab/virtual/client/quantum/resources/ReCExpQuantum").getString("rec.exp.customizer.tip.36"));
        ...
        mainTabbedPane.addTab(java.util.ResourceBundle.getBundle("pt/utl/ist/elab/virtual/client/quantum/resources/ReCExpQuantum").getString("rec.exp.customizer.title.5"), null, simulSettingsPanel, java.util.ResourceBundle.getBundle("pt/utl/ist/elab/virtual/client/quantum/resources/ReCExpQuantum").getString("rec.exp.customizer.tip.5"));
    ...
    private void vFuncTextFieldFocusLost(java.awt.event.FocusEvent evt) {//GEN-FIRST:event_vFuncTextFieldFocusLost
        try {
            ...
            repaint();
        } catch (org.opensourcephysics.numerics.ParserException e){vFuncTextField.setText("f(x) = 100");}
    ...
    private void addEditVButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_addEditVButtonActionPerformed
        quantum.addPotential(editPot.getX(),editPot.getWidth(),editPot.getFunction().substring(6,editPot.getFunction().length()),editPot.isEnabled(),editPot.isMedio());
    ...
    public void actionPerformed(java.awt.event.ActionEvent e) {
        if (e.getActionCommand().equalsIgnoreCase(java.util.ResourceBundle.getBundle("pt/utl/ist/elab/virtual/client/quantum/resources/ReCExpQuantum").getString("rec.exp.customizer.potentialMenu.title.3"))){
            if (editPot != null && editPot != quantum.getFocusOwner() && editPot.getHighLightColor() == java.awt.Color.BLUE)
                quantum.removePotential(editPot);
        ...
        else if (e.getActionCommand().equalsIgnoreCase(java.util.ResourceBundle.getBundle("pt/utl/ist/elab/virtual/client/quantum/resources/ReCExpQuantum").getString("rec.exp.customizer.potentialMenu.title.2"))){
        ...
        else if (e.getActionCommand().equalsIgnoreCase(java.util.ResourceBundle.getBundle("pt/utl/ist/elab/virtual/client/quantum/resources/ReCExpQuantum").getString("rec.exp.customizer.potentialMenu.title.1"))){
            if (editPot == null || editPot.getHighLightColor() != java.awt.Color.BLUE){
                editPot = new Potential(quantum.getMouseX(),5,"100",true,false,new java.awt.Color(0,0,.8f),java.awt.Color.BLUE);
    ...
    private void okButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_okButtonActionPerformed
        ...
        acqConfig.setSelectedFrequency(new Frequency((double)1,hardwareInfo.getHardwareFrequencies(0).getMinimumFrequency().getMultiplier(),hardwareInfo.getHardwareFrequencies(0).getMinimumFrequency().getFrequencyDefType()));
        ...
        acqConfig.getSelectedHardwareParameter("wraparoundKS").setParameterValue("" + (wraparoundKSCheckBox.isSelected()?1:0));
        acqConfig.getSelectedHardwareParameter("wraparoundXS").setParameterValue("" + (wraparoundXSCheckBox.isSelected()?1:0));
        acqConfig.getSelectedHardwareParameter("tunneling").setParameterValue("" + (tunnelingCheckBox.isSelected()?1:0));
    ...
    private void defaultButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_defaultButtonActionPerformed
        ...
        quantum.clearPotentials();
        quantum.configPotentials("0.0:4.0:f(x) = -cos(x)*5:false#5.0:5.0:f(x) = sin(x)*5:false#10.5:2.0:f(x) = exp(-x*25)+3:false#-3.0:2.0:f(x) = 210:false#-5.0:1.5:f(x) = x^3+4*x^2+5+cos(3*x):false",true);
        quantum.configGaussian(dX0Slider.getValue(),x0,Double.parseDouble(eLabel.getText()),nSlider.getValue(),deltaXSlider.getValue(),ComplexGaussian.DISPLAY_PROBABILITY,true);
    ...
    public void setHardwareAcquisitionConfig(HardwareAcquisitionConfig acqConfig) {
        ...
        if(acqConfig!=null) {
            ...
            wraparoundKSCheckBox.setSelected(acqConfig.getSelectedHardwareParameterValue("wraparoundKS").trim().equals("1")?true:false);
            wraparoundXSCheckBox.setSelected(acqConfig.getSelectedHardwareParameterValue("wraparoundXS").trim().equals("1")?true:false);
            tunnelingCheckBox.setSelected(acqConfig.getSelectedHardwareParameterValue("tunneling").trim().equals("1")?true:false);
    ...
    public javax.swing.ImageIcon getCustomizerIcon() {
        return new javax.swing.ImageIcon(getClass().getResource("/pt/utl/ist/elab/virtual/client/quantum/resources/quantum_iconified.PNG"));
    }
