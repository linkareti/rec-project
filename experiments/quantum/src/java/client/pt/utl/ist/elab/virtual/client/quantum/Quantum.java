...
public class Quantum extends InteractivePanel implements InteractiveMouseHandler, ActionListener {
    ...
    public Quantum(){
        ...
        gaussMenu.addCheckBoxItem(java.util.ResourceBundle.getBundle("pt/utl/ist/elab/virtual/client/quantum/resources/ReCExpQuantum").getString("rec.exp.customizer.gaussMenu.title.4"),java.util.ResourceBundle.getBundle("pt/utl/ist/elab/virtual/client/quantum/resources/ReCExpQuantum").getString("rec.exp.customizer.gaussMenu.tip.4"));
        gaussMenu.addItem(java.util.ResourceBundle.getBundle("pt/utl/ist/elab/virtual/client/quantum/resources/ReCExpQuantum").getString("rec.exp.customizer.gaussMenu.title.5"),java.util.ResourceBundle.getBundle("pt/utl/ist/elab/virtual/client/quantum/resources/ReCExpQuantum").getString("rec.exp.customizer.gaussMenu.tip.5"));
        gaussMenu.addItem(java.util.ResourceBundle.getBundle("pt/utl/ist/elab/virtual/client/quantum/resources/ReCExpQuantum").getString("rec.exp.customizer.gaussMenu.title.6"),java.util.ResourceBundle.getBundle("pt/utl/ist/elab/virtual/client/quantum/resources/ReCExpQuantum").getString("rec.exp.customizer.gaussMenu.tip.6"));
        
        config();
        
        eixo = new XAxis(java.util.ResourceBundle.getBundle("pt/utl/ist/elab/virtual/client/quantum/resources/ReCExpQuantum").getString("rec.exp.quantum.space"));
    ...
    protected void buildPopuMenu() {
        ...
        item.addActionListener(this);
        popupmenu.add(item);
        item = new JMenuItem(java.util.ResourceBundle.getBundle("pt/utl/ist/elab/virtual/client/quantum/resources/ReCExpQuantum").getString("rec.exp.displays.save"));
        item.setToolTipText(java.util.ResourceBundle.getBundle("pt/utl/ist/elab/virtual/client/quantum/resources/ReCExpQuantum").getString("rec.exp.displays.save.tip"));
        item.addActionListener(this);
        popupmenu.add(item);
        item = new JMenuItem(java.util.ResourceBundle.getBundle("pt/utl/ist/elab/virtual/client/quantum/resources/ReCExpQuantum").getString("rec.exp.displays.print"));
        item.setToolTipText(java.util.ResourceBundle.getBundle("pt/utl/ist/elab/virtual/client/quantum/resources/ReCExpQuantum").getString("rec.exp.displays.print.tip"));
        item.addActionListener(this);
        popupmenu.add(item);
    }
            ...
            case InteractivePanel.MOUSE_PRESSED :
                ...
                if(inter==null){
                    ...
                    if (enableZoom && evt.isControlDown()) {
                        setPreferredMinMax(panel.getMouseX()-(xmaxPreferred-xminPreferred)/2,panel.getMouseX()+(xmaxPreferred-xminPreferred)/2,panel.getMouseY()-(ymaxPreferred-yminPreferred)/2,panel.getMouseY()+(ymaxPreferred-yminPreferred)/2);
                        repaint();
                    }
                    return;
                }
    ...
    public void actionPerformed(ActionEvent e) {
        if (e.getActionCommand().equalsIgnoreCase(java.util.ResourceBundle.getBundle("pt/utl/ist/elab/virtual/client/quantum/resources/ReCExpQuantum").getString("rec.exp.customizer.gaussMenu.title.5"))){
            setPreferredMinMax(gaussian.getX()-25,gaussian.getX()+25,-1,1);
            repaint();
        }
        else if (e.getActionCommand().equalsIgnoreCase(java.util.ResourceBundle.getBundle("pt/utl/ist/elab/virtual/client/quantum/resources/ReCExpQuantum").getString("rec.exp.customizer.gaussMenu.title.6"))){
            setPreferredMinMax(gaussian.getX()-gaussian.getDX0()/2,gaussian.getX()+gaussian.getDX0()/2,-1,1);
            repaint();
        }
        else if (e.getActionCommand().equalsIgnoreCase(java.util.ResourceBundle.getBundle("pt/utl/ist/elab/virtual/client/quantum/resources/ReCExpQuantum").getString("rec.exp.customizer.gaussMenu.title.1"))){
            gaussian.setDisplay(ComplexGaussian.DISPLAY_PROBABILITY);
            repaint();
        }
        else if (e.getActionCommand().equalsIgnoreCase(java.util.ResourceBundle.getBundle("pt/utl/ist/elab/virtual/client/quantum/resources/ReCExpQuantum").getString("rec.exp.customizer.gaussMenu.title.2"))){
            gaussian.setDisplay(ComplexGaussian.DISPLAY_REAL);
            repaint();
        }
        else if (e.getActionCommand().equalsIgnoreCase(java.util.ResourceBundle.getBundle("pt/utl/ist/elab/virtual/client/quantum/resources/ReCExpQuantum").getString("rec.exp.customizer.gaussMenu.title.3"))){
            gaussian.setDisplay(ComplexGaussian.DISPLAY_IMAGINARY);
            repaint();
        }
        else if (e.getActionCommand().equalsIgnoreCase(java.util.ResourceBundle.getBundle("pt/utl/ist/elab/virtual/client/quantum/resources/ReCExpQuantum").getString("rec.exp.customizer.gaussMenu.title.4"))){
            ...
            zoomOut();
        else if (e.getActionCommand().equalsIgnoreCase(java.util.ResourceBundle.getBundle("pt/utl/ist/elab/virtual/client/quantum/resources/ReCExpQuantum").getString("rec.exp.displays.save")))
            try{doSaveAs(render());}catch(IOException io){}
        else if (e.getActionCommand().equalsIgnoreCase(java.util.ResourceBundle.getBundle("pt/utl/ist/elab/virtual/client/quantum/resources/ReCExpQuantum").getString("rec.exp.displays.print")))
    ...
    public synchronized void addDrawable(Drawable drawable){
        if((drawable != null) &&!drawableList.contains(drawable)) {
            if (drawable instanceof ComplexGaussian || (drawable instanceof Potential && ((Potential) drawable).getHighLightColor() == Color.BLUE))
                drawableList.add(drawableList.size(),drawable);
            else
                drawableList.add(0,drawable);
            validImage = false;
        }
        if(drawable instanceof Dimensioned) dimensionSetter= ((Dimensioned)drawable);
        if(drawable instanceof Interactive) containsInteractive=true;
    }
    ...
    public String getPotentials(){
        ...
        while (it.hasNext()){
            java.lang.Object obj = it.next();
            if (obj instanceof Potential)
                potentials += ((Potential) obj).getX()+":"+((Potential)obj).getWidth()+":"+((Potential)obj).getFunction()+":"+((Potential)obj).isMedio()+"#";
        }
    ...
    public void doSaveAs(java.awt.image.BufferedImage img) throws IOException {
        ...
        org.jfree.ui.ExtensionFileFilter filter = new org.jfree.ui.ExtensionFileFilter(java.util.ResourceBundle.getBundle("pt/utl/ist/elab/virtual/client/quantum/resources/ReCExpQuantum").getString("PNG_Image_Files"),".png");
   ...
   /* public String toString(){
    ...
    private class KSPanel extends DrawingPanel implements ActionListener, WindowListener {
        ...
        protected void buildPopuMenu() {
            ...
            item.addActionListener(this);
            popupmenu.add(item);
            item = new JMenuItem(java.util.ResourceBundle.getBundle("pt/utl/ist/elab/virtual/client/quantum/resources/ReCExpQuantum").getString("rec.exp.customizer.gaussMenu.title.6"));
            item.setToolTipText(java.util.ResourceBundle.getBundle("pt/utl/ist/elab/virtual/client/quantum/resources/ReCExpQuantum").getString("rec.exp.customizer.gaussMenu.tip.6"));
            item.addActionListener(this);
            popupmenu.add(item);
        }
