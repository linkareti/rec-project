...
package pt.utl.ist.elab.virtual.client.tiro.displays;
...
import pt.utl.ist.elab.virtual.client.tiro.Tiro;
/**
 *
 * @author  nomead
 */
public class Animation extends Tiro implements ExpDataDisplay, ExpDataModelListener {
    ...
    //TESTE
    public void start(){
        pt.utl.ist.elab.virtual.driver.tiro.TiroDataProducer data = new pt.utl.ist.elab.virtual.driver.tiro.TiroDataProducer(null,10,10,6.7,Math.PI/4,9.8);
        data.start(this);
    }
