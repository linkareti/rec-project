...
public class MomInerciaCustomizer extends javax.swing.JPanel implements
	...
	private void initComponents() {// GEN-BEGIN:initComponents
		...
		jPanel8.setBorder(new javax.swing.border.TitledBorder("Lan\u00e7amento do disco(s)"));
		...
		jTextFieldLaunch.setPreferredSize(new java.awt.Dimension(33, 16));
		...
		jPanel5.setBorder(new javax.swing.border.TitledBorder("\u00cdnicio trav\u00e3o electromagn\u00e9tico (s)"));
		...
		jTextFieldStop.setPreferredSize(new java.awt.Dimension(33, 16));
		...
		jPanel6.setBorder(new javax.swing.border.TitledBorder("N\u00famero de amostras"));
		...
		jLabelInfo.setText("Dura\u00e7\u00e3o da experi\u00eancia: 200 s ");
	...
	public void checkMaxNumSamples() {
		...
		if (duration > 90) {
			...
			jLabelInfo.setText("N\u00famero de amostras tem de ser <= " + (90000 / jSliderTBS.getValue()));
			btnOK.setEnabled(false);
		} else {
			jLabelInfo.setEnabled(false);
			jLabelInfo.setText("Dura\u00e7\u00e3o da experi\u00eancia: " + df.format(duration) + " s");
	...
	public boolean checkIterLaunch() {
		...
		if (launch > jSliderNumSamples.getValue() && jCheckBoxLaunch.isSelected()) {
			jLabelInfo.setEnabled(true);
			jLabelInfo
					.setText("O tempo de lan\u00e7amento escolhido \u00e9 superior \u00e0 dura\u00e7\u00e3o da experi\u00eancia");
			btnOK.setEnabled(false);
			ret = false;
		} else {
			checkMaxNumSamples();
	...
	public boolean checkIterStop() {
		...
		if (stop > jSliderNumSamples.getValue() && jCheckStop.isSelected()) {
			jLabelInfo.setEnabled(true);
			jLabelInfo
					.setText("O tempo de paragem escolhido \u00e9 superior \u00e0 dura\u00e7\u00e3o da experi\u00eancia");
			btnOK.setEnabled(false);
			ret = false;
		} else {
			checkMaxNumSamples();
	...
	public javax.swing.ImageIcon getCustomizerIcon() {
		return new javax.swing.ImageIcon(getClass().getResource(
				"/pt/utl/ist/elab/client/serial/stamp/momentoInercia/resources/cd_iconified.gif"));
	}

	public String getCustomizerTitle() {
		return "Momento In�rcia";
	}
