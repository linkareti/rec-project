...
import pt.utl.ist.elab.virtual.client.fermap.FERMAPAnima;
...
public class Animation extends FERMAPAnima implements ExpDataDisplay, ExpDataModelListener {
    ...
    public Animation() {
        ...
        //TESTE
        //config(2, 10, 0, 20, 9);
        //new pt.utl.ist.elab.virtual.driver.fermap.FERMAPDataProducer(null, 2, 5, 0, 10.1, 9, 10, 1, 1000).startAnima(this);
        //new pt.utl.ist.elab.virtual.driver.fermap.FERMAPDataProducer(null, 2, 10, 0, 0.1f, 9, 20, 1, 1000).startAnima(this);
        //new pt.utl.ist.elab.virtual.driver.fermap.FERMAPDataProducer(null, 2, 100, 0, 10.1, 9, 100, 1, 1000).startAnima(this);
        //new pt.utl.ist.elab.virtual.driver.fermap.FERMAPDataProducer(null, 2, 200, 2*Math.PI, 0.1f, 9, 20, 1, 1000).startAnima(this);
    ...
    public void newSamples(NewExpDataEvent evt) {
        for(int i=evt.getSamplesStartIndex(); i<=evt.getSamplesEndIndex(); i++) {
            //sample, canal
            if (model.getValueAt(i,0) != null && model.getValueAt(i,1) != null) //continuidade (x,xWall)
