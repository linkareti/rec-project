...
public class ColisioneCustomizer extends AbstractCustomizer {
	...
	private void initComponents()// GEN-BEGIN:initComponents
	{
		...
		btnDefaults.setText(ReCResourceBundle.findStringOrDefault("rec.exp.dftcfg.colisione.title.1", "Default Config"));
		...
		jPanel6.setBorder(new javax.swing.border.TitledBorder(ReCResourceBundle.findStringOrDefault(
				"colisione$rec.exp.customizer.title2", "colisione$rec.exp.customizer.title2")));
		...
		lblErrorSamplesTooHigh.setText(ReCResourceBundle.findStringOrDefault("colisione$rec.exp.customizer.label2",
				"colisione$rec.exp.customizer.label2"));
		...
		jPanel1.setBorder(new javax.swing.border.TitledBorder(ReCResourceBundle.findStringOrDefault(
				"colisione$rec.exp.customizer.title3", "colisione$rec.exp.customizer.title3")));
		...
		lblSamplingIntervalTooHigh.setText(ReCResourceBundle.findStringOrDefault("colisione$rec.exp.customizer.label3",
				"colisione$rec.exp.customizer.label3"));
		...
		jPanel5.setBorder(new javax.swing.border.TitledBorder(ReCResourceBundle.findStringOrDefault(
				"colisione$rec.exp.customizer.title1", "colisione$rec.exp.customizer.title1")));
		...
		lblErrorVolsAreEqua.setText(ReCResourceBundle.findStringOrDefault("colisione$rec.exp.customizer.label1",
				"colisione$rec.exp.customizer.label1"));
	...
	public void checkMaxTime() {
		...
		btnOK.setEnabled(!lblErrorVolsAreEqua.isEnabled() && !lblErrorSamplesTooHigh.isEnabled()
				&& !lblSamplingIntervalTooHigh.isEnabled());
		lblSamplingIntervalTooHigh.setText(ReCResourceBundle.findStringOrDefault("colisione$rec.exp.customizer.label2",
				"colisione$rec.exp.customizer.label2") + (int) maxValue);
	}
	...
	public String getCustomizerTitle() {
		return ReCResourceBundle.findStringOrDefault("colisione$rec.exp.colisione.customizer.title",
				"colisione$rec.exp.colisione.customizer.title");
	}
