...
public class Animation extends Pend2M implements ExpDataDisplay, ExpDataModelListener, ComponentListener {
    ...
    private String actionStr = java.util.ResourceBundle.getBundle("pt/utl/ist/elab/virtual/client/pend2m/resources/ReCExpPend2M").getString("rec.exp.displays.animation.actionStr");
    private double a, w;
    ...
    public Animation() {
        ...
        viewPopMenu.addCheckBoxItem(java.util.ResourceBundle.getBundle("pt/utl/ist/elab/virtual/client/pend2m/resources/ReCExpPend2M").getString("rec.exp.customizer.viewMenu.title.7"), java.util.ResourceBundle.getBundle("pt/utl/ist/elab/virtual/client/pend2m/resources/ReCExpPend2M").getString("rec.exp.customizer.viewMenu.tip.7"), true);
        viewPopMenu.addCheckBoxItem(java.util.ResourceBundle.getBundle("pt/utl/ist/elab/virtual/client/pend2m/resources/ReCExpPend2M").getString("rec.exp.customizer.viewMenu.title.8"), java.util.ResourceBundle.getBundle("pt/utl/ist/elab/virtual/client/pend2m/resources/ReCExpPend2M").getString("rec.exp.customizer.viewMenu.tip.8"));
        viewPopMenu.addCheckBoxItem(java.util.ResourceBundle.getBundle("pt/utl/ist/elab/virtual/client/pend2m/resources/ReCExpPend2M").getString("rec.exp.customizer.viewMenu.title.9"), java.util.ResourceBundle.getBundle("pt/utl/ist/elab/virtual/client/pend2m/resources/ReCExpPend2M").getString("rec.exp.customizer.viewMenu.tip.9"));
        viewPopMenu.addItem(java.util.ResourceBundle.getBundle("pt/utl/ist/elab/virtual/client/pend2m/resources/ReCExpPend2M").getString("rec.exp.customizer.viewMenu.title.10"), java.util.ResourceBundle.getBundle("pt/utl/ist/elab/virtual/client/pend2m/resources/ReCExpPend2M").getString("rec.exp.customizer.viewMenu.tip.10"));
        
        viewPopMenu.getComponent(6).setEnabled(false);
    }
    
    public void moves(double theta, double phi, double thetaDot, double phiDot, double point, double thetaDot2, double phiDot2){
    ...
    public void newSamples(NewExpDataEvent evt) {
        for(int i=evt.getSamplesStartIndex(); i<=evt.getSamplesEndIndex(); i++) {
            //sample, canal
            if (model.getValueAt(i,0) != null && model.getValueAt(i,1) != null && model.getValueAt(i,2) != null && model.getValueAt(i,3) != null && model.getValueAt(i,4) != null && model.getValueAt(i,5) != null && model.getValueAt(i,6) != null)
                moves(model.getValueAt(i,0).getValue().getFloatValue(),model.getValueAt(i,1).getValue().getFloatValue(),model.getValueAt(i,2).getValue().getFloatValue(),model.getValueAt(i,3).getValue().getFloatValue(), a*Math.sin(w*model.getValueAt(i,4).getValue().getFloatValue()+fase), model.getValueAt(i,5).getValue().getFloatValue(),model.getValueAt(i,6).getValue().getFloatValue());
    ...
    public void actionPerformed(ActionEvent e) {
        if (e.getActionCommand().equalsIgnoreCase(java.util.ResourceBundle.getBundle("pt/utl/ist/elab/virtual/client/pend2m/resources/ReCExpPend2M").getString("rec.exp.customizer.viewMenu.title.1"))){
            ...
            snapshot();
        else if (e.getActionCommand().equalsIgnoreCase(java.util.ResourceBundle.getBundle("pt/utl/ist/elab/virtual/client/pend2m/resources/ReCExpPend2M").getString("rec.exp.customizer.viewMenu.title.7"))){
        ...
        else if (e.getActionCommand().equalsIgnoreCase(java.util.ResourceBundle.getBundle("pt/utl/ist/elab/virtual/client/pend2m/resources/ReCExpPend2M").getString("rec.exp.customizer.viewMenu.title.8"))){
            isTrailing = ((javax.swing.JCheckBoxMenuItem) e.getSource()).isSelected();
        }
        else if (e.getActionCommand().equalsIgnoreCase(java.util.ResourceBundle.getBundle("pt/utl/ist/elab/virtual/client/pend2m/resources/ReCExpPend2M").getString("rec.exp.customizer.viewMenu.title.9"))){
        ...
        else if (e.getActionCommand().equalsIgnoreCase(java.util.ResourceBundle.getBundle("pt/utl/ist/elab/virtual/client/pend2m/resources/ReCExpPend2M").getString("rec.exp.customizer.viewMenu.title.10"))) {
            rasto[0].clear();
            rasto[1].clear();
            clearTrail();
        }
