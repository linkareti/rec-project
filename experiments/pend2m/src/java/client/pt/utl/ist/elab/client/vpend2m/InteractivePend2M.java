...
public class InteractivePend2M extends Pend2M implements InteractionListener, Runnable {
    ...
    private void buildInteractivePend2M(){
        ...
        editPopMenu.addItem(java.util.ResourceBundle.getBundle("pt/utl/ist/elab/virtual/client/pend2m/resources/ReCExpPend2M").getString("rec.exp.customizer.editMenu.title.1"), java.util.ResourceBundle.getBundle("pt/utl/ist/elab/virtual/client/pend2m/resources/ReCExpPend2M").getString("rec.exp.customizer.editMenu.tip.1"));
        editPopMenu.addItem(java.util.ResourceBundle.getBundle("pt/utl/ist/elab/virtual/client/pend2m/resources/ReCExpPend2M").getString("rec.exp.customizer.editMenu.title.2"), java.util.ResourceBundle.getBundle("pt/utl/ist/elab/virtual/client/pend2m/resources/ReCExpPend2M").getString("rec.exp.customizer.editMenu.tip.2"));
        editPopMenu.addItem(java.util.ResourceBundle.getBundle("pt/utl/ist/elab/virtual/client/pend2m/resources/ReCExpPend2M").getString("rec.exp.customizer.editMenu.title.3"), java.util.ResourceBundle.getBundle("pt/utl/ist/elab/virtual/client/pend2m/resources/ReCExpPend2M").getString("rec.exp.customizer.editMenu.tip.3"));
        editPopMenu.addItem(java.util.ResourceBundle.getBundle("pt/utl/ist/elab/virtual/client/pend2m/resources/ReCExpPend2M").getString("rec.exp.customizer.editMenu.title.4"), java.util.ResourceBundle.getBundle("pt/utl/ist/elab/virtual/client/pend2m/resources/ReCExpPend2M").getString("rec.exp.customizer.editMenu.tip.4"));
        editPopMenu.addItem(java.util.ResourceBundle.getBundle("pt/utl/ist/elab/virtual/client/pend2m/resources/ReCExpPend2M").getString("rec.exp.customizer.editMenu.title.5"), java.util.ResourceBundle.getBundle("pt/utl/ist/elab/virtual/client/pend2m/resources/ReCExpPend2M").getString("rec.exp.customizer.editMenu.tip.5"));
        editPopMenu.addItem(java.util.ResourceBundle.getBundle("pt/utl/ist/elab/virtual/client/pend2m/resources/ReCExpPend2M").getString("rec.exp.customizer.editMenu.title.6"), java.util.ResourceBundle.getBundle("pt/utl/ist/elab/virtual/client/pend2m/resources/ReCExpPend2M").getString("rec.exp.customizer.editMenu.tip.6"));
        editPopMenu.addItem(java.util.ResourceBundle.getBundle("pt/utl/ist/elab/virtual/client/pend2m/resources/ReCExpPend2M").getString("rec.exp.customizer.editMenu.title.7"), java.util.ResourceBundle.getBundle("pt/utl/ist/elab/virtual/client/pend2m/resources/ReCExpPend2M").getString("rec.exp.customizer.editMenu.tip.7"));
        editPopMenu.addItem(java.util.ResourceBundle.getBundle("pt/utl/ist/elab/virtual/client/pend2m/resources/ReCExpPend2M").getString("rec.exp.customizer.editMenu.title.8"), java.util.ResourceBundle.getBundle("pt/utl/ist/elab/virtual/client/pend2m/resources/ReCExpPend2M").getString("rec.exp.customizer.editMenu.tip.8"));
        editPopMenu.addItem(java.util.ResourceBundle.getBundle("pt/utl/ist/elab/virtual/client/pend2m/resources/ReCExpPend2M").getString("rec.exp.customizer.editMenu.title.9"), java.util.ResourceBundle.getBundle("pt/utl/ist/elab/virtual/client/pend2m/resources/ReCExpPend2M").getString("rec.exp.customizer.editMenu.tip.9"));
    }
        ...
        if (eventObj instanceof  InteractiveSphere){
            ...
            if (((InteractiveSphere) eventObj) == point){
                ...
                if (Math.abs(point.getGroup().getY()) > Math.abs(bar.getY()))
                    point.getGroup().setY(Math.abs(bar.getY())*point.getGroup().getY()/Math.abs(point.getGroup().getY()));
    ...
    public void config(double theta, double phi, double thetaDot, double phiDot, double l1, double l2, double amp, double fase, double w){
        this.w = w;
