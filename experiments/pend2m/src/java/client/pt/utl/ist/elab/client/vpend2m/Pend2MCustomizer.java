...
public class Pend2MCustomizer extends javax.swing.JPanel implements com.linkare.rec.impl.client.customizer.ICustomizer,
		InteractiveMenu {
	...
	private void initComponents() {// GEN-BEGIN:initComponents
		...
		okButton.setText(java.util.ResourceBundle.getBundle(
				"pt/utl/ist/elab/virtual/client/pend2m/resources/ReCExpPend2M")
				.getString("rec.exp.customizer.title.ok"));
		okButton.setToolTipText(java.util.ResourceBundle.getBundle(
				"pt/utl/ist/elab/virtual/client/pend2m/resources/ReCExpPend2M").getString("rec.exp.customizer.tip.ok"));
		...
		mainEditPanel.setToolTipText(java.util.ResourceBundle.getBundle(
				"pt/utl/ist/elab/virtual/client/pend2m/resources/ReCExpPend2M").getString("rec.exp.customizer.tip.22"));
		...
		editPanel.setToolTipText(java.util.ResourceBundle.getBundle(
				"pt/utl/ist/elab/virtual/client/pend2m/resources/ReCExpPend2M").getString("rec.exp.customizer.tip.23"));
		...
		mainTabbedPane.addTab(
				java.util.ResourceBundle.getBundle("pt/utl/ist/elab/virtual/client/pend2m/resources/ReCExpPend2M")
						...
						.getBundle("pt/utl/ist/elab/virtual/client/pend2m/resources/ReCExpPend2M").getString(
		...
		gPanel.setToolTipText(java.util.ResourceBundle.getBundle(
				"pt/utl/ist/elab/virtual/client/pend2m/resources/ReCExpPend2M").getString("rec.exp.customizer.tip.1"));
		...
		m2Panel.setToolTipText(java.util.ResourceBundle.getBundle(
				"pt/utl/ist/elab/virtual/client/pend2m/resources/ReCExpPend2M").getString("rec.exp.customizer.tip.3"));
		...
		m1Panel.setToolTipText(java.util.ResourceBundle.getBundle(
				"pt/utl/ist/elab/virtual/client/pend2m/resources/ReCExpPend2M").getString("rec.exp.customizer.tip.2"));
	...
	public void actionPerformed(java.awt.event.ActionEvent e) {
		 ...
		 * xCheckBoxMenuItem.isSelected() || thetaCheckBoxMenuItem.isSelected())
	...
	public void setHardwareAcquisitionConfig(HardwareAcquisitionConfig acqConfig) {
		...
		if (acqConfig != null) {
			...
			m1Slider.setValue((int) Math
					.round(Float.parseFloat(acqConfig.getSelectedHardwareParameterValue("m1")) * 100));
			m2Slider.setValue((int) Math
					.round(Float.parseFloat(acqConfig.getSelectedHardwareParameterValue("m2")) * 100));
	...
	public javax.swing.ImageIcon getCustomizerIcon() {
		return new javax.swing.ImageIcon(getClass().getResource(
				"/pt/utl/ist/elab/virtual/client/pend2m/resources/pend2m_iconified.PNG"));
	}
