...
public class PoissonCustomizer extends javax.swing.JPanel implements com.linkare.rec.impl.client.customizer.ICustomizer
{
    ...
    {
        String error = ReCResourceBundle.findStringOrDefault("ReCExpPoisson$rec.exp.customizer.title.errorfunc", "Wrong function!");
    ...
    {
        return new javax.swing.ImageIcon(getClass().getResource("/pt/utl/ist/elab/virtual/client/poisson/resources/poisson_iconified.png"));
    }
