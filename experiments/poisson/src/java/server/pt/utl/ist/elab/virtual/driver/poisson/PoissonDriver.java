...
{    
    ...
    public void configure(HardwareAcquisitionConfig config, HardwareInfo info) throws WrongConfigurationException 
    {
        ...
        dataSource = new PoissonDataProducer(this, nx, ny, nz, fnFace1, fnFace2, fnFace3, fnFace4, fnFace5, fnFace6, fnRho);
	...
	}catch(java.net.MalformedURLException e)
	{
	    ...
	    {
		LoggerUtil.logThrowable("Unable to load resource: " + baseHardwareInfoFile,e2,Logger.getLogger("Poisson.logger"));
	    }
	}
