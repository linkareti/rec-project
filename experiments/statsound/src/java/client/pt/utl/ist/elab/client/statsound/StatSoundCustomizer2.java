 ...
 * 
 */
public class StatSoundCustomizer2 extends javax.swing.JPanel implements
	...
	private void initComponents()// GEN-BEGIN:initComponents
	{
		...
		buttonMicGroup = new ButtonGroup();
		...
		buttonMicGroup.add(jRadioButtonMic2);
		buttonMicGroup.add(jRadioButtonMic3);
		buttonMicGroup.add(jRadioButtonMic4);
...
//		}
		...
		acqConfig.getSelectedHardwareParameter("Wave form")
				.setParameterValue("" + jComboBoxSoundVel.getSelectedIndex());
	...
	public static void main(String args[]) {
		...
		jf.getContentPane().add(new StatSoundCustomizer2());
		jf.pack();
		jf.show();
	}
	...
	private ButtonGroup buttonMicGroup;
