...
public class STDMAPImage extends MAPanel implements ExpDataDisplay, ExpDataModelListener {
    ...
    public void start(){
        ...
        //Map Non-Static
        staticImg = true;
        pt.utl.ist.elab.driver.vstdmap.STDMAPDataProducer std = new pt.utl.ist.elab.driver.vstdmap.STDMAPDataProducer(null, 1.1f, 0, nTheta, 2.1f, 0, nI, .21f, iter, (float)Math.PI, w, h, pixSize, staticImg);
