...
public class STDMAPDataProducer extends VirtualBaseDataSource implements Runnable
{
    ...
    private pt.utl.ist.elab.virtual.client.stdmap.displays.Animation stdAn;
    //TESTE
    public void startAnima(pt.utl.ist.elab.virtual.client.stdmap.displays.Animation stdAn)
    {
        this.stdAn = stdAn;
    ...
    //TESTE
    private pt.utl.ist.elab.virtual.client.stdmap.displays.STDHistogram stdHist;
    public void startHist(pt.utl.ist.elab.virtual.client.stdmap.displays.STDHistogram stdHist)
    {
    ...
    //TESTE
    private pt.utl.ist.elab.virtual.client.stdmap.displays.STDMAPImage stdIm;
    public void startM(pt.utl.ist.elab.virtual.client.stdmap.displays.STDMAPImage stdIm)
    {
        this.stdIm = stdIm;
        animaThread = new Thread(this);
        animaThread.start();
