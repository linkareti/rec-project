...
public class CCCustomizer extends javax.swing.JPanel implements com.linkare.rec.impl.client.customizer.ICustomizer
{
    ...
    private void initComponents() {
        ...
        jPanel6.setBorder(javax.swing.BorderFactory.createTitledBorder(ReCResourceBundle.findString("ReCExpCC$rec.exp.customizer.title2"))); // NOI18N
        ...
        jPanel1.setBorder(javax.swing.BorderFactory.createTitledBorder(ReCResourceBundle.findString("ReCExpCC$rec.exp.customizer.title3"))); // NOI18N
        ...
        jPanel5.setBorder(javax.swing.BorderFactory.createTitledBorder(ReCResourceBundle.findString("ReCExpPV$rec.exp.customizer.title1"))); // NOI18N
	...
	{//GEN-HEADEREND:event_btnOKActionPerformed
	    ...
	    acqConfig.getSelectedHardwareParameter("StartPosition").setParameterValue(""+((float)sldPos1.getValue()/1000.F));
	    acqConfig.getSelectedHardwareParameter("EndPosition").setParameterValue(""+((float)sldPos2.getValue()/1000.F));
