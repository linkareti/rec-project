 ...
 */
public class CCCustomizer extends AbstractCustomizer {
	...
	private void initComponents() {
		...
		java.util.ResourceBundle bundle = java.util.ResourceBundle
				.getBundle("pt/utl/ist/elab/client/condensadorcilindrico/resources/messages"); // NOI18N
		...
		jPanelInitialPosition.setBorder(javax.swing.BorderFactory.createTitledBorder(ReCResourceBundle
				.findStringOrDefault("condensadorcilindrico$rec.exp.customizer.title1",
						"condensadorcilindrico$rec.exp.customizer.title1"))); // NOI18N
		...
		jPanelFinalPosition.setBorder(javax.swing.BorderFactory.createTitledBorder(ReCResourceBundle
				.findStringOrDefault("condensadorcilindrico$rec.exp.customizer.title2",
						"condensadorcilindrico$rec.exp.customizer.title2"))); // NOI18N
		...
		jPanelNumberOfPoints.setBorder(javax.swing.BorderFactory.createTitledBorder(ReCResourceBundle
				.findStringOrDefault("condensadorcilindrico$rec.exp.customizer.title3",
						"condensadorcilindrico$rec.exp.customizer.title3"))); // NOI18N
	...
	private void btnOKActionPerformed(final java.awt.event.ActionEvent evt) {
		...
		final ParameterConfig hwStartPosition = getAcquisitionConfig().getSelectedHardwareParameter("StartPosition");
		hwStartPosition.setParameterValue(String.valueOf(sldInitPos.getValue()));

		final ParameterConfig hwEndPosition = getAcquisitionConfig().getSelectedHardwareParameter("EndPosition");
		hwEndPosition.setParameterValue(String.valueOf(sldFinalPos.getValue()));

		getAcquisitionConfig().setTotalSamples(sldNumPoints.getValue());
	...
	private boolean ensureNumberOfPointsSmallerThanPosDiff() {
		...
		if (!valid) {
			String errorMsg = ReCResourceBundle.findStringOrDefault(
					"condensadorcilindrico$rec.exp.cc.customizer.validation.numberOfPointsSmallerThanPosDiff",
					"condensadorcilindrico$rec.exp.cc.customizer.validation.numberOfPointsSmallerThanPosDiff");
	...
	public void setHardwareAcquisitionConfig(final HardwareAcquisitionConfig acqConfig) {
		...
		if (acqConfig != null) {
			...
			final int currentStartPosition = Integer.parseInt(acqConfig
					.getSelectedHardwareParameterValue("StartPosition"));
			sldInitPos.setValue(currentStartPosition);
			tfInitPos.setText("" + currentStartPosition);

			final int currentFinalPosition = Integer.parseInt(acqConfig
					.getSelectedHardwareParameterValue("EndPosition"));
	...
	public void setHardwareInfo(final HardwareInfo hardwareInfo) {
		...
		if (hardwareInfo != null) {
			...
			// Setting the minumum number of points as a global variable so that
			// it can be checked while validating the user input
			...
			// Setting the initial value for the text field next to the number
			// of points - note that we cannot retrieve this from the XML so we
			// assume the minimum value is OK
	...
	public javax.swing.ImageIcon getCustomizerIcon() {
		return new javax.swing.ImageIcon(ReCResourceBundle.findStringOrDefault("condensadorcilindrico$rec.exp.icon.cc",
				"condensadorcilindrico$rec.exp.icon.cc"));
	}

	@Override
	public String getCustomizerTitle() {
		return ReCResourceBundle.findStringOrDefault("condensadorcilindrico$rec.exp.cc.customizer.title",
				"condensadorcilindrico$rec.exp.cc.customizer.title");
	}
}