...
public class MainPanel extends javax.swing.JPanel implements com.linkare.rec.impl.client.experiment.ExpDataDisplay,
	...
	public MainPanel() {
		initComponents();
		jPanel1.setBorder(new ImageBorder(new javax.swing.ImageIcon(getClass().getResource(
				"/pt/utl/ist/elab/client/thomson/resources/mainpanelback.jpg")).getImage(), true));
	}
