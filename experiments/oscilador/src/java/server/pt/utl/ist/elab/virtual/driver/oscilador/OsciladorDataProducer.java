 ...
 *
 * Created on 31 de Março de 2005, 12:47
 */

package pt.utl.ist.elab.virtual.driver.oscilador;
...
public class OsciladorDataProducer extends VirtualBaseDataSource implements ODE{
    ...
    public void getRate(double[] state, double[] rate ) {
        rate[0] = state[1];
        rate[1] = (4*Math.PI*Math.PI*frequencia*frequencia*state[0]-2*g*a*state[0]-4*a*a*state[0]*state[1]*state[1])/(1+4*a*a*state[0]*state[0]);
        rate[2] = 1;
    }
    
    /** Creates a new instance of osciladorDataProducer */
    public OsciladorDataProducer(VirtualBaseDriver driver, float g, float a,  float frequencia, float alturaInicial, int tbs, int nSamples) {
        this.driver = driver;
        this.g = g;
        this.a = a;
        ...
        public void run() {
            try {
                ...
                while(currentSample <= nSamples && !stopped) {
                    ...
                    //vX
                    value[5] = new PhysicsValue(PhysicsValFactory.fromFloat((float)(state[1]*Math.sin(angulo)+state[0]*2*Math.PI*frequencia*Math.cos(angulo))),
                    ...
                    //vY
                    value[6] = new PhysicsValue(PhysicsValFactory.fromFloat((float)(state[1]*Math.cos(angulo)-state[0]*2*Math.PI*frequencia*Math.sin(angulo))),
                    ...
                    //v
                    value[8] = new PhysicsValue(PhysicsValFactory.fromFloat((float)(Math.sqrt(Math.pow((state[1]*Math.sin(angulo)+state[0]*2*Math.PI*frequencia*Math.cos(angulo)),2)+Math.pow((state[1]*Math.cos(angulo)-state[0]*2*Math.PI*frequencia*Math.sin(angulo)),2)+Math.pow((2*a*state[0]*state[1]),2)))),
                    ...
                    //vraio
                    value[9] = new PhysicsValue(PhysicsValFactory.fromFloat((float)(state[1])),
                    ...
                    //Energia Mecânica
                    value[10] = new PhysicsValue(PhysicsValFactory.fromFloat((float)(a*state[0]*state[0]*g+0.5*(Math.pow(state[1]*Math.sin(angulo)+state[0]*2*Math.PI*frequencia*Math.cos(angulo), 2)+Math.pow(state[1]*Math.cos(angulo)-state[0]*2*Math.PI*frequencia*Math.sin(angulo), 2)+Math.pow(2*a*state[0]*state[1], 2)))),
                    ...
                    //Energia Cinética
                    value[11] = new PhysicsValue(PhysicsValFactory.fromFloat((float)(0.5*(Math.pow(state[1]*Math.sin(angulo)+state[0]*2*Math.PI*frequencia*Math.cos(angulo), 2)+Math.pow(state[1]*Math.cos(angulo)-state[0]*2*Math.PI*frequencia*Math.sin(angulo), 2)+Math.pow(2*a*state[0]*state[1], 2)))),
                    ...
                    //Angulo
                    value[13] = new PhysicsValue(PhysicsValFactory.fromFloat((float)(angulo)),
                    getAcquisitionHeader().getChannelsConfig(13).getSelectedScale().getDefaultErrorValue(),
                    getAcquisitionHeader().getChannelsConfig(13).getSelectedScale().getMultiplier()
                    );
                     
                    //Abertura
                    value[14] = new PhysicsValue(PhysicsValFactory.fromFloat((float)(a)),
                    getAcquisitionHeader().getChannelsConfig(14).getSelectedScale().getDefaultErrorValue(),
                    getAcquisitionHeader().getChannelsConfig(14).getSelectedScale().getMultiplier()
                    );
                     
                    //Raio Máximo
                    value[15] = new PhysicsValue(PhysicsValFactory.fromFloat((float)(raioMax)),
                    getAcquisitionHeader().getChannelsConfig(15).getSelectedScale().getDefaultErrorValue(),
                    getAcquisitionHeader().getChannelsConfig(15).getSelectedScale().getMultiplier()
                    );
