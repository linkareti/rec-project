...
public class CGDriver extends VirtualBaseDriver {    
    ...
    public void configure(HardwareAcquisitionConfig config, HardwareInfo info) throws WrongConfigurationException {
        ...
        //boolean expGType = Boolean.getBoolean(config.getSelectedHardwareParameterValue("expGType"));
        ...
        dataSource = new CGDataProducer(this, expGType, angInit, s0, d, mm0, mm1, mM0, mM1, new double[]{c,k,g}, tbs, nSamples);
	...
	}catch(java.net.MalformedURLException e)
	{
	    ...
	    {
		LoggerUtil.logThrowable("Unable to load resource: " + baseHardwareInfoFile,e2,Logger.getLogger(CG_DRIVER_LOGGER));
	    }
	}
