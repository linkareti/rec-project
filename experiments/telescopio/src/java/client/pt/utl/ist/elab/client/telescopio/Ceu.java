...
public class Ceu {
	...
	public Ceu() {
		...
		ObjectoCeleste M32 = new ObjectoCeleste(":LM0032#", "M32", "Galaxia eliptica satelite da galaxia de Andomeda",
				0, 42.8, 40, 52.1, 3600.0);
		...
		ObjectoCeleste M110 = new ObjectoCeleste(":LM0110#", "M110 Andromeda",
		...
		ObjectoCeleste M31 = new ObjectoCeleste(":LM0031#", "M31 Andromeda", "Grande galaxia espiral de Andomeda", 0,
				42.8, 41, 16.1, 3600.0);
		...
		ObjectoCeleste M2 = new ObjectoCeleste(":LM0002#", "M2 Aquarius", "Enxame Globular constela��o do Aquario.",
				21, 33.5, -0, 49.3, 3600.0);
		...
		ObjectoCeleste M72 = new ObjectoCeleste(":LM0072#", "M72 Aquarius", "Enxame Globular ", 20, 53.5, -12, 32.3,
				7200.0);
		...
		ObjectoCeleste NGC7009 = new ObjectoCeleste(":LC7009#", "NGC7009 Aquarius", "Nebulosa Saturno planetaria", 21,
				4.2, -11, 22.3, 3600.0);
		...
		ObjectoCeleste NGC7293 = new ObjectoCeleste(":LC7293#", "NGC7293 Aquarius", "Nebulosa Planetaria Helice ", 22,
				29.6, -20, 48.4, 3600.0);
		...
		ObjectoCeleste NGC2403 = new ObjectoCeleste(":LC2403#", "NGC2403 Camelopardis", "Galaxia espiral", 7, 36.8, 65,
				37.0, 3600.0);
		...
		ObjectoCeleste M1 = new ObjectoCeleste(":LM0001#", "M1 Cancer", "Nebulosa do Carangueijo", 5, 34.5, 22, 1.1,
				3600.0);
		...
		ObjectoCeleste M106 = new ObjectoCeleste(":LM0106", "M106 Canes Venaciti", "Galaxia espiral", 12, 18.9, 47,
				19.1, 3600.0);
		...
		ObjectoCeleste NGC4490 = new ObjectoCeleste(":LM0106#", "NGC4490 Canes Venaciti", "Galaxia espiral", 12, 30.6,
				41, 39.1, 3600.0);
		...
		ObjectoCeleste M94 = new ObjectoCeleste(":LM0094#", "M94 Canes Venaciti", "Galaxia espiral", 12, 50.9, 41, 8.1,
				7200.0);
		...
		ObjectoCeleste M63 = new ObjectoCeleste(":LM0063#", "M63 Canes Venaciti", "Galaxias espiral", 13, 11.0, 37,
				3.1, 7200.0);
		...
		ObjectoCeleste M51 = new ObjectoCeleste(":LM0051#", "M51 Canes Venaciti",
		...
		ObjectoCeleste M3 = new ObjectoCeleste(":LM0003#", "M3 Canes Venaciti", "Enxame Globular", 13, 42.2, 28, 23.1,
				7200.0);
		...
		ObjectoCeleste M30 = new ObjectoCeleste(":LM0030#", "M30 Capricornus", "Enxame globular", 21, 40.4, -23, 11.4,
				15.0);
		...
		ObjectoCeleste NGC5128 = new ObjectoCeleste(":LM5128#", "NGC5128 Centauro", "Galaxia do Centauro", 13, 25.5,
				-43, 1.2, 7200.0);
		...
		ObjectoCeleste NGC5139 = new ObjectoCeleste(":LM5139#", "NGC5139 Centauro", "Enxame Globular", 13, 26.8, -47,
				28.8, 7200.0);
		...
		ObjectoCeleste acentauro = new ObjectoCeleste(":LS0150#", "Alfa Centauro", "Estrela mais proxima do Sol", 14,
				39.6, -60, 49.8, 7200.0);
		...
		ObjectoCeleste M98 = new ObjectoCeleste(":LM0098#", "M98 Coma Berenice", "Galaxia espiral", 12, 13.8, 14, 54.0,
				7200.0);
		...
		ObjectoCeleste M99 = new ObjectoCeleste(":LM 0099#", "M99 Coma Berenice", "Galaxia espiral", 12, 18.9, 14,
				26.2, 7200.0);
		...
		ObjectoCeleste M100 = new ObjectoCeleste(":LM 0100#", "M100 Coma Berenice", "Galaxia espiral", 12, 23.0, 15,
				50.2, 15.0);
		...
		ObjectoCeleste M85 = new ObjectoCeleste(":LM0085#", "M85 Coma Berenice", "Galaxia espiral", 12, 25.5, 18, 12.2,
				7200.0);
		...
		ObjectoCeleste M88 = new ObjectoCeleste(":LM0088#", "M88 Coma Berenice", "Galaxia espiral", 12, 31.1, 14, 26.2,
				7200.0);
		...
		ObjectoCeleste M91 = new ObjectoCeleste(":LM 0064#", "M64 Coma Berenice", "Galaxia espiral", 12, 56.7, 21,
				41.1, 7200.0);
		...
		ObjectoCeleste M53 = new ObjectoCeleste(":LM 0053#", "M53 Coma Berenice", "Enxame globular", 13, 12.9, 18,
				10.2, 7200.0);
		...
		ObjectoCeleste albireo = new ObjectoCeleste(":LS0223#", "Albireo Cygnus", "Estrela dupla", 19, 30.7, 27, 57.6,
				7200.0);
		...
		ObjectoCeleste NGC7000 = new ObjectoCeleste(":LC7000#", "NGC7000 Cygnus", "Nebulosa America do Norte", 20,
				58.8, 44, 20.2, 7200.0);
		...
		ObjectoCeleste M13 = new ObjectoCeleste(":LM0013#", "M13 Hercules", "Enxame Globular visivel a olho nu", 16,
				41.7, 36, 28.1, 3600.0);
		...
		ObjectoCeleste M92 = new ObjectoCeleste(":LM0092#", "M92 Hercules", "Enxame globular", 17, 17.1, 43, 8.1,
				7200.0);
		...
		ObjectoCeleste NGC2903 = new ObjectoCeleste(":LC2903#", "NGC2903 Leo", "Galaxia espiral", 9, 32.2, 21, 29.1,
				7200.0);
		...
		ObjectoCeleste M95 = new ObjectoCeleste(":LM0095#", "M95 Leo", "Galaxia Espiral em Barra", 10, 44.0, 11, 42.2,
				7200.0);
		...
		ObjectoCeleste NGC2261 = new ObjectoCeleste(":LC2261#", "NGC2261 Monoceros", "Nebulosa variavel de Hubble", 6,
				39.2, 8, 44.2, 7200.0);
		...
		ObjectoCeleste M107 = new ObjectoCeleste(":LM0107#", "M107 Ophiuchus", "Enxame Globular", 16, 32.5, -13, 3.2,
				3600.0);
		...
		ObjectoCeleste M12 = new ObjectoCeleste(":LM0012#", "M12 Ophiuchus", "Enxame Globular", 16, 47.2, -1, 57.2,
				3600.0);
		...
		ObjectoCeleste M10 = new ObjectoCeleste(":LM0010#", "M10 Ophiuchus", "Enxame Globular", 16, 57.1, -4, 6.2,
				3600.0);
		...
		ObjectoCeleste M14 = new ObjectoCeleste(":LM0014#", "M14 Ophiuchus", "Enxame Globular", 17, 37.6, -3, 15.2,
				3600.0);
		...
		// Orion
		ObjectoCeleste M42 = new ObjectoCeleste(":LM0042#", "M42 Ophiuchus", "Enxame Globular", 17, 37.6, -3, 15.2,
				3600.0);
		...
		ObjectoCeleste ALBIREO = new ObjectoCeleste(":LS0223#", "Albireo CYGNUS ", "Estrela_Bico do cisne", 19, 30.8,
				27, 58.0, 1);
		...
		ObjectoCeleste ALDEBARAN = new ObjectoCeleste(":LS0033#", "Aldebaran Toro ", "Estrela. Olho do toro", 4, 35.9,
				16, 31.0, 1);
		...
		ObjectoCeleste ALTAIR = new ObjectoCeleste(":LS0226#", "Altair AGUIA ", "Estrela. Olho da aguia", 19, 50.8, 8,
				52.0, 1);
		...
		ObjectoCeleste ANTARES = new ObjectoCeleste(":LS0177#", "Antares SCORPIAO ", "Estrela. Olho da escorpião", 14,
				15.7, 19, 11.0, 1);
