...
/*
 * WPBarcelonaCustomizerPanel.java
 *
 ...
 * @author npadriano
 */
public class WPBarcelonaCustomizerPanel extends AbstractCustomizer {
	...
	public static final float PERIOD = 3.3f;
        ...
        /** Creates new form WPBarcelonaCustomizerPanel */
	public WPBarcelonaCustomizerPanel() {
    ...
    private void initComponents() {
        ...
        jTabbedPaneWPBarcelona = new javax.swing.JTabbedPane();
        ...
        setName("WPBarcelonaCustomizer"); // NOI18N
        setPreferredSize(new java.awt.Dimension(350, 350));
        setRequestFocusEnabled(false);
        setLayout(new java.awt.BorderLayout());

        jTabbedPaneWPBarcelona.setName("jTabbedPaneWPBarcelona"); // NOI18N
        jTabbedPaneWPBarcelona.addChangeListener(new javax.swing.event.ChangeListener() {
            public void stateChanged(javax.swing.event.ChangeEvent evt) {
                jTabbedPaneWPBarcelonaStateChanged(evt);
            }
        });
        ...
        org.jdesktop.application.ResourceMap resourceMap = org.jdesktop.application.Application.getInstance().getContext().getResourceMap(WPBarcelonaCustomizerPanel.class);
        ...
        jTabbedPaneWPBarcelona.addTab(ReCResourceBundle.findStringOrDefault("wpbarcelona$jPanelPendulumConfig.TabConstraints.tabTitle","Configure"), null, jPanelPendulumConfig, resourceMap.getString("jPanelPendulumConfig.TabConstraints.tabToolTip")); // NOI18N

        add(jTabbedPaneWPBarcelona, java.awt.BorderLayout.CENTER);
        jTabbedPaneWPBarcelona.getAccessibleContext().setAccessibleName(ReCResourceBundle.findStringOrDefault("wpbarcelona$jPanelPendulumConfig.TabConstraints.tabTitle","Configure"));
...
private void jTabbedPaneWPBarcelonaStateChanged(javax.swing.event.ChangeEvent evt) {//GEN-FIRST:event_jTabbedPaneWPBarcelonaStateChanged
    validateScreen();
}//GEN-LAST:event_jTabbedPaneWPBarcelonaStateChanged
...
private void jFormattedTextFieldNrPointsFocusLost(java.awt.event.FocusEvent evt) {//GEN-FIRST:event_jFormattedTextFieldNrPointsFocusLost
	...
	private void jButtonOkActionPerformed(final java.awt.event.ActionEvent evt) {// GEN-FIRST:event_jButtonOkActionPerformed
		...
		Frequency freq = null;                
            ...
            final int time = (int) Math.ceil((WPBarcelonaCustomizerPanel.PERIOD * nsamples*(1.1) / nsamples));
    ...
    private javax.swing.JTabbedPane jTabbedPaneWPBarcelona;
	...
	public void setHardwareAcquisitionConfig(final HardwareAcquisitionConfig acqConfig) {
		super.setHardwareAcquisitionConfig(acqConfig);
                ...
                if (acqConfig != null) {
			System.out.println("WPBarcelonaCustomizer.setHardwareAcquisitionConfig(HardwareAcquisitionConfig  acqConfig)");
	...
	public javax.swing.ImageIcon getCustomizerIcon() {
		return new javax.swing.ImageIcon(getClass().getResource(
				"/pt/utl/ist/elab/client/wpbarcelona/resources/wpmaputo_iconified.gif"));
	}

	@Override
	public String getCustomizerTitle() {
		return ReCResourceBundle.findStringOrDefault("wpbarcelona$rec.exp.wpmaputo.customizer.title","wpmaputo$rec.exp.wpmaputo.customizer.title");
	}
