...
public class WorldPendulumCustomizerPanel extends AbstractCustomizer {
	...
	public WorldPendulumCustomizerPanel() {
		labelBegin = ReCResourceBundle.findStringOrDefault("wpucscl$jLabelEstimatedTime.text.beggining","Estimated time is");
                labelEnd = ReCResourceBundle.findStringOrDefault("wpucscl$jLabelEstimatedTime.text.end","minutes");
    ...
    private void initComponents() {
        ...
        jPanelPenduloDisplacement.setBorder(javax.swing.BorderFactory.createTitledBorder(ReCResourceBundle.findStringOrDefault("wpucscl$jPanelPenduloDisplacement.border.title","Initial Displacement")));
        ...
        jSliderDisplacement.setToolTipText(ReCResourceBundle.findStringOrDefault("wpucscl$jSliderDisplacement.toolTipText","Initial Displacement"));
        ...
        jSliderDisplacement.getAccessibleContext().setAccessibleName(ReCResourceBundle.findStringOrDefault("wpucscl$jSliderDisplacement.toolTipText","Deslocamento"));
        jSliderDisplacement.getAccessibleContext().setAccessibleDescription(ReCResourceBundle.findStringOrDefault("wpucscl$jSliderDisplacement.toolTipText","Deslocamento"));
        jFormattedTextFieldDisplacement.getAccessibleContext().setAccessibleDescription(ReCResourceBundle.findStringOrDefault("wpucscl$jSliderDisplacement.toolTipText","Deslocamento"));

        jPanelNrPoints.setBorder(javax.swing.BorderFactory.createTitledBorder(ReCResourceBundle.findStringOrDefault("wpucscl$jPanelNrPoints.border.title","Samples")));
        ...
        jSliderNrPoints.getAccessibleContext().setAccessibleDescription(ReCResourceBundle.findStringOrDefault("wpucscl$jFormattedTextFieldNrPoints.toolTipText","Amostras"));
        jFormattedTextFieldNrPoints.getAccessibleContext().setAccessibleDescription(ReCResourceBundle.findStringOrDefault("wpucscl$jFormattedTextFieldNrPoints.toolTipText","Amostras"));
        ...
        jPanelPenduloDisplacement.getAccessibleContext().setAccessibleName(ReCResourceBundle.findStringOrDefault("wpucscl$jPanelPenduloDisplacement.border.title","Initial Displacement"));
        jPanelPenduloDisplacement.getAccessibleContext().setAccessibleDescription(ReCResourceBundle.findStringOrDefault("wpucscl$jPanelPenduloDisplacement.border.title","Initial Displacement"));
        jPanelNrPoints.getAccessibleContext().setAccessibleName(ReCResourceBundle.findStringOrDefault("wpucscl$jPanelNrPoints.border.title","Samples"));
        jPanelNrPoints.getAccessibleContext().setAccessibleDescription(ReCResourceBundle.findStringOrDefault("wpucscl$jPanelNrPoints.border.title","Samples"));
        jLabelEstimatedTime.getAccessibleContext().setAccessibleName(ReCResourceBundle.findStringOrDefault("wpucscl$jLabelEstimatedTime.text","Tempo Estimado"));
        jLabelEstimatedTime.getAccessibleContext().setAccessibleDescription(ReCResourceBundle.findStringOrDefault("wpucscl$jLabelEstimatedTime.text","Tempo Estimado"));

        jTabbedPaneWorldPendulum.addTab(ReCResourceBundle.findStringOrDefault("wpucscl$jPanelPendulumConfig.TabConstraints.tabTitle","Configure"), null, jPanelPendulumConfig, resourceMap.getString("jPanelPendulumConfig.TabConstraints.tabToolTip")); // NOI18N

        add(jTabbedPaneWorldPendulum, java.awt.BorderLayout.CENTER);
        jTabbedPaneWorldPendulum.getAccessibleContext().setAccessibleName(ReCResourceBundle.findStringOrDefault("wpucscl$jPanelPendulumConfig.TabConstraints.tabTitle","Configure"));
        ...
        jButtonCancel.setText(ReCResourceBundle.findStringOrDefault("wpucscl$Cancel.label","Cancel"));
        ...
        jButtonDefaultConfig.setText(ReCResourceBundle.findStringOrDefault("wpucscl$DefaultConfig.label","Default Config"));
        ...
        jButtonCancel.getAccessibleContext().setAccessibleName(ReCResourceBundle.findStringOrDefault("wpucscl$jButtonCancel.AccessibleContext.accessibleName","Cancel"));
        jButtonDefaultConfig.getAccessibleContext().setAccessibleName(ReCResourceBundle.findStringOrDefault("wpucscl$jButtonDefaultConfig.AccessibleContext.accessibleName","Default Config"));
...
private void jFormattedTextFieldNrPointsFocusLost(java.awt.event.FocusEvent evt) {//GEN-FIRST:event_jFormattedTextFieldNrPointsFocusLost
	...
	private void jButtonOkActionPerformed(final java.awt.event.ActionEvent evt) {// GEN-FIRST:event_jButtonOkActionPerformed
		...
		Frequency freq = null;                
            ...
            getAcquisitionConfig().getSelectedHardwareParameter("wpucscl$parameter.displacement").setParameterValue(String.valueOf(displacement));
            getAcquisitionConfig().getSelectedHardwareParameter("wpucscl$parameter.nrpoints").setParameterValue(String.valueOf(nsamples));        
	...
	public javax.swing.ImageIcon getCustomizerIcon() {
		return new javax.swing.ImageIcon(getClass().getResource(
				"/pt/utl/ist/elab/client/wpucscl/resources/wpucscl_iconified.gif"));
	}

	@Override
	public String getCustomizerTitle() {
		return ReCResourceBundle.findStringOrDefault("wpucscl$rec.exp.wpucscl.customizer.title","wpucscl$rec.exp.wpucscl.customizer.title");
	}
