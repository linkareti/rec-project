 ...
 */
public class PVCustomizer extends AbstractCustomizer {
	...
	private void initComponents() {
		...
		jPanel6.setBorder(javax.swing.BorderFactory.createTitledBorder(ReCResourceBundle.findStringOrDefault(
				"boylemariotte$rec.exp.customizer.title2", "boylemariotte$rec.exp.customizer.title2"))); // NOI18N
		...
		lblErrorSamplesTooHigh.setText(ReCResourceBundle.findStringOrDefault("boylemariotte$rec.exp.customizer.label2",
				"boylemariotte$rec.exp.customizer.label2")); // NOI18N
		...
		jPanel1.setBorder(javax.swing.BorderFactory.createTitledBorder(ReCResourceBundle.findStringOrDefault(
				"boylemariotte$rec.exp.customizer.title3", "boylemariotte$rec.exp.customizer.title3"))); // NOI18N
		...
		jPanel5.setBorder(javax.swing.BorderFactory.createTitledBorder(ReCResourceBundle.findStringOrDefault(
				"boylemariotte$rec.exp.customizer.title1", "boylemariotte$rec.exp.customizer.title1"))); // NOI18N
		...
		lblErrorVolsAreEqua.setText(ReCResourceBundle.findStringOrDefault("boylemariotte$rec.exp.customizer.label1",
				"boylemariotte$rec.exp.customizer.label1")); // NOI18N
	...
	private void checkMaxNumSamples() {
		lblErrorSamplesTooHigh
				.setEnabled((float) Math.abs(sldPos2.getValue() - sldPos1.getValue()) < 20 * sldNumSamples.getValue());
		btnOK.setEnabled(!lblErrorVolsAreEqua.isEnabled() && !lblErrorSamplesTooHigh.isEnabled());
		lblErrorSamplesTooHigh.setText(ReCResourceBundle.findStringOrDefault("boylemariotte$rec.exp.customizer.label2",
				"boylemariotte$rec.exp.customizer.label2")
				+ (int) (Math.floor((float) Math.abs(sldPos2.getValue() - sldPos1.getValue())) / 20.F));
	}

	public void checkMaxTime() {
		// float maxValue = Math.min((float) sldFreq.getMaximum(), 72000.F /
		// (float) sldNumSamples.getValue());
	...
	{// GEN-HEADEREND:event_btnOKActionPerformed
		getAcquisitionConfig().getSelectedHardwareParameter("vol_init").setParameterValue("" + (sldPos1.getValue()));
		getAcquisitionConfig().getSelectedHardwareParameter("vol_final").setParameterValue("" + (sldPos2.getValue()));
	...
	public String getCustomizerTitle() {
		return ReCResourceBundle.findStringOrDefault("boylemariotte$rec.exp.boylemariotte.customizer.title",
				"boylemariotte$rec.exp.boylemariotte.customizer.title");
	}
}
