 ...
 * 
 */
public class OpticaCustomizer extends AbstractCustomizer {
	...
	private void initComponents()// GEN-BEGIN:initComponents
	{
		...
		jPanel6.setBorder(new javax.swing.border.TitledBorder(ReCResourceBundle.findStringOrDefault(
				"optica$rec.exp.customizer.title2", "optica$rec.exp.customizer.title2")));
		...
		lblErrorSamplesTooHigh.setText(ReCResourceBundle.findStringOrDefault("optica$rec.exp.customizer.label2",
				"optica$rec.exp.customizer.label2"));
		...
		jPanel1.setBorder(new javax.swing.border.TitledBorder(ReCResourceBundle.findStringOrDefault(
				"optica$rec.exp.customizer.title3", "optica$rec.exp.customizer.title3")));
		...
		lblSamplingIntervalTooHigh.setText(ReCResourceBundle.findStringOrDefault("optica$rec.exp.customizer.label3",
				"optica$rec.exp.customizer.label3"));
		...
		jPanel5.setBorder(new javax.swing.border.TitledBorder(ReCResourceBundle.findStringOrDefault(
				"optica$rec.exp.customizer.title1", "optica$rec.exp.customizer.title1")));
		...
		lblErrorVolsAreEqua.setText(ReCResourceBundle.findStringOrDefault("optica$rec.exp.customizer.label1",
				"optica$rec.exp.customizer.label1"));
	...
	public void checkMaxTime() {
		...
		btnOK.setEnabled(!lblErrorVolsAreEqua.isEnabled() && !lblErrorSamplesTooHigh.isEnabled()
				&& !lblSamplingIntervalTooHigh.isEnabled());
		lblSamplingIntervalTooHigh.setText(ReCResourceBundle.findStringOrDefault("optica$rec.exp.customizer.label2",
				"optica$rec.exp.customizer.label2") + (int) maxValue);
	}
	...
	{// GEN-HEADEREND:event_btnOKActionPerformed
		...
		getAcquisitionConfig().getSelectedHardwareParameter("ang1_min").setParameterValue(
				"" + (sldPos1.getValue() / 10.F));
		getAcquisitionConfig().getSelectedHardwareParameter("ang1_max").setParameterValue(
				"" + (sldPos2.getValue() / 10.F));
	...
	public String getCustomizerTitle() {
		return ReCResourceBundle.findStringOrDefault("optica$rec.exp.optica.customizer.title",
				"optica$rec.exp.optica.customizer.title");
	}
