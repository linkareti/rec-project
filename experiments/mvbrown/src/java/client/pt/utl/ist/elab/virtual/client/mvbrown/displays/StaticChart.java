 ...
 * StaticCharts.java
 *
 * Created on 26 de Março de 2005, 0:35
 */
...
public class StaticChart extends javax.swing.JPanel implements Printable, ActionListener, MouseListener {
    ...
    protected pt.utl.ist.elab.virtual.guipack.PopupMenu viewPopMenu;
    ...
    private void buildPopupMenu(){
        viewPopMenu = new pt.utl.ist.elab.virtual.guipack.PopupMenu(this);
