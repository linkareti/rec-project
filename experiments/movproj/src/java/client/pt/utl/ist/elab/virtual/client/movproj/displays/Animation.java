...
import pt.utl.ist.elab.virtual.client.movproj.MovProj;
...
public class Animation extends MovProj implements ExpDataDisplay, ExpDataModelListener {
    ...
    public void moves(double x, double y, double z, double vx, double vy, double vz, double ax, double ay, double az, double t){
        ...
        statusStr = "X : "+pt.utl.ist.elab.virtual.guipack.GUtils.trimDecimalN(x,5)+" m | Y : "+pt.utl.ist.elab.virtual.guipack.GUtils.trimDecimalN(y,5)+" m | Z : "+pt.utl.ist.elab.virtual.guipack.GUtils.trimDecimalN(x,5)+" m | t : "+pt.utl.ist.elab.virtual.guipack.GUtils.trimDecimalN(t,5)+" t";
        repaint();
    }
