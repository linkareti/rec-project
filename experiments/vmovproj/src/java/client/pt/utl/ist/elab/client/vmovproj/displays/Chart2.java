...
public class Chart2 extends com.linkare.rec.impl.baseUI.graph.DefaultXYExperimentGraph {
	 ...
	 * 
	 */
	private static final long serialVersionUID = 8422575595891201573L;
	...
	public void dataModelStartedNoData() {
		...
		final String[] graph2 = StringUtils.splitArroundPoint(header.getSelectedHardwareParameterValue("graph2"));
