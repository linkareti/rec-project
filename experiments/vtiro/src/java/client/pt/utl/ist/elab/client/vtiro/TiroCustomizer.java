...
public class TiroCustomizer extends javax.swing.JPanel implements com.linkare.rec.impl.client.customizer.ICustomizer {
	...
	private void initComponents() {// GEN-BEGIN:initComponents
		...
		okButton.setText(java.util.ResourceBundle.getBundle("pt/utl/ist/elab/virtual/client/tiro/resources/ReCExpTiro")
				.getString("rec.exp.customizer.title.ok"));
		okButton.setToolTipText(java.util.ResourceBundle.getBundle(
				"pt/utl/ist/elab/virtual/client/tiro/resources/ReCExpTiro").getString("rec.exp.customizer.tip.ok"));
		...
		cancelButton.setText(java.util.ResourceBundle.getBundle(
				"pt/utl/ist/elab/virtual/client/tiro/resources/ReCExpTiro")
				.getString("rec.exp.customizer.title.cancel"));
		cancelButton.setToolTipText(java.util.ResourceBundle.getBundle(
				"pt/utl/ist/elab/virtual/client/tiro/resources/ReCExpTiro").getString("rec.exp.customizer.tip.cancel"));
		...
		defaultButton.setText(java.util.ResourceBundle.getBundle(
				"pt/utl/ist/elab/virtual/client/tiro/resources/ReCExpTiro").getString("rec.exp.customizer.title.dfc"));
		defaultButton.setToolTipText(java.util.ResourceBundle.getBundle(
				"pt/utl/ist/elab/virtual/client/tiro/resources/ReCExpTiro").getString("rec.exp.customizer.tip.dfc"));
		...
		gPanel.setBorder(new javax.swing.border.TitledBorder(java.util.ResourceBundle.getBundle(
				"pt/utl/ist/elab/virtual/client/tiro/resources/ReCExpTiro").getString("rec.exp.customizer.title.2")));
		gPanel.setToolTipText(java.util.ResourceBundle.getBundle(
				"pt/utl/ist/elab/virtual/client/tiro/resources/ReCExpTiro").getString("rec.exp.customizer.tip.2"));
	...
	public javax.swing.ImageIcon getCustomizerIcon() {
		return new javax.swing.ImageIcon(getClass().getResource(
				"/pt/utl/ist/elab/virtual/client/tiro/resources/tiro_iconified.PNG"));
	}
