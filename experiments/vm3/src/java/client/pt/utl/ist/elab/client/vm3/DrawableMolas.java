	...
	public void fazMexer(double mousex, double mousey) {
		try {
			...
			if (gui.textX.getText().equals("5.0") && gui.textY.getText().equals("5.0")) {
				...
				gui.labelInf1.setText(ReCResourceBundle.findStringOrDefault("m3$rec.exp.customizer.title.9",
						"Please disturb the system"));
				gui.labelInf2.setText(ReCResourceBundle.findStringOrDefault("m3$rec.exp.customizer.title.10",
