...
public class RollPaperDataProducer extends VirtualBaseDataSource implements ODE {
	...
	public RollPaperDataProducer(final VirtualBaseDriver driver, final float theta, final float phi, final float thetaDot,
