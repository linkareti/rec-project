...
},applyActiveFilterStyle:function(element){if(element&&((element.tagName.toLowerCase()=="input"&&element.type=="text")||element.tagName.toLowerCase()=="select")){if($F(element)!=""){element.addClassName("xwiki-livetable-filter-active")
