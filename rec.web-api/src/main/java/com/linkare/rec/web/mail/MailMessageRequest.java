...
public class MailMessageRequest implements Serializable {
	...
	public MailMessageRequest(MailMessageRequest request, String to,
			String[] recipients) {
		this(request.getFrom(), to, recipients, request.getContent(), request
				.getMailFormat(), request.getSubject(), request
				.getAttachments(), request.getMimeParts());
		this.clientLocale = request.getClientLocale();
		setMailProperties(request.getRecipientsPerBlockMaxSize(),
				request.getMaxFailCount(), request.getSendMailRetryMillis());
	}

	@SuppressWarnings("PMD.ArrayIsStoredDirectly")
	public MailMessageRequest(String from, String to, String[] recipients,
			String content, MailFormatEnum mailFormat, String subject,
	...
	public final void setMailProperties(int recipientsPerBlockMaxSize,
			int maxFailCount, int sendMailRetryMillis) {
	...
	public String toShortString() {
		return "[from=" + from + ", to=" + to + ", recipients="
				+ Arrays.toString(recipients) + ", subject=" + subject + "]";
	}

	@Override
	public String toString() {
		return "MailMessageRequest [from=" + from + ", to=" + to
				+ ", recipients=" + Arrays.toString(recipients) + ", content="
				+ content + ", mailFormat=" + mailFormat + ", subject="
				+ subject + ", attachments=" + attachments + ", mimeParts="
				+ mimeParts + ", clientLocale=" + clientLocale + "]";
	}
}
