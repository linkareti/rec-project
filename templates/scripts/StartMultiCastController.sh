...
export MULTICAST_ORB_SYSPROPS="-Dopenorb.profile=ReCMultiCastController -DReC.MultiCastController.BindName=MultiCastController -DReC.MultiCastController.InitRef=MultiCastController -DReC.PercentFreeMemoryThreshold2Serialization=10 -DReC.MultiCastDataProducer.GET_SAMPLES_IDLE_TIME=60"
...
export SECURITYMANAGER_SYSPROPS=""
...
export ALLOCATIONMANAGER_SYSPROPS=""
