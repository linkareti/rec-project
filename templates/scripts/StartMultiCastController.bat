...
set GENERIC_ORB_SYSPROPS=-Dorg.omg.CORBA.ORBClass=org.openorb.orb.core.ORB -Dorg.omg.CORBA.ORBSingletonClass=org.openorb.orb.core.ORBSingleton -Dopenorb.config=%MULTICAST_BASE_DIR%/etc/openorb.xml -Djava.net.preferIPv4Stack=true
...
set MULTICAST_CLASSPATH=%MULTICAST_BASE_DIR%/ReCMulticastController.jar;%MULTICAST_BASE_DIR%/ELabMulticastController.jar;%MULTICAST_BASE_DIR%/ReCCommon.jar;%MULTICAST_BASE_DIR%/lib/rec.web-api-0.0.1-SNAPSHOT.jar;%MULTICAST_BASE_DIR%/lib/commons-0.0.1.jar;%MULTICAST_BASE_DIR%/lib/glassfish/ejb-container.jar;%MULTICAST_BASE_DIR%/lib/glassfish/appclient.security.jar
