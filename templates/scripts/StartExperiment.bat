...
set DRIVER_ORB_SYSPROPS=-Dopenorb.profile=ReCHardware -DReC.MultiCastController.InitRef=MultiCastController
...
set DRIVER_HARWARE_INFO_SYSPROPS=-DHardwareInfo=HardwareInfo.xml
set TOOLKIT_SYSPROPS=-Dawt.toolkit=sun.awt.motif.MToolkit -Djava.awt.headless=true

set RECCLASSPATH=%DRIVER_BASE_DIR%/lib/xml-apis.jar;%DRIVER_BASE_DIR%/lib/tools-1.4.0.jar;%DRIVER_BASE_DIR%/lib/openorb_orb-1.4.0.jar;%DRIVER_BASE_DIR%/lib/openorb_pss-1.4.0.jar;%DRIVER_BASE_DIR%/lib/openorb_orb_omg-1.4.0.jar;%DRIVER_BASE_DIR%/lib/openorb_ots-1.4.0.jar;%DRIVER_BASE_DIR%/lib/logkit.jar;%DRIVER_BASE_DIR%/lib/xercesImpl.jar;%DRIVER_BASE_DIR%/lib/avalon-framework.jar;%DRIVER_BASE_DIR%/lib/OSP.jar
...
set DEBUG=-Xdebug -Xnoagent -Djava.compiler=NONE -Xrunjdwp:transport=dt_socket,server=y,address=60001,suspend=n 
...
java -classpath %RECCLASSPATH%;%DRIVER_CLASSPATH% %GENERIC_ORB_SYSPROPS% %DRIVER_ORB_SYSPROPS% %LOG_SYSPROPS% %MEM_SYSPROPS% %DRIVER_HARWARE_INFO_SYSPROPS% %TOOLKIT_SYSPROPS% %DEBUG% @driver.main.class@ &
