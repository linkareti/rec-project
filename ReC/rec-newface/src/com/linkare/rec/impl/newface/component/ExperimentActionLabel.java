...
public class ExperimentActionLabel extends JLabel {
	...
	public enum State {
		...
		GREEN (new Color(75, 104, 48), new Color(208, 231, 197), Color.white),
		YELLOW (new Color(109, 99, 54), new Color(247, 242, 186), Color.white),
		RED	(new Color(186, 44, 54), new Color(251, 209, 199), Color.white);
	...
	private void updateStateUI(State state) {
		...
		setBorder(BorderFactory.createCompoundBorder(
				BorderFactory.createLineBorder(state.getBorderColor()), 
