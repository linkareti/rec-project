...
public class WorldPendulumCustomizerPanel extends AbstractCustomizer {
	...
	public WorldPendulumCustomizerPanel() {
		labelBegin = ReCResourceBundle.findStringOrDefault("wputfsmvap$jLabelEstimatedTime.text.beggining","Estimated time is");
                labelEnd = ReCResourceBundle.findStringOrDefault("wputfsmvap$jLabelEstimatedTime.text.end","minutes");
    ...
    private void initComponents() {
        ...
        jPanelPenduloDisplacement.setBorder(javax.swing.BorderFactory.createTitledBorder(ReCResourceBundle.findStringOrDefault("wputfsmvap$jPanelPenduloDisplacement.border.title","Initial Displacement")));
        ...
        jSliderDisplacement.setToolTipText(ReCResourceBundle.findStringOrDefault("wputfsmvap$jSliderDisplacement.toolTipText","Initial Displacement"));
        ...
        jSliderDisplacement.getAccessibleContext().setAccessibleName(ReCResourceBundle.findStringOrDefault("wputfsmvap$jSliderDisplacement.toolTipText","Deslocamento"));
        jSliderDisplacement.getAccessibleContext().setAccessibleDescription(ReCResourceBundle.findStringOrDefault("wputfsmvap$jSliderDisplacement.toolTipText","Deslocamento"));
        jFormattedTextFieldDisplacement.getAccessibleContext().setAccessibleDescription(ReCResourceBundle.findStringOrDefault("wputfsmvap$jSliderDisplacement.toolTipText","Deslocamento"));

        jPanelNrPoints.setBorder(javax.swing.BorderFactory.createTitledBorder(ReCResourceBundle.findStringOrDefault("wputfsmvap$jPanelNrPoints.border.title","Samples")));
        ...
        jSliderNrPoints.getAccessibleContext().setAccessibleDescription(ReCResourceBundle.findStringOrDefault("wputfsmvap$jFormattedTextFieldNrPoints.toolTipText","Amostras"));
        jFormattedTextFieldNrPoints.getAccessibleContext().setAccessibleDescription(ReCResourceBundle.findStringOrDefault("wputfsmvap$jFormattedTextFieldNrPoints.toolTipText","Amostras"));
        ...
        jPanelPenduloDisplacement.getAccessibleContext().setAccessibleName(ReCResourceBundle.findStringOrDefault("wputfsmvap$jPanelPenduloDisplacement.border.title","Initial Displacement"));
        jPanelPenduloDisplacement.getAccessibleContext().setAccessibleDescription(ReCResourceBundle.findStringOrDefault("wputfsmvap$jPanelPenduloDisplacement.border.title","Initial Displacement"));
        jPanelNrPoints.getAccessibleContext().setAccessibleName(ReCResourceBundle.findStringOrDefault("wputfsmvap$jPanelNrPoints.border.title","Samples"));
        jPanelNrPoints.getAccessibleContext().setAccessibleDescription(ReCResourceBundle.findStringOrDefault("wputfsmvap$jPanelNrPoints.border.title","Samples"));
        jLabelEstimatedTime.getAccessibleContext().setAccessibleName(ReCResourceBundle.findStringOrDefault("wputfsmvap$jLabelEstimatedTime.text","Tempo Estimado"));
        jLabelEstimatedTime.getAccessibleContext().setAccessibleDescription(ReCResourceBundle.findStringOrDefault("wputfsmvap$jLabelEstimatedTime.text","Tempo Estimado"));

        jTabbedPaneWorldPendulum.addTab(ReCResourceBundle.findStringOrDefault("wputfsmvap$jPanelPendulumConfig.TabConstraints.tabTitle","Configure"), null, jPanelPendulumConfig, resourceMap.getString("jPanelPendulumConfig.TabConstraints.tabToolTip")); // NOI18N

        add(jTabbedPaneWorldPendulum, java.awt.BorderLayout.CENTER);
        jTabbedPaneWorldPendulum.getAccessibleContext().setAccessibleName(ReCResourceBundle.findStringOrDefault("wputfsmvap$jPanelPendulumConfig.TabConstraints.tabTitle","Configure"));
        ...
        jButtonCancel.setText(ReCResourceBundle.findStringOrDefault("wputfsmvap$Cancel.label","Cancel"));
        ...
        jButtonDefaultConfig.setText(ReCResourceBundle.findStringOrDefault("wputfsmvap$DefaultConfig.label","Default Config"));
        ...
        jButtonCancel.getAccessibleContext().setAccessibleName(ReCResourceBundle.findStringOrDefault("wputfsmvap$jButtonCancel.AccessibleContext.accessibleName","Cancel"));
        jButtonDefaultConfig.getAccessibleContext().setAccessibleName(ReCResourceBundle.findStringOrDefault("wputfsmvap$jButtonDefaultConfig.AccessibleContext.accessibleName","Default Config"));
...
private void jFormattedTextFieldNrPointsFocusLost(java.awt.event.FocusEvent evt) {//GEN-FIRST:event_jFormattedTextFieldNrPointsFocusLost
	...
	private void jButtonOkActionPerformed(final java.awt.event.ActionEvent evt) {// GEN-FIRST:event_jButtonOkActionPerformed
		...
		Frequency freq = null;                
            ...
            getAcquisitionConfig().getSelectedHardwareParameter("wputfsmvap$parameter.displacement").setParameterValue(String.valueOf(displacement));
            getAcquisitionConfig().getSelectedHardwareParameter("wputfsmvap$parameter.nrpoints").setParameterValue(String.valueOf(nsamples));        
	...
	public javax.swing.ImageIcon getCustomizerIcon() {
		return new javax.swing.ImageIcon(getClass().getResource(
				"/pt/utl/ist/elab/client/wputfsmvap/resources/wputfsmvap_iconified.gif"));
	}

	@Override
	public String getCustomizerTitle() {
		return ReCResourceBundle.findStringOrDefault("wputfsmvap$rec.exp.wputfsmvap.customizer.title","wputfsmvap$rec.exp.wputfsmvap.customizer.title");
	}
