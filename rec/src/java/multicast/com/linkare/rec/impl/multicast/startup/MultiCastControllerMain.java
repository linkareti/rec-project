		...
		try {
			...
			try {
				...
				MultiCastControllerPOATie mccpoatie = (MultiCastControllerPOATie) ORBBean.getORBBean()
						.registerRootPOAServant(MultiCastController.class, mcc, MULTICAST_INIT_REF.getBytes());
				String corbaURL = ORBBean.getORBBean().bindObjectToCorbalocService(MULTICAST_BIND_NAME,
