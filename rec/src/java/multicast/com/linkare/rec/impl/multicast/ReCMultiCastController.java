...
public class ReCMultiCastController implements MultiCastControllerOperations, ISecurityCommunicator {
    ...
    public List<HardwareInfo> unsecureEnumerateHardware() {
        ...
        final List<ReCMultiCastHardware> unsecureEnumerateHardwares = hardwareChangeAdapter.unsecureEnumerateHardwares();
    ...
    public void sendMessage(final UserInfo user, final String clientTo, final String message) throws NotRegistered,
        ...
        sendNewChatMessageNotification(new RecChatMessageDTO(user.getUserName()+" : "+ message, new Date()), NotificationTypeEnum.NEW_CHAT_MESSAGE);
    }

    public void sendMessage(final UserInfo user, final String clientTo, final String message, final boolean fromElab) throws NotRegistered,
            NotAuthorized {
        clientQueue.sendChatMessage(user, clientTo, message, resource, fromElab);
    }
    ...
    public void sendMulticastMessage(final String clientTo, final String message, final boolean fromElab) {
        clientQueue.sendMulticastChatMessage(clientTo, message, fromElab);
    }
    ...
    private void sendNewChatMessageNotification(final RecChatMessageDTO chatMessageDTO, final NotificationTypeEnum notificationType) {
        ...
        NotificationManager.getInstance().sendAsynNotification(NotificationTypeEnum.NEW_CHAT_MESSAGE, multiCastControllerNotifInfoDTO);
    }
    ...
    private void sendHardwareNotification(final ReCMultiCastHardware multiCastHardware,
        ...
        multiCastControllerNotifInfoDTO.setRegisteredHardwareDTO(DTOMapperUtils.mapToRegisteredHardwareInfoDTO(multiCastHardware.getRegisteredHardwareInfo()));
