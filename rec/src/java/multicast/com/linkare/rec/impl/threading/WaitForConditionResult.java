...
public class WaitForConditionResult extends AbstractConditionDecisor
{
	...
	public static void waitForConditionTrue(IConditionDecisor decisor,long timeout)
	throws TimedOutException
	{
	...
	public static void waitForConditionFalse(IConditionDecisor decisor,long timeout)
	throws TimedOutException
	{
	...
	private WaitForConditionResult(IConditionDecisor decisorDelegate,long timeOut,long frequencyCheck,boolean waitForTrue)
	throws TimedOutException
	{
