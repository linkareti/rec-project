...
public class MultiplierValueEditor extends AbstractSelectionListPropertyEditor {
	...
	public MultiplierValueEditor() {
		...
		addTableValue(Byte.valueOf(Multiplier.fento.getValue()), "f (1E-15)", pack + "Multiplier.fento.getValue()");
		addTableValue(Byte.valueOf(Multiplier.pico.getValue()), "p (1E-12)", pack + "Multiplier.pico.getValue()");
		addTableValue(Byte.valueOf(Multiplier.nano.getValue()), "n (1E-9)", pack + "Multiplier.nano.getValue()");
		addTableValue(Byte.valueOf(Multiplier.micro.getValue()), "\u03BC (1E-6)", pack + "Multiplier.micro.getValue()");
		addTableValue(Byte.valueOf(Multiplier.mili.getValue()), "m (1E-3)", pack + "Multiplier.mili.getValue()");
		addTableValue(Byte.valueOf(Multiplier.none.getValue()), "none (1E0)", pack + "Multiplier.none.getValue()");
		addTableValue(Byte.valueOf(Multiplier.kilo.getValue()), "k (1E3)", pack + "Multiplier.kilo.getValue()");
