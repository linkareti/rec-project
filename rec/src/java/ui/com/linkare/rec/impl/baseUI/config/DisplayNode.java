...
public abstract class DisplayNode
{
    ...
    {
	return ReCResourceBundle.findStringOrDefault(getDisplayNameBundleKey(), "<DisplayNameNotFoundInBundles="+getDisplayNameBundleKey()+">");
    }
    
    public String getToolTipText()
    {
	return ReCResourceBundle.findStringOrDefault(getToolTipBundleKey(),ReCResourceBundle.findStringOrDefault(getDisplayNameBundleKey(), "") );
    }
	...
	firePropertyChangeListenerPropertyChange(new java.beans.PropertyChangeEvent(this, "enable", new Boolean(!enabled), new Boolean(enabled)));
    }
	...
	firePropertyChangeListenerPropertyChange(new java.beans.PropertyChangeEvent(this, "connected", new Boolean(!connected), new Boolean(connected)));
    }
    ...
    public void setSelected(boolean selected)
    {
        ...
        firePropertyChangeListenerPropertyChange(new java.beans.PropertyChangeEvent(this, "selected", new Boolean(!selected), new Boolean(selected)));
    }
