...
public class Apparatus extends DisplayNode implements com.linkare.rec.impl.baseUI.config.CommonBean,OrderedItem
{
	...
	for (Iterator it = source._DefaultAcquisitionConfig.iterator();
	it.hasNext(); )
	{
	    _DefaultAcquisitionConfig.add(new com.linkare.rec.impl.baseUI.config.DefaultAcquisitionConfig((com.linkare.rec.impl.baseUI.config.DefaultAcquisitionConfig)it.next()));
	}
	for (Iterator it = source._Display.iterator();
	it.hasNext(); )
	{
	    _Display.add(new com.linkare.rec.impl.baseUI.config.Display((com.linkare.rec.impl.baseUI.config.Display)it.next()));
	}
	for (Iterator it = source._WebResource.iterator();
	it.hasNext(); )
	{
	    _WebResource.add(new com.linkare.rec.impl.baseUI.config.WebResource((com.linkare.rec.impl.baseUI.config.WebResource)it.next()));
	}
	for (Iterator it = source._LocalizationBundle.iterator();
	it.hasNext(); )
	{
	    _LocalizationBundle.add(new com.linkare.rec.impl.baseUI.config.LocalizationBundle((com.linkare.rec.impl.baseUI.config.LocalizationBundle)it.next()));
	}
	...
	if (eventListeners != null )
	{
	    event = new PropertyChangeEvent(this, "dataModelClassLocationBundleKey", getDataModelClassLocationBundleKey(), value);
	}
	...
	if (eventListeners != null )
	{
	    event = new PropertyChangeEvent(this, "headerDisplayClassLocationBundleKey", getHeaderDisplayClassLocationBundleKey(), value);
	}
	...
	if (eventListeners != null )
	{
	    event = new PropertyChangeEvent(this, "displayFactoryClassLocationBundleKey", getDisplayFactoryClassLocationBundleKey(), value);
	}
	...
	if (eventListeners != null )
	{
	    event = new PropertyChangeEvent(this, "customizerClassLocationBundleKey", getCustomizerClassLocationBundleKey(), value);
	}
	_Location = value;
	if (eventListeners != null)
	    eventListeners.firePropertyChange(event);
	...
	if (eventListeners != null)
	{
	    PropertyChangeEvent event = new PropertyChangeEvent(this, "defaultAcquisitionConfig.i"+index, _DefaultAcquisitionConfig.get(index), value);
	    eventListeners.firePropertyChange(event);
	}
	...
	if (eventListeners != null)
	{
	    PropertyChangeEvent event = new PropertyChangeEvent(this, "defaultAcquisitionConfig.i"+(_DefaultAcquisitionConfig.size()-1), null, value);
	    eventListeners.firePropertyChange(event);
	}
	...
	if (pos >= 0)
	{
	    ...
	    if (eventListeners != null)
	    {
		PropertyChangeEvent event = new PropertyChangeEvent(this, "defaultAcquisitionConfig.i"+pos, value, null);
		eventListeners.firePropertyChange(event);
	    }
	}
	return pos;
	...
	if (eventListeners != null)
	{
	    PropertyChangeEvent event = new PropertyChangeEvent(this, "webResource.i"+index, _WebResource.get(index), value);
	    eventListeners.firePropertyChange(event);
	}
	...
	if (eventListeners != null)
	{
	    PropertyChangeEvent event = new PropertyChangeEvent(this, "webResource.i"+(_WebResource.size()-1), null, value);
	    eventListeners.firePropertyChange(event);
	}
	...
	if (eventListeners != null)
	{
	    PropertyChangeEvent event = new PropertyChangeEvent(this, "localizationBundle.i"+index, _LocalizationBundle.get(index), value);
	    eventListeners.firePropertyChange(event);
	}
	...
	if (eventListeners != null)
	{
	    PropertyChangeEvent event = new PropertyChangeEvent(this, "localizationBundle.i"+(_LocalizationBundle.size()-1), null, value);
	    eventListeners.firePropertyChange(event);
	}
	...
	if (_HeaderDisplayClassLocationBundleKey != null)
	{
	    ...
	    out.write("='");	// NOI18N
	    com.linkare.rec.impl.baseUI.config.ReCBaseUIConfig.writeXML(out, _HeaderDisplayClassLocationBundleKey, true);
	    out.write("'");	// NOI18N
	}
	// headerDisplayClassLocationBundleKey is an attribute
	if (_DisplayFactoryClassLocationBundleKey != null)
	{
	    ...
	    out.write("='");	// NOI18N
	    com.linkare.rec.impl.baseUI.config.ReCBaseUIConfig.writeXML(out, _DisplayFactoryClassLocationBundleKey, true);
	    out.write("'");	// NOI18N
	}	
	...
	it.hasNext(); )
	{
	    com.linkare.rec.impl.baseUI.config.DefaultAcquisitionConfig element = (com.linkare.rec.impl.baseUI.config.DefaultAcquisitionConfig)it.next();
	    if (element != null)
	    {
	...
	for (Iterator it = _WebResource.iterator();
	it.hasNext(); )
	{
	    com.linkare.rec.impl.baseUI.config.WebResource element = (com.linkare.rec.impl.baseUI.config.WebResource)it.next();
	    if (element != null)
	    {
		element.writeNode(out, "WebResource", nextIndent);
	    }
	}
	for (Iterator it = _LocalizationBundle.iterator();
	it.hasNext(); )
	{
	    com.linkare.rec.impl.baseUI.config.LocalizationBundle element = (com.linkare.rec.impl.baseUI.config.LocalizationBundle)it.next();
	    if (element != null)
	    {
	...
	//Check if this is not optional! -> Indeed it should be optional
	/*if (getDataModelClassLocationBundleKey() == null)
	{
	    throw new ValidateException("getDataModelClassLocationBundleKey() == null", "dataModelClassLocationBundleKey", this);	// NOI18N
	}*/
	// Validating property videoLocation
	//Check if this is not optional! -> Indeed it should be optional
	/*if (getVideoLocation() == null)
	{
	    throw new ValidateException("getVideoLocation() == null", "videoLocation", this);	// NOI18N
	}*/
	// Validating property headerDisplayClassLocationBundleKey
	//Check if this is not optional! -> Indeed it should be optional
	/*if (getHeaderDisplayClassLocationBundleKey() == null)
	{
	    throw new ValidateException("getHeaderDisplayClassLocationBundleKey() == null", "headerDisplayClassLocationBundleKey", this);	// NOI18N
	}*/
	...
	for (int _index = 0; _index < sizeDefaultAcquisitionConfig();
	++_index)
	{
	...
	if (!(_IconLocationBundleKey == null ? inst._IconLocationBundleKey == null : _IconLocationBundleKey.equals(inst._IconLocationBundleKey)))
	    return false;
        if (!(_DesktopLocationBundleKey == null ? inst._DesktopLocationBundleKey == null : _DesktopLocationBundleKey.equals(inst._DesktopLocationBundleKey)))
	    return false;
	if (!(_ToolTipBundleKey == null ? inst._ToolTipBundleKey == null : _ToolTipBundleKey.equals(inst._ToolTipBundleKey)))
	    return false;
	if (!(_DataModelClassLocationBundleKey == null ? inst._DataModelClassLocationBundleKey == null : _DataModelClassLocationBundleKey.equals(inst._DataModelClassLocationBundleKey)))
	    return false;
	if (!(_VideoLocation == null ? inst._VideoLocation == null : _VideoLocation.equals(inst._VideoLocation)))
	    return false;
	if (!(_HeaderDisplayClassLocationBundleKey == null ? inst._HeaderDisplayClassLocationBundleKey == null : _HeaderDisplayClassLocationBundleKey.equals(inst._HeaderDisplayClassLocationBundleKey)))
	    return false;
	if (!(_DisplayFactoryClassLocationBundleKey == null ? inst._DisplayFactoryClassLocationBundleKey == null : _DisplayFactoryClassLocationBundleKey.equals(inst._DisplayFactoryClassLocationBundleKey)))
	    return false;	
	if (!(_Location == null ? inst._Location == null : _Location.equals(inst._Location)))
	    return false;
        if (!(_CustomizerClassLocationBundleKey == null ? inst._CustomizerClassLocationBundleKey == null : _CustomizerClassLocationBundleKey.equals(inst._CustomizerClassLocationBundleKey)))
	    return false;
	if (sizeDefaultAcquisitionConfig() != inst.sizeDefaultAcquisitionConfig())
	    return false;
	// Compare every element.
	for (Iterator it = _DefaultAcquisitionConfig.iterator(), it2 = inst._DefaultAcquisitionConfig.iterator();
	it.hasNext() && it2.hasNext(); )
	{
	    com.linkare.rec.impl.baseUI.config.DefaultAcquisitionConfig element = (com.linkare.rec.impl.baseUI.config.DefaultAcquisitionConfig)it.next();
	    com.linkare.rec.impl.baseUI.config.DefaultAcquisitionConfig element2 = (com.linkare.rec.impl.baseUI.config.DefaultAcquisitionConfig)it2.next();
	...
	if (sizeDisplay() != inst.sizeDisplay())
	    return false;
	// Compare every element.
	for (Iterator it = _Display.iterator(), it2 = inst._Display.iterator();
	it.hasNext() && it2.hasNext(); )
	{
	    com.linkare.rec.impl.baseUI.config.Display element = (com.linkare.rec.impl.baseUI.config.Display)it.next();
	    com.linkare.rec.impl.baseUI.config.Display element2 = (com.linkare.rec.impl.baseUI.config.Display)it2.next();
	    if (!(element == null ? element2 == null : element.equals(element2)))
		return false;
	}
	if (sizeWebResource() != inst.sizeWebResource())
	    return false;
	// Compare every element.
	for (Iterator it = _WebResource.iterator(), it2 = inst._WebResource.iterator();
	it.hasNext() && it2.hasNext(); )
	{
	    com.linkare.rec.impl.baseUI.config.WebResource element = (com.linkare.rec.impl.baseUI.config.WebResource)it.next();
	    com.linkare.rec.impl.baseUI.config.WebResource element2 = (com.linkare.rec.impl.baseUI.config.WebResource)it2.next();
	    if (!(element == null ? element2 == null : element.equals(element2)))
		return false;
	}
	if (sizeLocalizationBundle() != inst.sizeLocalizationBundle())
	    return false;
	// Compare every element.
	for (Iterator it = _LocalizationBundle.iterator(), it2 = inst._LocalizationBundle.iterator();
	it.hasNext() && it2.hasNext(); )
	{
	    com.linkare.rec.impl.baseUI.config.LocalizationBundle element = (com.linkare.rec.impl.baseUI.config.LocalizationBundle)it.next();
	    com.linkare.rec.impl.baseUI.config.LocalizationBundle element2 = (com.linkare.rec.impl.baseUI.config.LocalizationBundle)it2.next();
	    if (!(element == null ? element2 == null : element.equals(element2)))
		return false;
	}
	return true;
	...
	result = 37*result + (_DataModelClassLocationBundleKey == null ? 0 : _DataModelClassLocationBundleKey.hashCode());
	result = 37*result + (_VideoLocation == null ? 0 : _VideoLocation.hashCode());
	result = 37*result + (_HeaderDisplayClassLocationBundleKey == null ? 0 : _HeaderDisplayClassLocationBundleKey.hashCode());
	result = 37*result + (_DisplayFactoryClassLocationBundleKey == null ? 0 : _DisplayFactoryClassLocationBundleKey.hashCode());	
	result = 37*result + (_Location == null ? 0 : _Location.hashCode());
        result = 37*result + (_CustomizerClassLocationBundleKey == null ? 0 : _CustomizerClassLocationBundleKey.hashCode());
