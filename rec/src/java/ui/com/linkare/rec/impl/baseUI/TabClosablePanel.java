...
public class TabClosablePanel extends javax.swing.JPanel
{
    ...
    private void initComponents()//GEN-BEGIN:initComponents
    {
        ...
        jButtonClose.setIcon(com.linkare.rec.impl.i18n.ReCResourceBundle.findImageIconOrDefault("ReCBaseUI$rec.bui.icon.close", new javax.swing.ImageIcon(getClass().getResource("/com/linkare/rec/impl/baseUI/resources/Close16.gif"))));
        jButtonClose.setToolTipText(	com.linkare.rec.impl.i18n.ReCResourceBundle.findStringOrDefault("ReCBaseUI$rec.bui.tip.closeTab", "Close the current tab"));
	...
	firePropertyChangeListenerPropertyChange(new java.beans.PropertyChangeEvent(this, "closed", Boolean.FALSE, Boolean.TRUE));
