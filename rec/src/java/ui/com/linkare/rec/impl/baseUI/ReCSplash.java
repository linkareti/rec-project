...
public class ReCSplash extends javax.swing.JDialog {
	...
	private void initComponents()// GEN-BEGIN:initComponents
	{
		...
		setTitle(ReCResourceBundle.findStringOrDefault("ReCBaseUI$rec.bui.status.loading.experiment",
				"Loading Experiment"));
		...
		jPanel1.setBorder(new javax.swing.border.LineBorder(javax.swing.UIManager.getDefaults()
				.getColor("Button.focus"), 1, true));
		...
		jProgressBar1.setString(ReCResourceBundle.findStringOrDefault("ReCBaseUI$rec.bui.status.loading.experiment",
				"Loading Experiment"));
