...
public class DefaultExperimentDataTable extends javax.swing.JPanel implements ExpDataDisplay, Printable {
    ...
    private void initComponents()// GEN-BEGIN:initComponents
    {
        ...
        final org.jdesktop.application.ResourceMap resourceMap = org.jdesktop.application.Application.getInstance(com.linkare.rec.impl.newface.ReCApplication.class).getContext().getResourceMap(ResultsActionBar.class);

        toolBarTable.setRollover(true);
        toolBarTable.setOpaque(false);

        final javax.swing.ActionMap actionMap = org.jdesktop.application.Application.getInstance(com.linkare.rec.impl.newface.ReCApplication.class).getContext().getActionMap(DefaultExperimentDataTable.class, this);
