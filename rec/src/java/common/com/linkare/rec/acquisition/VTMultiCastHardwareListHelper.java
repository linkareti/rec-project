...
public final class VTMultiCastHardwareListHelper implements org.omg.CORBA.portable.BoxedValueHelper
{
		...
		if (__typeCode == null)
		{
			synchronized (org.omg.CORBA.TypeCode.class)
			{
				if (__typeCode == null)
				{
					...
					__typeCode = org.omg.CORBA.ORB.init().create_value_box_tc(_id, "VTMultiCastHardwareList", __typeCode);
					__active = false;
				}
			}
		}
	...
	public static com.linkare.rec.acquisition.MultiCastHardware[] read(org.omg.CORBA.portable.InputStream istream)
	{
		...
		return (com.linkare.rec.acquisition.MultiCastHardware[]) ((org.omg.CORBA_2_3.portable.InputStream) istream).read_value(_instance);
	}
