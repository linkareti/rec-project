...
/**
* com/linkare/rec/acquisition/DataProducerPOATie.java .
...
public class DataProducerPOATie extends DataProducerPOA
{
  ...
  // Constructors
    ...
    public DataProducerPOATie(com.linkare.rec.acquisition.DataProducerOperations delegate, org.omg.PortableServer.POA poa) {
      this._impl = delegate;
      this._poa      = poa;
  }
