...
public final class VTDataClientListHelper implements org.omg.CORBA.portable.BoxedValueHelper
{
		...
		if (__typeCode == null)
		{
			synchronized (org.omg.CORBA.TypeCode.class)
			{
				if (__typeCode == null)
				{
					...
					__typeCode = org.omg.CORBA.ORB.init().create_alias_tc(com.linkare.rec.acquisition.DataClientListHelper.id(), "DataClientList", __typeCode);
					__typeCode = org.omg.CORBA.ORB.init().create_value_box_tc(_id, "VTDataClientList", __typeCode);
					__active = false;
				}
			}
		}
	...
	public static com.linkare.rec.acquisition.DataClient[] read(org.omg.CORBA.portable.InputStream istream)
	{
		...
		return (com.linkare.rec.acquisition.DataClient[]) ((org.omg.CORBA_2_3.portable.InputStream) istream).read_value(_instance);
	}
