...
/**
* com/linkare/rec/acquisition/NotAvailableExceptionHelper.java .
...
public abstract class NotAvailableExceptionHelper
{
      ...
      synchronized (org.omg.CORBA.TypeCode.class)
      {
        if (__typeCode == null)
        {
          ...
          _members0[0] = new org.omg.CORBA.StructMember (
            ...
            _tcOf_members0,
            null);
          __typeCode = org.omg.CORBA.ORB.init ().create_exception_tc (com.linkare.rec.acquisition.NotAvailableExceptionHelper.id (), "NotAvailableException", _members0);
          __active = false;
        }
      }
    }
  ...
  public static void write (org.omg.CORBA.portable.OutputStream ostream, com.linkare.rec.acquisition.NotAvailableException value)
  {
