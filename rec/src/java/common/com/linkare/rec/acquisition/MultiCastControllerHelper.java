...
/**
 * com/linkare/rec/acquisition/MultiCastControllerHelper.java .
 * Generated by the IDL-to-Java compiler (portable), version "3.1"
 * from I:/Projects/REC/IdlCompile/ReC7.idl
 * S�bado, 17 de Janeiro de 2004 19H00m GMT
 */
...
abstract public class MultiCastControllerHelper
{
    ...
    public static final String MULTICAST_INIT_REF = com.linkare.rec.impl.utils.Defaults.defaultIfEmpty(System.getProperty(SYSPROP_MULTICAST_INIT_REF), "MultiCastController");
	...
	if (__typeCode == null)
	{
	    __typeCode = org.omg.CORBA.ORB.init().create_interface_tc(com.linkare.rec.acquisition.MultiCastControllerHelper.id(), MULTICAST_INIT_REF);
	}
	return __typeCode;
    }
    ...
    public static void write(org.omg.CORBA.portable.OutputStream ostream, com.linkare.rec.acquisition.MultiCastController value)
    {
