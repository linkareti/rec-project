...
/**
 * com/linkare/rec/acquisition/DataProducerOperations.java . Generated by the
...
public interface DataProducerOperations {
	...
	com.linkare.rec.data.config.HardwareAcquisitionConfig getAcquisitionHeader()
			throws com.linkare.rec.acquisition.NotAvailableException;

	// and getSamples(0,getMaxPacketNum());
	com.linkare.rec.data.acquisition.SamplesPacket[] getSamples(int num_packet_start, int num_packet_end)
	...
	void registerDataReceiver(com.linkare.rec.acquisition.DataReceiver data_receiver)
