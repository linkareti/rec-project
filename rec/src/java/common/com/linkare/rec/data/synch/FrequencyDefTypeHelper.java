...
abstract public class FrequencyDefTypeHelper
{
	...
	synchronized public static org.omg.CORBA.TypeCode type()
	{
		if (__typeCode == null)
		{
			__typeCode = org.omg.CORBA.ORB.init().create_enum_tc(com.linkare.rec.data.synch.FrequencyDefTypeHelper.id(), "FrequencyDefType", new String[]
			{ "FrequencyType", "SamplingIntervalType"} );
		}
		return __typeCode;
	}
	...
	public static void write(org.omg.CORBA.portable.OutputStream ostream, com.linkare.rec.data.synch.FrequencyDefType value)
	{
