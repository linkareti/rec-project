		...
		if (__typeCode == null) {
			synchronized (org.omg.CORBA.TypeCode.class) {
				if (__typeCode == null) {
					...
					_tcOf_members0 = org.omg.CORBA.WStringValueHelper.type();
					_members0[1] = new org.omg.CORBA.StructMember("HardwareName", _tcOf_members0, null);
					_tcOf_members0 = org.omg.CORBA.WStringValueHelper.type();
					_members0[2] = new org.omg.CORBA.StructMember("HardwareVersion", _tcOf_members0, null);
					_tcOf_members0 = org.omg.CORBA.WStringValueHelper.type();
					_members0[3] = new org.omg.CORBA.StructMember("HardwareManufacturer", _tcOf_members0, null);
					_tcOf_members0 = org.omg.CORBA.WStringValueHelper.type();
					_members0[4] = new org.omg.CORBA.StructMember("DescriptionText", _tcOf_members0, null);
