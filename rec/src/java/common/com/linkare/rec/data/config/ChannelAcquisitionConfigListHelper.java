...
abstract public class ChannelAcquisitionConfigListHelper
{
	...
	synchronized public static org.omg.CORBA.TypeCode type()
	{
		if (__typeCode == null)
		{
			__typeCode = com.linkare.rec.data.config.ChannelAcquisitionConfigHelper.type();
			__typeCode = org.omg.CORBA.ORB.init().create_sequence_tc(0, __typeCode);
			__typeCode = org.omg.CORBA.ORB.init().create_alias_tc(com.linkare.rec.data.config.ChannelAcquisitionConfigListHelper.id(), "ChannelAcquisitionConfigList", __typeCode);
		}
		return __typeCode;
	}
