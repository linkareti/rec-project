...
public final class VTPhysicsValueHelper implements org.omg.CORBA.portable.BoxedValueHelper {
		...
		if (__typeCode == null) {
			synchronized (org.omg.CORBA.TypeCode.class) {
				if (__typeCode == null) {
					...
					__active = true;
					__typeCode = com.linkare.rec.data.acquisition.PhysicsValueHelper.type();
					__typeCode = org.omg.CORBA.ORB.init().create_value_box_tc(_id, "VTPhysicsValue", __typeCode);
					__active = false;
				}
			}
		}
	...
	public java.io.Serializable read_value(org.omg.CORBA.portable.InputStream istream) {
		com.linkare.rec.data.acquisition.PhysicsValue tmp = com.linkare.rec.data.acquisition.PhysicsValueHelper
				.read(istream);
		return (java.io.Serializable) tmp;
	}

	public static void write(org.omg.CORBA.portable.OutputStream ostream,
			com.linkare.rec.data.acquisition.PhysicsValue value) {
