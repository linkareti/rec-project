			...
			synchronized (org.omg.CORBA.TypeCode.class) {
				if (__typeCode == null) {
					...
					__typeCode = org.omg.CORBA.ORB.init()
							.create_alias_tc(com.linkare.rec.data.metadata.HardwareParameterHelper.id(),
									"HardwareParameter", __typeCode);
					...
					__typeCode = org.omg.CORBA.ORB.init().create_alias_tc(
							...
							__typeCode);
					__typeCode = org.omg.CORBA.ORB.init().create_value_box_tc(_id, "VTHardwareParameterList",
							__typeCode);
					__active = false;
				}
			}
