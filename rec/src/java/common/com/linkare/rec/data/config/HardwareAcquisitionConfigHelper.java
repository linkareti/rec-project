...
abstract public class HardwareAcquisitionConfigHelper {
	...
	public static com.linkare.rec.data.config.HardwareAcquisitionConfig read(org.omg.CORBA.portable.InputStream istream) {
		...
		new_one.setTimeStart((com.linkare.rec.data.synch.DateTime) com.linkare.rec.data.synch.DateTimeHelper
				.read(istream));
		new_one.setSelectedFrequency((com.linkare.rec.data.synch.Frequency) com.linkare.rec.data.synch.FrequencyHelper
				.read(istream));
		new_one.setChannelsConfig(com.linkare.rec.data.config.ChannelAcquisitionConfigListHelper.read(istream));
		new_one
				.setSelectedHardwareParameters((com.linkare.rec.data.config.ParameterConfig[]) com.linkare.rec.data.config.VTHardwareParameterConfigListHelper
						.read(istream));
	...
	public static void write(org.omg.CORBA.portable.OutputStream ostream,
			com.linkare.rec.data.config.HardwareAcquisitionConfig value) {
		...
		com.linkare.rec.data.config.VTHardwareParameterConfigListHelper.write(ostream, value
