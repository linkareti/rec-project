		...
		if (__typeCode == null)
		{
			synchronized (org.omg.CORBA.TypeCode.class)
			{
				if (__typeCode == null)
				{
					...
					__typeCode = org.omg.CORBA.ORB.init().create_alias_tc(com.linkare.rec.data.metadata.ParameterValueHelper.id(), "ParameterValue", __typeCode);
					__typeCode = org.omg.CORBA.ORB.init().create_sequence_tc(0, __typeCode);
					__typeCode = org.omg.CORBA.ORB.init().create_alias_tc(com.linkare.rec.data.metadata.ParameterSelectionListHelper.id(), "ParameterSelectionList", __typeCode);
					__typeCode = org.omg.CORBA.ORB.init().create_value_box_tc(_id, "VTParameterSelectionList", __typeCode);
					__active = false;
				}
			}
		}
