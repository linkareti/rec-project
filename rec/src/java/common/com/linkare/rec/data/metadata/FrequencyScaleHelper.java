		...
		if (__typeCode == null)
		{
			synchronized (org.omg.CORBA.TypeCode.class)
			{
				if (__typeCode == null)
				{
					...
					"frequency_scale_label",
					_tcOf_members0,
					null);
					__typeCode = org.omg.CORBA.ORB.init().create_struct_tc(com.linkare.rec.data.metadata.FrequencyScaleHelper.id(), "FrequencyScale", _members0);
					__active = false;
				}
			}
		}
