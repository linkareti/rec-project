...
public final class Frequency implements org.omg.CORBA.portable.IDLEntity
{
	...
	//
	public Frequency(double frequency, com.linkare.rec.data.Multiplier applied_multiplier,FrequencyDefType frequency_def_type)
	{
	...
	{
		if(frequency<=0) throw new RuntimeException("Frequency values must be positive: value tried=" + frequency);
