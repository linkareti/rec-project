...
public final class SamplesPacket implements org.omg.CORBA.portable.IDLEntity {
	...
	//
	public SamplesPacket(int packet_number, int total_packets,
			com.linkare.rec.data.acquisition.PhysicsValue[][] the_data) {
	...
	//
	public SamplesPacket(int packet_number, int total_packets,
			com.linkare.rec.data.acquisition.PhysicsValue[][] the_data, com.linkare.rec.data.synch.DateTime time_start) {
