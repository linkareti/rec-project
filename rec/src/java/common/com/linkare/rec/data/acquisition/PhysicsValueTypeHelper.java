...
abstract public class PhysicsValueTypeHelper
{
	...
	synchronized public static org.omg.CORBA.TypeCode type()
	{
		if (__typeCode == null)
		{
			__typeCode = org.omg.CORBA.ORB.init().create_enum_tc(com.linkare.rec.data.acquisition.PhysicsValueTypeHelper.id(), "PhysicsValueType", new String[]
			{ "BooleanVal", "ByteVal", "ShortVal", "IntVal", "LongVal", "FloatVal", "DoubleVal", "ByteArrayVal"} );
		}
		return __typeCode;
	}
	...
	public static void write(org.omg.CORBA.portable.OutputStream ostream, com.linkare.rec.data.acquisition.PhysicsValueType value)
	{
