...
abstract public class ChannelParameterConfigListHelper
{
	...
	synchronized public static org.omg.CORBA.TypeCode type()
	{
		if (__typeCode == null)
		{
			...
			__typeCode = org.omg.CORBA.ORB.init().create_alias_tc(com.linkare.rec.data.config.ChannelParameterConfigListHelper.id(), "ChannelParameterConfigList", __typeCode);
		}
		return __typeCode;
	}
