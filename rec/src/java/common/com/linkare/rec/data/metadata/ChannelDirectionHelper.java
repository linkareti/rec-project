...
abstract public class ChannelDirectionHelper
{
	...
	synchronized public static org.omg.CORBA.TypeCode type()
	{
		if (__typeCode == null)
		{
			__typeCode = org.omg.CORBA.ORB.init().create_enum_tc(com.linkare.rec.data.metadata.ChannelDirectionHelper.id(), "ChannelDirection", new String[]
	...
	public static void write(org.omg.CORBA.portable.OutputStream ostream, com.linkare.rec.data.metadata.ChannelDirection value)
	{
