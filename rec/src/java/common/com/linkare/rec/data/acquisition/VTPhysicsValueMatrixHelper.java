		...
		if (__typeCode == null)
		{
			synchronized (org.omg.CORBA.TypeCode.class)
			{
				if (__typeCode == null)
				{
					...
					__active = true;
					__typeCode = com.linkare.rec.data.acquisition.VTPhysicsValueListHelper.type();
					__typeCode = org.omg.CORBA.ORB.init().create_sequence_tc(0, __typeCode);
					__typeCode = org.omg.CORBA.ORB.init().create_alias_tc(com.linkare.rec.data.acquisition.PhysicsValueMatrixHelper.id(), "PhysicsValueMatrix", __typeCode);
					__typeCode = org.omg.CORBA.ORB.init().create_value_box_tc(_id, "VTPhysicsValueMatrix", __typeCode);
					__active = false;
				}
			}
		}
