...
abstract public class ChannelAcquisitionConfigHelper {
	...
	public static com.linkare.rec.data.config.ChannelAcquisitionConfig read(org.omg.CORBA.portable.InputStream istream) {
		...
		new_one.setTimeStart((com.linkare.rec.data.synch.DateTime) com.linkare.rec.data.synch.VTDateTimeHelper
				.read(istream));
		new_one
				.setSelectedFrequency((com.linkare.rec.data.synch.Frequency) com.linkare.rec.data.synch.VTFrequencyHelper
						.read(istream));
		new_one.setSelectedScale((com.linkare.rec.data.metadata.Scale) com.linkare.rec.data.metadata.VTScaleHelper
				.read(istream));
		new_one
				.setSelectedChannelParameters((com.linkare.rec.data.config.ParameterConfig[]) com.linkare.rec.data.config.VTChannelParameterConfigListHelper
						.read(istream));
	...
	public static void write(org.omg.CORBA.portable.OutputStream ostream,
			com.linkare.rec.data.config.ChannelAcquisitionConfig value) {
		...
		com.linkare.rec.data.config.VTChannelParameterConfigListHelper.write(ostream, value
				.getSelectedChannelParameters());
