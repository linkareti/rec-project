...
abstract public class ByteArrayValueHelper
{
		...
		if (__typeCode == null)
		{
			synchronized (org.omg.CORBA.TypeCode.class)
			{
				if (__typeCode == null)
				{
					...
					_tcOf_members0 = org.omg.CORBA.ORB.init().create_alias_tc(com.linkare.rec.data.acquisition.ByteArrayHelper.id(), "ByteArray", _tcOf_members0);
					...
					_tcOf_members0,
					null);
					__typeCode = org.omg.CORBA.ORB.init().create_struct_tc(com.linkare.rec.data.acquisition.ByteArrayValueHelper.id(), "ByteArrayValue", _members0);
					__active = false;
				}
			}
		}
	...
	public static void write(org.omg.CORBA.portable.OutputStream ostream, com.linkare.rec.data.acquisition.ByteArrayValue value)
	{
