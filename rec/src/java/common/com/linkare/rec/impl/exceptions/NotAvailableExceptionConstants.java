...
public class NotAvailableExceptionConstants {
	...
	public static final String HARDWARE_DOENST_EXIST_IN_MULTICASTCONTROLLER_MSG = notAvailableExceptionRB
			.getString("hardware_not_referenced_by_multicastcontroller");
	public static final int NO_DATA_PRODUCER_AT_THIS_MOMENT = 1;
	public static final String NO_DATA_PRODUCER_AT_THIS_MOMENT_MSG = notAvailableExceptionRB
			.getString("no_dataproducer_active_in_hardware");
	public static final int COULDNT_GET_ALL_SAMPLES = 2;
	public static final String COULDNT_GET_ALL_SAMPLES_MSG = notAvailableExceptionRB
	...
	public static final String NO_ACQ_HEADER_MSG = notAvailableExceptionRB
