...
public class NotAuthorizedConstants {
	...
	public static final String NOT_AUTHORIZED_SECURITY_MANAGER_MSG = notAuthorizedRB
			.getString("not_authorized_securitymanager");

	public static final int NOT_AUTHORIZED_CONNECTION_FAILED = 8;
	public static final String NOT_AUTHORIZED_CONNECTION_FAILED_MSG = notAuthorizedRB
			.getString("not_authorized_connectionfailed");

	public static final int NOT_AUTHORIZED_REGISTER_AT_PARENT_RESOURCE_FIRST = 9;
	public static final String NOT_AUTHORIZED_REGISTER_AT_PARENT_RESOURCE_FIRST_MSG = notAuthorizedRB
