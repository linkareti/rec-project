...
public class DataCollectorState implements java.io.Serializable
{
	...
	throw new RuntimeException("Error - The data collector state value is incorrect... Current value is " +getValue());
    }
    ...
    {
	if(other==null || !(other instanceof DataCollectorState)) return false;
