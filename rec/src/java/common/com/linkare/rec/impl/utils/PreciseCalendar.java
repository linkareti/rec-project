...
public class PreciseCalendar extends GregorianCalendar
{
    ...
    {
	super((int)dateTime.getDate().getYear(),
	(int)dateTime.getDate().getMonth(),
	(int)dateTime.getDate().getDay(),
	(int)dateTime.getTime().getHours(),
	(int)dateTime.getTime().getMinutes(),
	(int)dateTime.getTime().getSeconds());
