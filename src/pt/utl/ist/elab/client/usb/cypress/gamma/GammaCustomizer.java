...
public class GammaCustomizer extends javax.swing.JPanel implements com.linkare.rec.impl.client.customizer.ICustomizer
{
    ...
    private void initComponents()//GEN-BEGIN:initComponents
    {
        ...
        jPanel3.setBorder(new javax.swing.border.TitledBorder(ReCResourceBundle.findString("ReCExpGamma$rec.exp.lbl.gamma.Volume")));
        ...
        jPanel5.setBorder(new javax.swing.border.TitledBorder(ReCResourceBundle.findString("ReCExpGamma$rec.exp.lbl.gamma.FreqAcq")));
        ...
        jPanel7.setBorder(new javax.swing.border.TitledBorder(ReCResourceBundle.findString("ReCExpGamma$rec.exp.lbl.gamma.NPoints")));
    ...
    {//GEN-HEADEREND:event_btnOKActionPerformed
        ...
        acqConfig.setSelectedFrequency(new Frequency((double)jSliderAcqFreq.getValue(),hardwareInfo.getHardwareFrequencies(0).getMinimumFrequency().getMultiplier(),hardwareInfo.getHardwareFrequencies(0).getMinimumFrequency().getFrequencyDefType()));
    ...
    {
        return new javax.swing.ImageIcon(getClass().getResource("/pt/utl/ist/elab/client/usb/cypress/gamma/resources/gamma_iconified.gif"));
    }
