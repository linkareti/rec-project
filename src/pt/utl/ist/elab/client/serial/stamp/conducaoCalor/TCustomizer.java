...
public class TCustomizer extends javax.swing.JPanel implements com.linkare.rec.impl.client.customizer.ICustomizer
{
    ...
    private void initComponents()//GEN-BEGIN:initComponents
    {
        ...
        jPanel4.setBorder(new javax.swing.border.TitledBorder(ReCResourceBundle.findString("ReCExpT$rec.exp.t.lbl.mode")));
        ...
        jPanel5.setBorder(new javax.swing.border.TitledBorder(ReCResourceBundle.findString("ReCExpT$rec.exp.t.lbl.heattime")));
        ...
        jPanel1.setBorder(new javax.swing.border.TitledBorder(ReCResourceBundle.findString("ReCExpT$rec.exp.t.lbl.tbs")));
        ...
        jPanel6.setBorder(new javax.swing.border.TitledBorder(ReCResourceBundle.findString("ReCExpT$rec.exp.t.lbl.nsamples")));
        ...
        jPanel8.setBorder(new javax.swing.border.TitledBorder(ReCResourceBundle.findString("ReCExpT$rec.exp.t.lbl.maxtemp")));
    ...
    public void checkMaxNumSamples()
    {
        ...
        if(duration > 1500)
        {
            ...
            jLabelInfo.setText(ReCResourceBundle.findString("ReCExpT$rec.exp.t.lbl.maxsamples") + " <= " + (1500/jSliderTBS.getValue()));
	...
	{
	    return new javax.swing.ImageIcon(getClass().getResource("/pt/utl/ist/elab/client/serial/stamp/conducaoCalor/resources/t2_iconified.gif"));
	}
