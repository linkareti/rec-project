...
public class MainPanel extends javax.swing.JPanel implements com.linkare.rec.impl.client.experiment.ExpDataDisplay, com.linkare.rec.impl.client.experiment.ExpDataModelListener
{
    ...
    {
        initComponents();
        jPanel1.setBorder(new ImageBorder(new javax.swing.ImageIcon(getClass().getResource("/pt/utl/ist/elab/client/serial/stamp/thomson/resources/mainpanelback.jpg")).getImage(), true));
    }
