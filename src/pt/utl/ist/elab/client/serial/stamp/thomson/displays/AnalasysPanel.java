...
public class AnalasysPanel extends javax.swing.JPanel implements com.linkare.rec.impl.client.experiment.ExpDataDisplay, com.linkare.rec.impl.client.experiment.ExpDataModelListener
{
    ...
    protected java.awt.Image[] im_analiz = new java.awt.Image[6]; //[0]-> original, [1]->BW, [2]->rectas, [3]->alinhada, [4]->feixe, [5]-> imagem final
    protected boolean values_done = false;
    protected double[] values= new double[6]; //[0]->X0 , [1]->Y0 , [2]-> R , [3]->intensidade, [4]->tensao, [5]->q_m
    ...
    public void setQM()
    {
        ...
        /*System.out.println("N_ESP= " + N_ESP);
        System.out.println("D_ESP= " + D_ESP);
        System.out.println("R= " + values[2]);
        System.out.println("I= " + values[3]);
        System.out.println("V= " + values[4]);
        System.out.println("q/m= " + values[5]);        */
    }
    ...
    public boolean setImages(java.awt.Image img1, java.awt.Image img2, java.awt.Image img3, java.awt.Image img4, java.awt.Image img5, java.awt.Image img6 )
    {
        im_analiz[0] = img1;
        im_analiz[1] = img2;
        im_analiz[2] = img3;
    ...
    private void buildImages(byte[] imageBA)
    {
        ...
        double corrente = 0;
        if(model != null)
            corrente = Double.parseDouble(model.getAcquisitionConfig().getSelectedHardwareParameterValue("correntebobines"));
