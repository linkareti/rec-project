 ...
 * Esquerda.java
 *
 * Created on 27 de Janeiro de 2003, 16:09
 */
 ...
 * @author  Andre
 */
public class Esquerda extends pt.utl.ist.elab.client.webrobot.customizer.Comps.Block 
{
    ...
    private int TIPO=6;
    private javax.swing.ImageIcon image = new javax.swing.ImageIcon(getClass().getResource("/pt/utl/ist/elab/client/webrobot/customizer/Comps/Icons/esquerda.gif"));
    private pt.utl.ist.elab.client.webrobot.customizer.Models.ModelEsquerda model;
    private pt.utl.ist.elab.client.webrobot.customizer.Comps.Configs.ConfEsquerda confEsquerda;
    private java.awt.Color backgroundColor = new java.awt.Color(204,204,204);
    private String text;
    private String fullNameDescription="Roda a esquerda";
    ...
    public Esquerda(javax.swing.JFrame parent) 
    {
        super();
        setCancel(false);
    ...
    public Esquerda(pt.utl.ist.elab.client.webrobot.customizer.Models.ModelEsquerda model)
    {
        super();
        setCancel(false);
        this.model=new pt.utl.ist.elab.client.webrobot.customizer.Models.ModelEsquerda();
    ...
    public void setDataModel(pt.utl.ist.elab.client.webrobot.customizer.Models.ModelEsquerda model)
    {
        this.model=model;
    }
