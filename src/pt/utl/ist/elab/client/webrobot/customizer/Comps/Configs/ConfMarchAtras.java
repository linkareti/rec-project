...
public class ConfMarchAtras extends javax.swing.JDialog {
    ...
    public ConfMarchAtras(java.awt.Frame parent, boolean modal, pt.utl.ist.elab.client.webrobot.customizer.Models.ModelMarchAtras model) 
    {
        super(parent, modal);
        this.model=model;
        initComponents();
    ...
    private void initComponents() {//GEN-BEGIN:initComponents
        ...
        jLabel1.setIcon(new javax.swing.ImageIcon(getClass().getResource("/pt/utl/ist/elab/client/webrobot/customizer/Comps/Icons/marchatras.gif")));
    ...
    public static void main(String args[]) {
        new ConfMarchAtras(new javax.swing.JFrame(), true).show();
    }*/
