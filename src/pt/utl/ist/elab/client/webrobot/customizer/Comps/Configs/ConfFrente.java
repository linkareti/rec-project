 ...
 * @author  Andr�
 */
public class ConfFrente extends javax.swing.JDialog {
    
    /** Creates new form ConfCompBin */
    public ConfFrente(java.awt.Frame parent, boolean modal, pt.utl.ist.elab.client.webrobot.customizer.Models.ModelFrente model)
    {
        super(parent, modal);
        this.model=model;
        initComponents();
    ...
    private void initComponents() {//GEN-BEGIN:initComponents
        ...
        jLabel1.setIcon(new javax.swing.ImageIcon(getClass().getResource("/pt/utl/ist/elab/client/webrobot/customizer/Comps/Icons/frente.gif")));
    ...
    public static void main(String args[]) {
        new ConfFrente(new javax.swing.JFrame(), true).show();
    }*/
    ...
    public pt.utl.ist.elab.client.webrobot.customizer.Models.ModelFrente getModel()
    {
        return model;
    }
