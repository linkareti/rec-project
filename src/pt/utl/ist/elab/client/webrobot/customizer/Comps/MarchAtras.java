...
{    
    ...
    private int TIPO=4;
    private javax.swing.ImageIcon image = new javax.swing.ImageIcon(getClass().getResource("/pt/utl/ist/elab/client/webrobot/customizer/Comps/Icons/marchatras.gif"));
    ...
    private String text;
    private String fullNameDescription="Segue para tras";
    ...
    public MarchAtras(javax.swing.JFrame parent) 
    {
        super();
        setCancel(false);
        model = new pt.utl.ist.elab.client.webrobot.customizer.Models.ModelMarchAtras();
        confMarchAtras = new pt.utl.ist.elab.client.webrobot.customizer.Comps.Configs.ConfMarchAtras(parent, true, model);
    ...
    public MarchAtras(pt.utl.ist.elab.client.webrobot.customizer.Models.ModelMarchAtras model)
    {
        super();
        setCancel(false);
    ...
    {        
        ...
        g.setColor(java.awt.Color.black);
        text=""+model.getValor();
        g.drawString(text,(int)((image.getIconWidth()-text.length()*g.getFont().getSize()*1/3)/2),image.getIconWidth()/3);                
    ...
    public void setDataModel(pt.utl.ist.elab.client.webrobot.customizer.Models.ModelMarchAtras model)
    {
        this.model=model;
    }
