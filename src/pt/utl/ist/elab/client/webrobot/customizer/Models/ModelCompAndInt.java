 ...
 * @author  Andre
 */
public class ModelCompAndInt extends pt.utl.ist.elab.client.webrobot.customizer.Models.ModelBlock implements pt.utl.ist.elab.client.webrobot.customizer.Interfaces.Model
{

    
    /** Holds value of property d1. */
    private String d1="A1";    
    
    /** Holds value of property d2. */
    private String d2="=";
    
    /** Holds value of property d3. */
    private String d3="A1";
