...
public class ConfIncDec extends javax.swing.JDialog {
    ...
    public ConfIncDec(java.awt.Frame parent, boolean modal, pt.utl.ist.elab.client.webrobot.customizer.Models.ModelIncDec model)
    {
        super(parent, modal);
        this.model = model;
        initComponents();
    ...
    private void initComponents() {//GEN-BEGIN:initComponents
        ...
        if(model.getFlag()==0)
        {
            jLabel1.setIcon(new javax.swing.ImageIcon(getClass().getResource("/pt/utl/ist/elab/client/webrobot/customizer/Comps/Icons/incdec+.gif")));
        }
        else
        {
            jLabel1.setIcon(new javax.swing.ImageIcon(getClass().getResource("/pt/utl/ist/elab/client/webrobot/customizer/Comps/Icons/incdec-.gif")));
    ...
    public static void main(String args[]) {
        new ConfIncDec(new javax.swing.JFrame(), true).show();
    }*/
