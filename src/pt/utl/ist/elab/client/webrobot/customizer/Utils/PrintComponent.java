...
public class PrintComponent implements java.awt.print.Printable
{
    ...
    public void print() 
    {
        ...
        /******************************************************************************
         *BIG PROBLEM....
         *O utilizador tem de escolher a orientacao da pagina no primeiro painel que eu lhe dou
         *ou nao funciona....JAVA BUG: 4311283 
        *******************************************************************************/
    ...
    public int print(java.awt.Graphics g, java.awt.print.PageFormat pageFormat, int pageIndex) 
    {
		...
		scale =  pageWidth / tableWidth;
            ...
            //bottom center
            g2.drawString("Pagina: "+(pageIndex+1),(int)pageWidth/2-35,(int)(pageHeight+fontHeight-fontDesent));
