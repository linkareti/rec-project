 ...
 */
public class ModelPWM extends pt.utl.ist.elab.client.webrobot.customizer.Models.ModelBlock implements pt.utl.ist.elab.client.webrobot.customizer.Interfaces.Model
{
    ...
    private int valor=155;
    
    /** Holds value of property valor2. */
    private int valor2=155;
    ...
    private int flag=1; //1 se os dois selecionados, 2 se o de cima selecionado, 3 se o de baixo selecionado
