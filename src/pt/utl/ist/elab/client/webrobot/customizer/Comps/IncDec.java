...
{    
    ...
    private int TIPO=11;
    private javax.swing.ImageIcon imageInc = new javax.swing.ImageIcon(getClass().getResource("/pt/utl/ist/elab/client/webrobot/customizer/Comps/Icons/incdec+.gif"));
    private javax.swing.ImageIcon imageDec = new javax.swing.ImageIcon(getClass().getResource("/pt/utl/ist/elab/client/webrobot/customizer/Comps/Icons/incdec-.gif"));
    ...
    {        
        ...
        if(paintBottom)
        {
            g2.drawLine(imageInc.getIconWidth()/2,imageInc.getIconHeight(),imageInc.getIconWidth()/2,imageInc.getIconHeight()+LINEWIDTH);
        }
        if(paintLeft)
        {
            g2.drawLine(imageInc.getIconWidth(),imageInc.getIconHeight()/2,imageInc.getIconWidth()+LINEWIDTH,imageInc.getIconHeight()/2);
        }
        if(model.getFlag()==0)
        {
