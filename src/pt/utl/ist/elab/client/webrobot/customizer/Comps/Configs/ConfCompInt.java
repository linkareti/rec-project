...
public class ConfCompInt extends javax.swing.JDialog {
    ...
    public ConfCompInt(java.awt.Frame parent, boolean modal, pt.utl.ist.elab.client.webrobot.customizer.Models.ModelCompInt modelCompInt) {
        super(parent, modal);
    ...
    private void initComponents() {//GEN-BEGIN:initComponents
        ...
        jLabel1.setIcon(new javax.swing.ImageIcon(getClass().getResource("/pt/utl/ist/elab/client/webrobot/customizer/Comps/Icons/compInt.gif")));
    ...
    public static void main(String args[]) {
        new ConfCompInt(new javax.swing.JFrame(), true).show();
    }*/
