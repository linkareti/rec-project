...
public class ConfPWM extends javax.swing.JDialog {
    ...
    public ConfPWM(java.awt.Frame parent, boolean modal, pt.utl.ist.elab.client.webrobot.customizer.Models.ModelPWM model) 
    {
        super(parent, modal);
        this.model=model;
        initComponents();
    ...
    private void initComponents() {//GEN-BEGIN:initComponents
        ...
        jLabel1.setIcon(new javax.swing.ImageIcon(getClass().getResource("/pt/utl/ist/elab/client/webrobot/customizer/Comps/Icons/pwm.gif")));
        gridBagConstraints = new java.awt.GridBagConstraints();
    ...
    public static void main(String args[]) {
        new ConfPWM(new javax.swing.JFrame(), true).show();
    }*/
