 ...
 * @author  Andre
 */
public class ConfCompBin extends javax.swing.JDialog {
    
    /** Creates new form ConfCompBin */
    public ConfCompBin(java.awt.Frame parent, boolean modal, pt.utl.ist.elab.client.webrobot.customizer.Models.ModelCompBin model)
    {
        super(parent, modal);
        this.model=model;
        initComponents();
    ...
    private void initComponents() {//GEN-BEGIN:initComponents
        ...
        jLabel1.setIcon(new javax.swing.ImageIcon(getClass().getResource("/pt/utl/ist/elab/client/webrobot/customizer/Comps/Icons/compBin.gif")));
    ...
    public static void main(String args[]) {
        new ConfCompBin(new javax.swing.JFrame(), true).show();
    }*/
    ...
    public pt.utl.ist.elab.client.webrobot.customizer.Models.ModelCompBin getModel()
    {
        return model;
    }
