 ...
 * SetReset.java
 *
 * Created on 27 de Janeiro de 2003, 15:41
 */
 ...
 * @author  Andre
 */
public class SetReset extends pt.utl.ist.elab.client.webrobot.customizer.Comps.Block 
{    
    ...
    private int TIPO=9;
    private javax.swing.ImageIcon image = new javax.swing.ImageIcon(getClass().getResource("/pt/utl/ist/elab/client/webrobot/customizer/Comps/Icons/setreset.gif"));        
    private pt.utl.ist.elab.client.webrobot.customizer.Models.ModelSetReset model;
    private pt.utl.ist.elab.client.webrobot.customizer.Comps.Configs.ConfSetReset confSetReset;
    private java.awt.Color backgroundColor = new java.awt.Color(204,204,204);
    private String text;
    private String fullNameDescription="Set/Reset saida digital";    
    ...
    public SetReset(javax.swing.JFrame parent) 
    {
        super();
        setCancel(false);
    ...
    public SetReset(pt.utl.ist.elab.client.webrobot.customizer.Models.ModelSetReset model)
    {
        super();
        setCancel(false);
        this.model=new pt.utl.ist.elab.client.webrobot.customizer.Models.ModelSetReset();
    ...
    public void setDataModel(pt.utl.ist.elab.client.webrobot.customizer.Models.ModelSetReset model)
    {
        this.model=model;
    }
