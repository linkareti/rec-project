 ...
 * @author  Andre
 */
public class ConfCompAndBin extends javax.swing.JDialog {
    
    /** Creates new form ConfCompBin */
    public ConfCompAndBin(java.awt.Frame parent, boolean modal, pt.utl.ist.elab.client.webrobot.customizer.Models.ModelCompAndBin model) 
    {
        super(parent, modal);
        this.model = model;
        initComponents();
    ...
    private void initComponents() {//GEN-BEGIN:initComponents
        ...
        setTitle("Compara\u00e7\u00e3o AND bin\u00e1rio");
        setResizable(false);
        ...
        jComboBoxD1.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "b0", "b1", "b2", "b3", "b4", "b5", "b6", "b7", "c0", "c3" }));
        ...
        jLabel1.setIcon(new javax.swing.ImageIcon(getClass().getResource("/pt/utl/ist/elab/client/webrobot/customizer/Comps/Icons/compAndBin.gif")));
    ...
    public static void main(String args[]) {
        new ConfCompAndBin(new javax.swing.JFrame(), true).show();
    }*/
    ...
    public pt.utl.ist.elab.client.webrobot.customizer.Models.ModelCompAndBin getModel()
    {
        return model;
    }
