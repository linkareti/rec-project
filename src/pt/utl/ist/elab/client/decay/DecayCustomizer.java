...
public class DecayCustomizer extends javax.swing.JPanel implements com.linkare.rec.impl.client.customizer.ICustomizer
{
    ...
    public DecayCustomizer()
    {
        ...
        jComboBoxMinutesIni.addItem("1");
        jComboBoxMinutesIni.addItem("1");
        jComboBoxMinutesEnd.addItem("1");
        jComboBoxMinutesEnd.addItem("1");
        for(int i=1; i<32; i++)
        {
            jComboBoxDayIni.addItem("" + i);
            jComboBoxDayEnd.addItem("" + i);
            
            if(i < 13)
            {
                jComboBoxMonthIni.addItem("" + i);
                jComboBoxMonthEnd.addItem("" + i);
            }
            
            jComboBoxYearIni.addItem("" + (2003 + i));
            jComboBoxYearEnd.addItem("" + (2003 + i));
            
            if(i < 25)
            {
                jComboBoxHoursIni.addItem("" + (i-1));
                jComboBoxHoursEnd.addItem("" + (i-1));
            }
            
            if(i < 30)
            {
                jComboBoxMinutesIni.addItem("" + (2 * i));
                jComboBoxMinutesIni.addItem("" + (2 * i + 1));
                jComboBoxMinutesEnd.addItem("" + (2 * i));
                jComboBoxMinutesEnd.addItem("" + (2 * i + 1));
            }
    ...
    private void initComponents()//GEN-BEGIN:initComponents
    {
        ...
        jComboBoxHoursIni = new javax.swing.JComboBox();
        jComboBoxMinutesIni = new javax.swing.JComboBox();
        ...
        jComboBoxHoursEnd = new javax.swing.JComboBox();
        jComboBoxMinutesEnd = new javax.swing.JComboBox();
        ...
        jPanel4.setBorder(new javax.swing.border.TitledBorder(ReCResourceBundle.findString("ReCExpDecay$rec.exp.decay.inidate")));
        jPanel4.setPreferredSize(new java.awt.Dimension(210, 123));
        jPanel9.setLayout(new java.awt.GridBagLayout());

        jComboBoxDayIni.setBorder(new javax.swing.border.TitledBorder(ReCResourceBundle.findString("ReCExpDecay$rec.exp.decay.day")));
        jPanel9.add(jComboBoxDayIni, new java.awt.GridBagConstraints());

        jComboBoxMonthIni.setBorder(new javax.swing.border.TitledBorder(ReCResourceBundle.findString("ReCExpDecay$rec.exp.decay.month")));
        gridBagConstraints = new java.awt.GridBagConstraints();
        gridBagConstraints.insets = new java.awt.Insets(0, 8, 0, 7);
        jPanel9.add(jComboBoxMonthIni, gridBagConstraints);

        jComboBoxYearIni.setBorder(new javax.swing.border.TitledBorder(ReCResourceBundle.findString("ReCExpDecay$rec.exp.decay.year")));
        ...
        jComboBoxHoursIni.setBorder(new javax.swing.border.TitledBorder(ReCResourceBundle.findString("ReCExpDecay$rec.exp.decay.hours")));
        jPanel10.add(jComboBoxHoursIni, new java.awt.GridBagConstraints());

        jComboBoxMinutesIni.setBorder(new javax.swing.border.TitledBorder(ReCResourceBundle.findString("ReCExpDecay$rec.exp.decay.minutes")));
        gridBagConstraints = new java.awt.GridBagConstraints();
        gridBagConstraints.insets = new java.awt.Insets(0, 8, 0, 7);
        ...
        jPanel7.setBorder(new javax.swing.border.TitledBorder(ReCResourceBundle.findString("ReCExpDecay$rec.exp.decay.enddate")));
        jPanel7.setPreferredSize(new java.awt.Dimension(210, 123));
        jComboBoxDayEnd.setBorder(new javax.swing.border.TitledBorder(ReCResourceBundle.findString("ReCExpDecay$rec.exp.decay.day")));
        jPanel11.add(jComboBoxDayEnd);

        jComboBoxMonthEnd.setBorder(new javax.swing.border.TitledBorder(ReCResourceBundle.findString("ReCExpDecay$rec.exp.decay.month")));
        jPanel11.add(jComboBoxMonthEnd);

        jComboBoxYearEnd.setBorder(new javax.swing.border.TitledBorder(ReCResourceBundle.findString("ReCExpDecay$rec.exp.decay.year")));
        ...
        jComboBoxHoursEnd.setBorder(new javax.swing.border.TitledBorder(ReCResourceBundle.findString("ReCExpDecay$rec.exp.decay.hours")));
        jPanel13.add(jComboBoxHoursEnd, new java.awt.GridBagConstraints());

        jComboBoxMinutesEnd.setBorder(new javax.swing.border.TitledBorder(ReCResourceBundle.findString("ReCExpDecay$rec.exp.decay.minutes")));
        gridBagConstraints = new java.awt.GridBagConstraints();
        gridBagConstraints.insets = new java.awt.Insets(0, 8, 0, 7);
        ...
        jPanel1.setBorder(new javax.swing.border.TitledBorder(ReCResourceBundle.findString("ReCExpDecay$rec.exp.decay.lbl.dheight")));
        ...
        jPanel5.setBorder(new javax.swing.border.TitledBorder(ReCResourceBundle.findString("ReCExpDecay$rec.exp.decay.lbl.material")));
        btnWood.setIcon(new javax.swing.ImageIcon(getClass().getResource("/pt/utl/ist/elab/client/decay/resources/wood.gif")));
        ...
        btnCork.setIcon(new javax.swing.ImageIcon(getClass().getResource("/pt/utl/ist/elab/client/decay/resources/corticite.gif")));
        ...
        btnCopper2.setIcon(new javax.swing.ImageIcon(getClass().getResource("/pt/utl/ist/elab/client/decay/resources/cobre2.gif")));
        ...
        btnCopper4.setIcon(new javax.swing.ImageIcon(getClass().getResource("/pt/utl/ist/elab/client/decay/resources/cobre4.gif")));
        ...
        btnCopper8.setIcon(new javax.swing.ImageIcon(getClass().getResource("/pt/utl/ist/elab/client/decay/resources/cobre8.gif")));
        ...
        btnCopper16.setIcon(new javax.swing.ImageIcon(getClass().getResource("/pt/utl/ist/elab/client/decay/resources/cobre16.gif")));
        ...
        btnCopper32.setIcon(new javax.swing.ImageIcon(getClass().getResource("/pt/utl/ist/elab/client/decay/resources/cobre32.gif")));
        ...
        btnAir.setIcon(new javax.swing.ImageIcon(getClass().getResource("/pt/utl/ist/elab/client/decay/resources/air.gif")));
        ...
        btnLead.setIcon(new javax.swing.ImageIcon(getClass().getResource("/pt/utl/ist/elab/client/decay/resources/chumbo.gif")));
        ...
        btnBrick.setIcon(new javax.swing.ImageIcon(getClass().getResource("/pt/utl/ist/elab/client/decay/resources/brick.gif")));
	...
	{//GEN-HEADEREND:event_btnOKActionPerformed
            ...
            //Resolver numero de amostras :S
            acqConfig.setTotalSamples(1000);
        ...
        private boolean verifyDates()
        {
            ...
            int yearend = Integer.parseInt(jComboBoxYearEnd.getSelectedItem().toString());
            int monthini = Integer.parseInt(jComboBoxMonthIni.getSelectedItem().toString());
            int monthend = Integer.parseInt(jComboBoxMonthEnd.getSelectedItem().toString());
            int dayini = Integer.parseInt(jComboBoxDayIni.getSelectedItem().toString());
            int dayend = Integer.parseInt(jComboBoxDayEnd.getSelectedItem().toString());
    ...
    private javax.swing.JComboBox jComboBoxHoursEnd;
    private javax.swing.JComboBox jComboBoxHoursIni;
    private javax.swing.JComboBox jComboBoxMinutesEnd;
    private javax.swing.JComboBox jComboBoxMinutesIni;
    ...
    {
        return new javax.swing.ImageIcon(getClass().getResource("/pt/utl/ist/elab/client/decay/resources/radioactividade_iconified.gif"));
    }
    ...
    {
        ReCResourceBundle.loadResourceBundle("ReCExpDecay", "recresource:///pt/utl/ist/elab/client/decay/resources/ReCExpDecay");
