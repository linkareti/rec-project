...
public class AccumulatedGraphDisplay extends javax.swing.JPanel implements com.linkare.rec.impl.client.experiment.ExpDataDisplay, com.linkare.rec.impl.client.experiment.ExpDataModelListener {
    ...
    //My Vars
    private pt.utl.ist.elab.client.Aleatorio2.utils.StorageSingleton accuGraphDisplaySingleton = pt.utl.ist.elab.client.Aleatorio2.utils.StorageSingleton.getSingleton();
    ...
    public void newSamples(com.linkare.rec.impl.client.experiment.NewExpDataEvent evt)
    {
        for (int i = evt.getSamplesStartIndex(); i <= evt.getSamplesEndIndex(); i++)
        {
            ...
            if (model.getValueAt(i, model.getChannelIndex("CenterCount")) != null && xx != null)
            {
                ...
                int maxIter = 100;
                double[] params = pt.utl.ist.elab.client.Aleatorio2.utils.LMFit.solve(accuX, accuY,mu,sigma,y0,Amp,lambda,termEpsilon,maxIter);
