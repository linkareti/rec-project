...
public class CypressFinder
{
     ...
     */
    public synchronized void removeCypressFinderListener(pt.utl.ist.elab.driver.usb.cypress.CypressFinderListener listener)
    {
    ...
    private class CypressFinderRunner extends Thread
    {
        ...
        public void cycleUSBPorts()
        {
            ...
            Logger.getLogger(CYPRESS_FINDER_LOGGER).log(Level.INFO, "staticVendorId = " + vendorID + " and staticProductId = " + productID);
            ...
            if(usbDevices != null && usbDevices.size() > 0)
                Logger.getLogger(CYPRESS_FINDER_LOGGER).log(Level.INFO, "Found " + usbDevices.size() + " device with the requested parameters!");
            else
            {
