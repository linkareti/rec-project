...
public class InterLacedSineWaveStream implements PullBufferStream {
    ...
    public InterLacedSineWaveStream() {
        ...
        //audioFormat=new AudioFormat( AudioFormat.LINEAR, freq_out, bits_per_channel, num_channels);/*, SIGNED, LITTLE_ENDIAN);*/
        
        maxDataLength = (int)freq_out*num_channels*bits_per_channel/8/4;//basicamente estou a escolher um dataLength de 250ms
        //maxDataLength=256;
   ...
   /* public void run() {
        while (started) {
            ...
            if (started && transferHandler != null) {
                ...
                try {
                    ...
                    Thread.currentThread().sleep((long)(waitSecsForNewTransfer*1000.));//J� alterei
        ...
        */
        ...
        public void read(javax.media.Buffer buffer) throws java.io.IOException 
        {
            ...
            ((byte[])outdata).length != maxDataLength) {//realoca o array se o length for diferente do maxDataLength
