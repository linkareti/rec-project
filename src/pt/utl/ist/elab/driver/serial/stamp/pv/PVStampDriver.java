...
import pt.utl.ist.elab.driver.serial.stamp.pv.translators.StampConfigTranslator;
...
public class PVStampDriver extends AbstractStampDriver
{
	...
	String baseHardwareInfoFile="recresource://pt/utl/ist/elab/driver/serial/stamp/pv/PVBaseHardwareInfo.xml";
	String prop=Defaults.defaultIfEmpty(System.getProperty("eLab.PV.HardwareInfo"),baseHardwareInfoFile);
	...
	new String[]
	{
	    packageName+"processors.StampPVProcessor",
