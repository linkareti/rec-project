...
package pt.utl.ist.elab.driver.Aleatorio2;

import java.util.logging.Logger;

import pt.utl.ist.elab.driver.Aleatorio2.Hardware.HardwareInit;
import pt.utl.ist.elab.driver.Aleatorio2.Hardware.SoundThread;
import pt.utl.ist.elab.driver.Aleatorio2.Hardware.WebCamThread;
import pt.utl.ist.elab.driver.Aleatorio2.Utils.VideoReader;
...
public class AleatorioDriver extends BaseDriver{
    ...
    pt.utl.ist.elab.driver.Aleatorio2.Utils.ImageAnalyser imageAnalyser = null;
    ...
    private void analyseImage() {
        ...
        imageAnalyser = new pt.utl.ist.elab.driver.Aleatorio2.Utils.ImageAnalyser(image);
