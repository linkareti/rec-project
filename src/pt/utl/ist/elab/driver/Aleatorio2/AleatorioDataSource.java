...
public class AleatorioDataSource extends BaseDataSource {
    ...
    public pt.utl.ist.elab.driver.Aleatorio2.Utils.FileOps file = null;
    ...
    /*public void dataSource()
    {
        ...
        file = new pt.utl.ist.elab.driver.Aleatorio2.Utils.FileOps("utils/AcuStat" + numDice + ".dat", newFileProperties);
    ...
    public void fillStatistics()//sendStatistics()
    {
        ...
        file = new pt.utl.ist.elab.driver.Aleatorio2.Utils.FileOps("AcuStat" + numDice + ".dat", newFileProperties);
