...
public final class DateTime implements org.omg.CORBA.portable.IDLEntity
{
	...
	public String toSimpleString()
	{
		...
		String time="";
		if(this.time!=null) time=this.time.toSimpleTimeString();
		return date+" "+time;
	}
	...
	{
		java.util.Calendar c=new java.util.GregorianCalendar(this.getDate().getYear(),this.getDate().getMonth(),this.getDate().getDay(),this.getTime().getHours(),this.getTime().getMinutes(),this.getTime().getSeconds());
