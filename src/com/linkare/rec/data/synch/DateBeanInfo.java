...
public class DateBeanInfo extends SimpleBeanInfo
{
    ...
    private static BeanDescriptor beanDescriptor = new BeanDescriptor  ( Date.class , com.linkare.rec.data.synch.DateCustomizer.class );
...
//GEN-HEADEREND:Events
  ...
  //GEN-LAST:Events
    ...
    static {
        try {
            methods[METHOD_toString0] = new MethodDescriptor ( com.linkare.rec.data.synch.Date.class.getMethod("toString", new Class[] {}));
