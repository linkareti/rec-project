...
abstract public class PhysicsValHelper
{
  ...
  synchronized public static org.omg.CORBA.TypeCode type()
  {
    if (__typeCode == null)
    {
      ...
      com.linkare.rec.data.acquisition.PhysicsValueTypeHelper.insert(_anyOf_members0, com.linkare.rec.data.acquisition.PhysicsValueType.BooleanVal);
      ...
      _anyOf_members0 = org.omg.CORBA.ORB.init().create_any();
      com.linkare.rec.data.acquisition.PhysicsValueTypeHelper.insert(_anyOf_members0, com.linkare.rec.data.acquisition.PhysicsValueType.ByteVal);
      ...
      _anyOf_members0 = org.omg.CORBA.ORB.init().create_any();
      com.linkare.rec.data.acquisition.PhysicsValueTypeHelper.insert(_anyOf_members0, com.linkare.rec.data.acquisition.PhysicsValueType.ShortVal);
      ...
      _anyOf_members0 = org.omg.CORBA.ORB.init().create_any();
      com.linkare.rec.data.acquisition.PhysicsValueTypeHelper.insert(_anyOf_members0, com.linkare.rec.data.acquisition.PhysicsValueType.IntVal);
      ...
      _anyOf_members0 = org.omg.CORBA.ORB.init().create_any();
      com.linkare.rec.data.acquisition.PhysicsValueTypeHelper.insert(_anyOf_members0, com.linkare.rec.data.acquisition.PhysicsValueType.LongVal);
      ...
      _anyOf_members0 = org.omg.CORBA.ORB.init().create_any();
      com.linkare.rec.data.acquisition.PhysicsValueTypeHelper.insert(_anyOf_members0, com.linkare.rec.data.acquisition.PhysicsValueType.FloatVal);
      ...
      _anyOf_members0 = org.omg.CORBA.ORB.init().create_any();
      com.linkare.rec.data.acquisition.PhysicsValueTypeHelper.insert(_anyOf_members0, com.linkare.rec.data.acquisition.PhysicsValueType.DoubleVal);
      ...
      _anyOf_members0 = org.omg.CORBA.ORB.init().create_any();
      com.linkare.rec.data.acquisition.PhysicsValueTypeHelper.insert(_anyOf_members0, com.linkare.rec.data.acquisition.PhysicsValueType.ByteArrayVal);
      ...
      _tcOf_members0,
      null);
      __typeCode = org.omg.CORBA.ORB.init().create_union_tc(com.linkare.rec.data.acquisition.PhysicsValHelper.id(), "PhysicsVal", _disTypeCode0, _members0);
    }
    return __typeCode;
  }
  ...
  public static void write(org.omg.CORBA.portable.OutputStream ostream, com.linkare.rec.data.acquisition.PhysicsVal value)
  {
