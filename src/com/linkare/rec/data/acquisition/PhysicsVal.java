...
public final class PhysicsVal implements IDLEntity
{
    ...
    {
			/*if(getDiscriminator()!=com.linkare.rec.data.acquisition.PhysicsValueType.BooleanVal)
    ...
    {
			/*if(getDiscriminator()!=com.linkare.rec.data.acquisition.PhysicsValueType.ByteVal)
				throw new RuntimeException("Invalid type request");*/
    ...
    {
			/*if(getDiscriminator()!=com.linkare.rec.data.acquisition.PhysicsValueType.ShortVal)
				throw new RuntimeException("Invalid type request");*/
    ...
    {
			/*if(getDiscriminator()!=com.linkare.rec.data.acquisition.PhysicsValueType.IntVal)
				throw new RuntimeException("Invalid type request");*/
    ...
    {
			/*if(getDiscriminator()!=com.linkare.rec.data.acquisition.PhysicsValueType.LongVal)
				throw new RuntimeException("Invalid type request");*/
    ...
    {
			/*if(getDiscriminator()!=com.linkare.rec.data.acquisition.PhysicsValueType.FloatVal)
				throw new RuntimeException("Invalid type request");*/
    ...
    {
			/*if(getDiscriminator()!=com.linkare.rec.data.acquisition.PhysicsValueType.DoubleVal)
				throw new RuntimeException("Invalid type request");*/
    ...
    {
			/*if(getDiscriminator()!=com.linkare.rec.data.acquisition.PhysicsValueType.ByteArrayVal)
				throw new RuntimeException("Invalid type request");*/
