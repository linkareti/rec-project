...
public final class Multiplier implements org.omg.CORBA.portable.IDLEntity
{
	...
	{
		if(	    value==_fento || value==_pico || value==_nano
		||  value==_micro || value==_mili || value==_none
		||  value==_kilo || value==_mega || value==_giga
		||  value==_tera)
			this.value=value;
		else
	...
	{
		if(other==null || !(other instanceof Multiplier)) return false;
