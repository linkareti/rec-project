...
//GEN-LAST:Events
    ...
    static {
        try {
            methods[METHOD_equals0] = new MethodDescriptor ( com.linkare.rec.data.Multiplier.class.getMethod("equals", new Class[] {java.lang.Object.class}));
            methods[METHOD_equals0].setDisplayName ( "" );
            methods[METHOD_toExpString1] = new MethodDescriptor ( com.linkare.rec.data.Multiplier.class.getMethod("toExpString", new Class[] {}));
            methods[METHOD_toExpString1].setDisplayName ( "" );
            methods[METHOD_toString2] = new MethodDescriptor ( com.linkare.rec.data.Multiplier.class.getMethod("toString", new Class[] {}));
