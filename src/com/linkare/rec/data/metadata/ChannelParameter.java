...
public final class ChannelParameter implements org.omg.CORBA.portable.IDLEntity
{
	...
	// @param	actual_selected_parameter_index	actual_selected_parameter_index struct member
	//
	public ChannelParameter( String parameter_name, com.linkare.rec.data.metadata.ParameterType parameter_type, String[] parameter_selection_list, String actual_selected_parameter_value)
	{
	...
	public ChannelParameter( ChannelParameter  other)
	{
		...
		this.setParameterSelectionList(temp);temp=null;System.gc();
	 ...
	 * @param index Index of the property.
	 * @param parameterSelectionList New value of the property at <CODE>index</CODE>.
	 */
	public void setParameterSelectionList(int index, String parameterSelectionList)
	{
		...
		else
		{
			...
			this.parameterSelectionList=temp;temp=null;System.gc();
		}
	}

	/** Setter for property parameterSelectionList.
	 * @param parameterSelectionList New value of property parameterSelectionList.
	 */
	 ...
	 * @param selectedParameterIndex New value of property selectedParameterIndex.
	 */
	...
	public boolean isSelectedValueValid(String selectedParameterValue)
	{
		switch(this.parameterType.getValue())
		{
			...
			{
				if(parameterSelectionList.length<3) return true;
				try
				{
