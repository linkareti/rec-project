...
public final class ChannelAcquisitionConfig implements org.omg.CORBA.portable.IDLEntity
{
	...
	// @param	selected_channel_parameters	selected_channel_parameters struct member
	// @param	total_samples	total_samples struct member
	//
	public ChannelAcquisitionConfig(String channelName,com.linkare.rec.data.synch.DateTime time_start, com.linkare.rec.data.synch.Frequency selected_frequency, com.linkare.rec.data.metadata.Scale selected_scale, com.linkare.rec.data.config.ParameterConfig[] selected_channel_parameters, int total_samples)
	{
	...
	public ChannelAcquisitionConfig(ChannelAcquisitionConfig other)
	{
		...
		this.setSelectedChannelParameters(temp);temp=null;System.gc();
	 ...
	 * @param index Index of the property.
	 * @param selectedChannelParameters New value of the property at <CODE>index</CODE>.
	 */
	public void setSelectedChannelParameters(int index, com.linkare.rec.data.config.ParameterConfig selectedChannelParameters)
	{
		if(this.selectedChannelParameters!=null && index<this.selectedChannelParameters.length)
		...
		else
		{
			...
			this.selectedChannelParameters=temp;temp=null;System.gc();
		}
	}
	...
	public String getChannelName()
	{
            return this.channelName;
                //return ReCResourceBundle.findStringOrDefault(this.channelName, this.channelName);
	}
