...

{
    ...
    private static BeanDescriptor beanDescriptor = new BeanDescriptor  ( MultiplierLabel.class , com.linkare.customizer.DefaultPropertySheetCustomizer.class );
    ...
    static {
        try {
            properties[PROPERTY_multiplier] = new PropertyDescriptor ( "multiplier", MultiplierLabel.class, "getMultiplier", "setMultiplier" );
