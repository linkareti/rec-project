...
public class ByteArrayValBuffer
{
	...
	/** Creates a new instance of ByteArrayValBuffer */
	public ByteArrayValBuffer(String mimeType,String file_loc)
	...
	/** Creates a new instance of ByteArrayValBuffer */
	public ByteArrayValBuffer(String mimeType,String file_loc,int startIndex)
	throws FileNotFoundException,IOException
	{
		setMimeType(mimeType);
	...
	/** Creates a new instance of ByteArrayValBuffer */
	public ByteArrayValBuffer(String mimeType,URL url)
	throws FileNotFoundException,IOException
	{
		setMimeType(mimeType);
		readInData(url);
	...
	/** Creates a new instance of ByteArrayValBuffer */
	public ByteArrayValBuffer(String mimeType,URL url,int startIndex)
	throws FileNotFoundException,IOException
	{
		setMimeType(mimeType);
	...
	/** Creates a new instance of ByteArrayValBuffer */
	public ByteArrayValBuffer(String mimeType,URL url,int startIndex,int endIndex)
	throws FileNotFoundException,IOException
	{
		setMimeType(mimeType);
	...
	/** Creates a new instance of ByteArrayValBuffer */
	public ByteArrayValBuffer(URL url)
	throws FileNotFoundException,IOException
	{
	...
	/** Creates a new instance of ByteArrayValBuffer */
	public ByteArrayValBuffer(URL url,int startIndex)
	throws FileNotFoundException,IOException
	{
		setMimeType(url.openConnection().getContentType());
		readInData(url,startIndex);
	...
	/** Creates a new instance of ByteArrayValBuffer */
	public ByteArrayValBuffer(URL url,int startIndex,int endIndex)
	throws FileNotFoundException,IOException
	{
		setMimeType(url.openConnection().getContentType());
		readInData(url,startIndex,endIndex);
	...
	/*public ByteArrayValBuffer(PullSourceStream pss,int startIndex,int endIndex)
	{
		setMimeType(pss.getContentDescriptor().getContentType());
		data=new byte[pss.];
		pss.read(data,0,data.length);
	}

	public ByteArrayValBuffer(PushSourceStream pss)
	{
		setMimeType(pss.getContentDescriptor().getContentType());
		data=new byte[pss.getContentLength()];
		pss.read(data,0,data.length);
	}*/
	...
	private void readInData(URL url)
	throws FileNotFoundException,IOException
	{
	...
	private void readInData(URL url,int startIndex)
	throws FileNotFoundException,IOException
	{
		URLConnection con=url.openConnection();
		java.io.InputStream is=con.getInputStream();
	...
	private void readInData(URL url,int startIndex,int endIndex)
	throws FileNotFoundException,IOException
	{
		URLConnection con=url.openConnection();
		java.io.InputStream is=con.getInputStream();
	...
	private void readInData(String file_loc)
	throws FileNotFoundException,IOException
	{
	...
	private void readInData(String file_loc,int startIndex)
	throws FileNotFoundException,IOException
	{
		java.io.InputStream is=new FileInputStream(file_loc);
		readInData(is,startIndex,is.available());
	...
	private void readInData(String file_loc,int startIndex,int endIndex)
	throws FileNotFoundException,IOException
	{
		java.io.InputStream is=new FileInputStream(file_loc);
		readInData(is,startIndex,endIndex);
	...
	private void readInData(InputStream is,int startIndex)
	throws FileNotFoundException,IOException
	{
		readInData(is,startIndex,is.available());
	}

	private void readInData(InputStream is,int startIndex,int endIndex)
	throws FileNotFoundException,IOException
	{
