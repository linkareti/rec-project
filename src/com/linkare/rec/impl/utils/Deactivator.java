...
public class Deactivator extends Thread
{
	...
	{
	    try
	    {this.wait(DEACTIVATION_TIME);}catch(InterruptedException ignored)
	    {return;}
	}
	while(!deactivated)
	{
	...
	try
	{
	    /*System.out.println("************************************");
	    System.out.println("************************************");
	    System.out.println("Going to deactivate object with ID=" + (new String(oid)) + " in POA "+deactivatable.getPOA().the_name());*/
	    deactivatable.getPOA().deactivate_object(oid);
	    /*System.out.println("Apparently deactivated object with ID=" + (new String(oid)) + " in POA "+deactivatable.getPOA().the_name());
	    System.out.println("************************************");
	    System.out.println("************************************");*/
	    deactivated=true;
	}catch(Exception e)
