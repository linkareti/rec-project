...
public class DefaultDisplayFactory extends AbstractDisplayFactory {
	...
	private class ExpDataDisplayTreeIconAndName implements ExpDataDisplay {
		...
		public ExpDataDisplayTreeIconAndName(ExpDataDisplay expDisplay,
				Display treeDisplay) {
		...
		public javax.swing.Icon getIcon() {
			return ReCResourceBundle.findImageIconOrDefault(treeDisplay
		...
		public String getName() {
			return ReCResourceBundle.findStringOrDefault(treeDisplay
					.getDisplayStringBundleKey(), expDisplay.getName());
		}
		...
		public void setExpDataModel(
				com.linkare.rec.impl.client.experiment.ExpDataModel model) {
