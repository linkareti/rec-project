 ...
 */
public class ApparatusTabbedPane extends JTabbedPane {

	private static final long serialVersionUID = -935436319100632299L;

    private static ResourceMap resourceMap = ReCApplication.getApplication().getContext().getResourceMap(ApparatusTabbedPane.class);
	...
	public ApparatusTabbedPane(ApparatusDescriptionPane descriptionPane) {
		super();
