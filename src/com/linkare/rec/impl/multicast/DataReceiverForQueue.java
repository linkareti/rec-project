...

{
    ...
    public DataReceiverForQueue(DataReceiver dr, IDataReceiverForQueueListener dataReceiverForQueueListener) throws NotAuthorized
     ...
     *
     * @param dataReceiverForQueueListener New value of property dataReceiverForQueueListener.
     *
     *
     *
     */
