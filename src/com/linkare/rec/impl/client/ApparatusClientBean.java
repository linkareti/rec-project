...
public class ApparatusClientBean implements DataClientOperations,ExpUsersListSource,IChatServer,ApparatusConnector
{
    ...
    private DataClient _this()
    {
        ...
        try
        {
            return (_this=DataClientHelper.narrow(ORBBean.getORBBean().getAutoIdRootPOA().servant_to_reference(ORBBean.getORBBean().registerAutoIdRootPOAServant(DataClient.class,this,(oid=new ObjectID())))));
        }
        catch(Exception e)
        {
            LoggerUtil.logThrowable("Couldn't register this DataClient with ORB",e,Logger.getLogger(APPARATUS_CLIENT_LOGGER));
            return null;
        }
    ...
    private void fireApparatusConnectorListenerApparatusConnecting(String message)
    {
        ...
        for (int i = listeners.length-2; i>=0; i-=2)
        {
            ...
            {
                ((ApparatusConnectorListener)listeners[i+1]).apparatusConnecting(new ApparatusConnectorEvent(this, message));
            }
        }
    }
    ...
    private void fireApparatusConnectorListenerApparatusConnected(String message)
    {
        ...
        for (int i = listeners.length-2; i>=0; i-=2)
        {
            if (listeners[i]==ApparatusConnectorListener.class)
            {
                ((ApparatusConnectorListener)listeners[i+1]).apparatusConnected(new ApparatusConnectorEvent(this, message));
            }
        }
    }
    ...
    private void fireApparatusConnectorListenerApparatusDisconnecting(String message)
    {
        ...
        for (int i = listeners.length-2; i>=0; i-=2)
        {
            if (listeners[i]==ApparatusConnectorListener.class)
            {
                ((ApparatusConnectorListener)listeners[i+1]).apparatusDisconnecting(new ApparatusConnectorEvent(this, message));
            }
        }
    }
    ...
    private void fireApparatusConnectorListenerApparatusDisconnected(String message)
    {
        ...
        for (int i = listeners.length-2; i>=0; i-=2)
        {
            if (listeners[i]==ApparatusConnectorListener.class)
            {
                ((ApparatusConnectorListener)listeners[i+1]).apparatusDisconnected(new ApparatusConnectorEvent(this, message));
            }
        }
    }
    ...
    private void fireApparatusConnectorListenerApparatusUnreachable(String message)
    {
        ...
        for (int i = listeners.length-2; i>=0; i-=2)
        {
            if (listeners[i]==ApparatusConnectorListener.class)
            {
                ((ApparatusConnectorListener)listeners[i+1]).apparatusUnreachable(new ApparatusConnectorEvent(this, message));
            }
        }
    }
    ...
    private void fireApparatusConnectorListenerApparatusNotAuthorized(String message)
    {
        ...
        for (int i = listeners.length-2; i>=0; i-=2)
        {
            if (listeners[i]==ApparatusConnectorListener.class)
            {
                ((ApparatusConnectorListener)listeners[i+1]).apparatusNotAuthorized(new ApparatusConnectorEvent(this, message));
            }
        }
    }
    ...
    private void fireApparatusConnectorListenerApparatusMaxUsers(String message)
    {
        ...
        for (int i = listeners.length-2; i>=0; i-=2)
        {
            if (listeners[i]==ApparatusConnectorListener.class)
            {
                ((ApparatusConnectorListener)listeners[i+1]).apparatusMaxUsers(new ApparatusConnectorEvent(this, message));
            }
        }
    }
    ...
    private void fireApparatusConnectorListenerApparatusNotRegistered(String message)
    {
        ...
        for (int i = listeners.length-2; i>=0; i-=2)
        {
            if (listeners[i]==ApparatusConnectorListener.class)
            {
                ((ApparatusConnectorListener)listeners[i+1]).apparatusNotRegistered(new ApparatusConnectorEvent(this, message));
            }
        }
    }
    ...
    private void fireApparatusConnectorListenerApparatusStateUnknow(String message)
    {
        ...
        for (int i = listeners.length-2; i>=0; i-=2)
        {
            if (listeners[i]==ApparatusConnectorListener.class)
            {
                ((ApparatusConnectorListener)listeners[i+1]).apparatusStateUnknow(new ApparatusConnectorEvent(this, message));
            }
        }
    }
    ...
    private void fireApparatusConnectorListenerApparatusStateConfiguring(String message)
    {
        ...
        for (int i = listeners.length-2; i>=0; i-=2)
        {
            if (listeners[i]==ApparatusConnectorListener.class)
            {
                ((ApparatusConnectorListener)listeners[i+1]).apparatusStateConfiguring(new ApparatusConnectorEvent(this, message));
            }
        }
    }
    ...
    private void fireApparatusConnectorListenerApparatusStateConfigured(String message)
    {
        ...
        for (int i = listeners.length-2; i>=0; i-=2)
        {
            if (listeners[i]==ApparatusConnectorListener.class)
            {
                ((ApparatusConnectorListener)listeners[i+1]).apparatusStateConfigured(new ApparatusConnectorEvent(this, message));
            }
        }
    }
    ...
    private void fireApparatusConnectorListenerApparatusStateStarting(String message)
    {
        ...
        for (int i = listeners.length-2; i>=0; i-=2)
        {
            if (listeners[i]==ApparatusConnectorListener.class)
            {
                ((ApparatusConnectorListener)listeners[i+1]).apparatusStateStarting(new ApparatusConnectorEvent(this, message));
            }
        }
    }
    ...
    private void fireApparatusConnectorListenerApparatusStateStarted(DataProducerWrapper dataSource)
    {
        if(dataSource==null)
        {
            ...
            {
                LoggerUtil.logThrowable("Data Source is null... unable to fetch it from MCHardware...",e,Logger.getLogger(APPARATUS_CLIENT_LOGGER));
            }
        }
        if(dataSource==null)
            return;
        ...
        for (int i = listeners.length-2; i>=0; i-=2)
        {
            if (listeners[i]==ApparatusConnectorListener.class)
            {
                ((ApparatusConnectorListener)listeners[i+1]).apparatusStateStarted(new ApparatusConnectorEvent(this, dataSource));
            }
        }
    }
    ...
    private void fireApparatusConnectorListenerApparatusStateStoping(String message)
    {
        ...
        for (int i = listeners.length-2; i>=0; i-=2)
        {
            if (listeners[i]==ApparatusConnectorListener.class)
            {
                ((ApparatusConnectorListener)listeners[i+1]).apparatusStateStoping(new ApparatusConnectorEvent(this, message));
            }
        }
    }
    ...
    private void fireApparatusConnectorListenerApparatusStateStoped(String message)
    {
        ...
        for (int i = listeners.length-2; i>=0; i-=2)
        {
            if (listeners[i]==ApparatusConnectorListener.class)
            {
                ((ApparatusConnectorListener)listeners[i+1]).apparatusStateStoped(new ApparatusConnectorEvent(this, message));
            }
        }
    }
    ...
    private void fireApparatusConnectorListenerApparatusStateReseting(String message)
    {
        ...
        for (int i = listeners.length-2; i>=0; i-=2)
        {
            if (listeners[i]==ApparatusConnectorListener.class)
            {
                ((ApparatusConnectorListener)listeners[i+1]).apparatusStateReseting(new ApparatusConnectorEvent(this, message));
            }
        }
    }
    ...
    private void fireApparatusConnectorListenerApparatusStateReseted(String message)
    {
        ...
        for (int i = listeners.length-2; i>=0; i-=2)
        {
            if (listeners[i]==ApparatusConnectorListener.class)
            {
                ((ApparatusConnectorListener)listeners[i+1]).apparatusStateReseted(new ApparatusConnectorEvent(this, message));
            }
        }
    }
    ...
    private void fireApparatusConnectorListenerApparatusLockable(long millis_to_lock_success)
    {
        ...
        for (int i = listeners.length-2; i>=0; i-=2)
        {
            if (listeners[i]==ApparatusConnectorListener.class)
            {
                ((ApparatusConnectorListener)listeners[i+1]).apparatusLockable(new ApparatusConnectorEvent(this, millis_to_lock_success));
            }
        }
    }
    ...
    private void fireApparatusConnectorListenerApparatusIncorrectState(String message)
    {
        ...
        for (int i = listeners.length-2; i>=0; i-=2)
        {
            if (listeners[i]==ApparatusConnectorListener.class)
            {
                ((ApparatusConnectorListener)listeners[i+1]).apparatusIncorrectState(new ApparatusConnectorEvent(this, message));
            }
        }
    }
    ...
    private void fireApparatusConnectorListenerApparatusLocked(String message)
    {
        ...
        for (int i = listeners.length-2; i>=0; i-=2)
        {
            if (listeners[i]==ApparatusConnectorListener.class)
            {
                ((ApparatusConnectorListener)listeners[i+1]).apparatusLocked(new ApparatusConnectorEvent(this, message));
            }
        }
    }
    ...
    private void fireApparatusConnectorListenerApparatusNotOwner(String message)
    {
        ...
        for (int i = listeners.length-2; i>=0; i-=2)
        {
            if (listeners[i]==ApparatusConnectorListener.class)
            {
                ((ApparatusConnectorListener)listeners[i+1]).apparatusNotOwner(new ApparatusConnectorEvent(this, message));
            }
        }
    }
    ...
    private void fireApparatusConnectorListenerApparatusStateConfigError(String message)
    {
        ...
        for (int i = listeners.length-2; i>=0; i-=2)
        {
            if (listeners[i]==ApparatusConnectorListener.class)
            {
                ((ApparatusConnectorListener)listeners[i+1]).apparatusStateConfigError(new ApparatusConnectorEvent(this, message));
            }
        }
    }
     ...
     * @param listener The listener to register.
     */
    public synchronized void addExpUsersListChangeListener(com.linkare.rec.impl.client.experiment.ExpUsersListChangeListener listener)
    {
        if (listenerList == null )
        {
            listenerList = new javax.swing.event.EventListenerList();
     ...
     * @param listener The listener to remove.
     */
    public synchronized void removeExpUsersListChangeListener(com.linkare.rec.impl.client.experiment.ExpUsersListChangeListener listener)
    {
    ...
    private void fireExpUsersListChangeListenerUsersListChanged(UserInfo[] event)
    {
        ...
        for (int i = listeners.length-2; i>=0; i-=2)
        {
            ...
            //Se isto existir... vamos ter problemas mais tarde...pois o chat só vai ficar com os utilizadores ligados no apparatus em questão...
    ...
    /*private void fireIChatMessageListenerUsersListChanged(UserInfo[] newUsersList)
    {
        if (listenerList == null) return;
        Object[] listeners = listenerList.getListenerList();
        for (int i = listeners.length-2; i>=0; i-=2)
     ...
     * @param usersListRefreshPeriod New value of property usersListRefreshPeriod.
     */
    ...
    public void disconnect()
    {
        if(connectedBefore)
        {
            try
            {
                ...
                //System.out.println("Trying to deactivate object with oid = " + oid.getOid());
                ORBBean.getORBBean().deactivateServant(oid.getOid());
                _this=null;
                //System.out.println("Deactivated object with oid = " + oid.getOid());
                fireApparatusConnectorListenerApparatusDisconnected(null);
    ...
    private UsersListRefresher usersListRefreshThread = null;//new UsersListRefresher();
