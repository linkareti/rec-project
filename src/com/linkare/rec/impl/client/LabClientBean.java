 ...
 * @author  jp
 */
public class LabClientBean implements DataClientOperations, LabConnector, ApparatusListSource, IChatServer, ExpUsersListSource
{
    ...
    private Vector apparatusList=new Vector();
    ...
    private DataClient _this()
    {
        ...
        try
        {
            /*org.omg.PortableServer.Servant servant = ORBBean.getORBBean().registerAutoIdRootPOAServant(DataClient.class,this,(oid=new ObjectID()));
            if(servant != null)
                System.out.println("Servant is ok!");
             
            org.omg.CORBA.Object object = ORBBean.getORBBean().getAutoIdRootPOA().servant_to_reference(servant);
                ...
                if(mcc!=null)
                {
                    ...
                    if(mcw.isConnected())
                    {
                        try
                        {
                            ...
                            timerCheckConnectionMultiCastController.schedule(
                            new TimerTask()
                            {
                                public void run()
                                {
     ...
     * @param listener The listener to register.
     */
    public synchronized void addApparatusListSourceListener(com.linkare.rec.impl.client.apparatus.ApparatusListSourceListener listener)
    {
        if (listenerList == null )
        {
            listenerList = new javax.swing.event.EventListenerList();
     ...
     * @param listener The listener to remove.
     */
    public synchronized void removeApparatusListSourceListener(com.linkare.rec.impl.client.apparatus.ApparatusListSourceListener listener)
    {
    ...
    private void fireApparatusListSourceListenerApparatusChanged(ApparatusListChangeEvent newApparatusList)
    {
        ...
        for (int i = listeners.length-2; i>=0; i-=2)
        {
            ...
            {
                ((com.linkare.rec.impl.client.apparatus.ApparatusListSourceListener)listeners[i+1]).apparatusListChanged(newApparatusList);
            }
        }
    }
