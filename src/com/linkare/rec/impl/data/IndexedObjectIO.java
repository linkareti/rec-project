...
public class IndexedObjectIO implements Serializable {
    ...
    public Object[] readObjects(Object[] keys)
    throws IndexedObjectReadException {
        Object[] retVal=null;
        if(keys==null)
    ...
    public Object readObject(Object key) throws IndexedObjectReadException {
        ...
        if(location==null)
            throw new IndexedObjectReadException(new IOException("Unable to read Object - key doesn't exist here!"),key);
    ...
    public void writeObject(Object key, Object value)
    throws IOException {
        synchronized(raf) {
            try {
                ...
                baos.close();                seqWriteStream.close();
                ...
                objectsLocations.put(key,new long[]
                {startPos,endPos});
            }
    ...
    public void writeObjects(Map objects)
    throws IOException {
