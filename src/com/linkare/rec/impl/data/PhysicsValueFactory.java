...
public class PhysicsValueFactory
{
    ...
    {
	return new PhysicsValue(PhysicsValFactory.fromByte(bytevalue),PhysicsValFactory.fromByte(errorvalue),appliedmultiplier);
    }
    ...
    {
	return new PhysicsValue(PhysicsValFactory.fromShort(shortvalue),PhysicsValFactory.fromShort(errorvalue),appliedmultiplier);
    }

    public static PhysicsValue fromInt(int intvalue,int errorvalue,Multiplier appliedmultiplier)
    {
	return new PhysicsValue(PhysicsValFactory.fromInt(intvalue),PhysicsValFactory.fromInt(errorvalue),appliedmultiplier);
    }

    public static PhysicsValue fromFloat(float floatvalue,float errorvalue,Multiplier appliedmultiplier)
    {
	return new PhysicsValue(PhysicsValFactory.fromFloat(floatvalue),PhysicsValFactory.fromFloat(errorvalue),appliedmultiplier);
    }

    public static PhysicsValue fromDouble(double doublevalue,double errorvalue,Multiplier appliedmultiplier)
    {
	return new PhysicsValue(PhysicsValFactory.fromDouble(doublevalue),PhysicsValFactory.fromDouble(errorvalue),appliedmultiplier);
    }
	...
	return new PhysicsValue(PhysicsValFactory.fromDouble(value_corrected),PhysicsValFactory.fromDouble(error_corrected),s.getMultiplier());
    }
	...
	double error_corrected=Math.rint(error*multiplier)/multiplier;
	return new PhysicsValue(PhysicsValFactory.fromInt((int)value_corrected),PhysicsValFactory.fromInt((int)error_corrected),s.getMultiplier());
    }
	...
	double value_corrected=Math.floor((double)value*multiplier)/multiplier;
	double error_corrected=Math.rint(error*multiplier)/multiplier;
	return new PhysicsValue(PhysicsValFactory.fromLong((long)value_corrected),PhysicsValFactory.fromLong((long)error_corrected),s.getMultiplier());
    }
	...
	double value_corrected=Math.floor((double)value*multiplier)/multiplier;
	double error_corrected=Math.rint(error*multiplier)/multiplier;
	return new PhysicsValue(PhysicsValFactory.fromShort((short)value_corrected),PhysicsValFactory.fromShort((short)error_corrected),s.getMultiplier());
    }
	...
	double value_corrected=Math.floor((double)value*multiplier)/multiplier;
	double error_corrected=Math.rint(error*multiplier)/multiplier;
	return new PhysicsValue(PhysicsValFactory.fromByte((byte)value_corrected),PhysicsValFactory.fromByte((byte)error_corrected),s.getMultiplier());
    }
	...
	double error_corrected=Math.rint(error*multiplier)/multiplier;
	return new PhysicsValue(PhysicsValFactory.fromFloat((float)value_corrected),PhysicsValFactory.fromFloat((float)error_corrected),s.getMultiplier());
    }
