...
public class Lab extends DisplayNode implements com.linkare.rec.impl.baseUI.config.CommonBean, OrderedItem
{
	...
	for (Iterator it = source._Apparatus.iterator();
	it.hasNext(); )
	{
	    _Apparatus.add(new com.linkare.rec.impl.baseUI.config.Apparatus((com.linkare.rec.impl.baseUI.config.Apparatus)it.next()));
	}
	...
	if (eventListeners != null)
	{
	    PropertyChangeEvent event = new PropertyChangeEvent(this, "apparatus.i"+index, _Apparatus.get(index), value);
	    eventListeners.firePropertyChange(event);
	}
	...
	if (eventListeners != null)
	{
	    PropertyChangeEvent event = new PropertyChangeEvent(this, "apparatus.i"+(_Apparatus.size()-1), null, value);
	    eventListeners.firePropertyChange(event);
	}
	...
	{
	    com.linkare.rec.impl.baseUI.config.Apparatus element = (com.linkare.rec.impl.baseUI.config.Apparatus)it.next();
	    if (element != null)
	    {
	...
	for (Iterator it = _Apparatus.iterator(), it2 = inst._Apparatus.iterator();
	it.hasNext() && it2.hasNext(); )
	{
	    com.linkare.rec.impl.baseUI.config.Apparatus element = (com.linkare.rec.impl.baseUI.config.Apparatus)it.next();
	    com.linkare.rec.impl.baseUI.config.Apparatus element2 = (com.linkare.rec.impl.baseUI.config.Apparatus)it2.next();
