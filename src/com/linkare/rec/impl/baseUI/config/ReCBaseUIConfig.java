...
public class ReCBaseUIConfig implements CommonBean
{
	...
	{
	    logThrowable("Couldn't get codebase - Basic Service is probably not defined... Not running as a jnlp application!", e);
	}
	...
	/*finally 
	{
	    try
	    {
		is=ReCProtocols.getURL("recresource:///com/linkare/rec/impl/baseUI/config/ReCBaseUIConfigExample.xml").openConnection().getInputStream();
	    }
	    catch(Exception e)
	    {
	...
	if (eventListeners != null )
	{
	    event = new PropertyChangeEvent(this, "splashIconLocationBundleKey", getSplashIconLocationBundleKey(), value);
	}
    ...
    {
        return ReCResourceBundle.findImageIconOrDefault(getSplashIconLocationBundleKey(), new javax.swing.ImageIcon(getClass().getResource("/com/linkare/rec/impl/baseUI/resources/about_box.png")));
    }
	...
	if (eventListeners != null )
	{
	    event = new PropertyChangeEvent(this, "enableVideoFrame", new Boolean(isEnableVideoFrame()), new Boolean(value));
	}
	...
	if (eventListeners != null )
	{
	    event = new PropertyChangeEvent(this, "enableLoginPassword", new Boolean(isEnableLoginPassword()), new Boolean(value));
	}
	...
	if (eventListeners != null )
	{
	    event = new PropertyChangeEvent(this, "enableChatFrame", new Boolean(isEnableChatFrame()), new Boolean(value));
	}
	...
	if (eventListeners != null )
	{
	    event = new PropertyChangeEvent(this, "enableUsersList", new Boolean(isEnableUsersList()), new Boolean(value));
	}
	...
	if (eventListeners != null )
	{
	    event = new PropertyChangeEvent(this, "usersListRefreshRateMs", new Long(getUsersListRefreshRateMs()), new Long(value));
	}
	...
	if (eventListeners != null )
	{
	    event = new PropertyChangeEvent(this, "enterApparatusChatRoom", new Boolean(isEnterApparatusChatRoom()), new Boolean(value));
	}
	...
	if (eventListeners != null )
	{
	    event = new PropertyChangeEvent(this, "iconSponsorLocationBundleKey", getIconSponsorLocationBundleKey(), value);
	}
    ...
    public void read(InputSource in, boolean validate, EntityResolver er, org.xml.sax.ErrorHandler eh) throws ParserConfigurationException, SAXException, IOException
    {
	...
	/*if (getAboutPageLocationBundleKey() == null)
	{
	    throw new ReCBaseUIConfig.ValidateException("getAboutPageLocationBundleKey() == null", "aboutPageLocationBundleKey", this);	// NOI18N
	}*/
	
	// Validating property usersListRefreshRateMs
	if (getUsersListRefreshRateMs() < 0)
	{
	    throw new ReCBaseUIConfig.ValidateException("getUsersListRefreshRateMs() < 0", "usersListRefreshRateMs", this);	// NOI18N
	}
	...
	/*if (getIconSponsorLocationBundleKey() == null)
	{
	    throw new ReCBaseUIConfig.ValidateException("getIconSponsorLocationBundleKey() == null", "iconSponsorLocationBundleKey", this);	// NOI18N
	}*/
	// Validating property helpPageLocationBundleKey
	/*if (getHelpPageLocationBundleKey() == null)
	{
	    throw new ReCBaseUIConfig.ValidateException("getHelpPageLocationBundleKey() == null", "helpPageLocationBundleKey", this);	// NOI18N
	}*/
	...
	if (!(_AboutPageLocationBundleKey == null ? inst._AboutPageLocationBundleKey == null : _AboutPageLocationBundleKey.equals(inst._AboutPageLocationBundleKey)))
	    return false;
        if (!(_SplashIconLocationBundleKey == null ? inst._SplashIconLocationBundleKey == null : _SplashIconLocationBundleKey.equals(inst._SplashIconLocationBundleKey)))
	    return false;
	...
	if (!(_IconLocationBundleKey == null ? inst._IconLocationBundleKey == null : _IconLocationBundleKey.equals(inst._IconLocationBundleKey)))
	    ...
	    return false;
	if (!(_FrameTitleBundleKey == null ? inst._FrameTitleBundleKey == null : _FrameTitleBundleKey.equals(inst._FrameTitleBundleKey)))
	    return false;
	if (!(_IconSponsorLocationBundleKey == null ? inst._IconSponsorLocationBundleKey == null : _IconSponsorLocationBundleKey.equals(inst._IconSponsorLocationBundleKey)))
	    return false;
	if (!(_HelpPageLocationBundleKey == null ? inst._HelpPageLocationBundleKey == null : _HelpPageLocationBundleKey.equals(inst._HelpPageLocationBundleKey)))
	    return false;
	if (sizeLab() != inst.sizeLab())
	    return false;
	// Compare every element.
	for (Iterator it = _Lab.iterator(), it2 = inst._Lab.iterator();
