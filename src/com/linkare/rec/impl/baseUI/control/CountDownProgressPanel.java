...
public class CountDownProgressPanel extends javax.swing.JPanel
{
    ...
    private String lockFor = ReCResourceBundle.findStringOrDefault("ReCBaseUI$rec.bui.lbl.lockableFor", "Lockable for: ");
	...
	public void run()
	{
		...
		while(counter >= countDownTo && !stop)
		{
		    ...
		    sleep(updateRate * 1000);
                ...
                firePropertyChangeListenerPropertyChange(new java.beans.PropertyChangeEvent(this, "progressEnd", Boolean.FALSE, Boolean.TRUE));
