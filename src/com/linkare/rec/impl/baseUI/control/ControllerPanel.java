...
public class ControllerPanel extends javax.swing.JPanel implements java.io.Serializable
{
    ...
    private void initComponents()//GEN-BEGIN:initComponents
    {
        ...
        jButtonConfigure.setIcon(ReCResourceBundle.findImageIconOrDefault("ReCBaseUI$rec.bui.icon.customize", new ImageIcon(getClass().getResource("/com/linkare/rec/impl/baseUI/resources/Preferences16.gif"))));
        jButtonConfigure.setToolTipText(ReCResourceBundle.findStringOrDefault("ReCBaseUI$rec.bui.tip.customize", "Customize the experiment!"));
        ...
        jButtonPlay.setIcon(ReCResourceBundle.findImageIconOrDefault("ReCBaseUI$rec.bui.icon.play", new ImageIcon(getClass().getResource("/com/linkare/rec/impl/baseUI/resources/Play16.gif"))));
        jButtonPlay.setToolTipText(ReCResourceBundle.findStringOrDefault("ReCBaseUI$rec.bui.tip.start", "Start the experiment!"));
        ...
        jButtonStop.setIcon(ReCResourceBundle.findImageIconOrDefault("ReCBaseUI$rec.bui.icon.stop", new ImageIcon(getClass().getResource("/com/linkare/rec/impl/baseUI/resources/Stop16.gif"))));
        jButtonStop.setToolTipText(ReCResourceBundle.findStringOrDefault("ReCBaseUI$rec.bui.tip.stop", "Stop the experiment!"));
