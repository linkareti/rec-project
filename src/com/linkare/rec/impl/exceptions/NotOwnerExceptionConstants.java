...
{
	private static final java.util.ResourceBundle notOwnerExceptionRB = java.util.ResourceBundle.getBundle("com/linkare/rec/impl/exceptions/resources/NotOwnerException");

	public static final int HARDWARE_NOT_LOCKABLE_TO_ANYONE=0;
	public static final String HARDWARE_NOT_LOCKABLE_TO_ANYONE_MSG=notOwnerExceptionRB.getString("multicasthardware_lock_unavailable_all_dataclients");
	public static final int HARDWARE_IN_LOCK_PROCESS_TO_ANOTHER=1;
	public static final String HARDWARE_IN_LOCK_PROCESS_TO_ANOTHER_MSG=notOwnerExceptionRB.getString("multicasthardware_locking_another_dataclient");
	public static final int HARDWARE_LOCKED_TO_ANOTHER=2;
	public static final String HARDWARE_LOCKED_TO_ANOTHER_MSG=notOwnerExceptionRB.getString("multicasthardware_locked_another_dataclient");
	public static final int HARDWARE_LOCK_AVAILABLE_TO_ANOTHER=3;
	public static final String HARDWARE_LOCK_AVAILABLE_TO_ANOTHER_MSG=notOwnerExceptionRB.getString("multicasthardware_lock_available_another_dataclient");
