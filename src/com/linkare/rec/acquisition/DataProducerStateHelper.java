...
abstract public class DataProducerStateHelper
{
  ...
  synchronized public static org.omg.CORBA.TypeCode type ()
  {
    if (__typeCode == null)
    {
      __typeCode = org.omg.CORBA.ORB.init ().create_enum_tc (com.linkare.rec.acquisition.DataProducerStateHelper.id (), "DataProducerState", new String[] { "DP_WAITING", "DP_STARTED_NODATA", "DP_STARTED", "DP_ENDED", "DP_STOPED", "DP_ERROR"} );
    }
    return __typeCode;
  }
  ...
  public static void write (org.omg.CORBA.portable.OutputStream ostream, com.linkare.rec.acquisition.DataProducerState value)
  {
