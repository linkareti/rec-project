...
/**
* com/linkare/rec/acquisition/NotOwnerExceptionHelper.java .
...
public abstract class NotOwnerExceptionHelper
{
      ...
      synchronized (org.omg.CORBA.TypeCode.class)
      {
        if (__typeCode == null)
        {
          ...
          _members0[1] = new org.omg.CORBA.StructMember (
            ...
            _tcOf_members0,
            null);
          __typeCode = org.omg.CORBA.ORB.init ().create_exception_tc (com.linkare.rec.acquisition.NotOwnerExceptionHelper.id (), "NotOwnerException", _members0);
          __active = false;
        }
      }
    }
  ...
  public static void write (org.omg.CORBA.portable.OutputStream ostream, com.linkare.rec.acquisition.NotOwnerException value)
  {
