...
abstract public class HardwareStateHelper
{
	...
	synchronized public static org.omg.CORBA.TypeCode type()
	{
		if (__typeCode == null)
		{
			__typeCode = org.omg.CORBA.ORB.init().create_enum_tc(com.linkare.rec.acquisition.HardwareStateHelper.id(), "HardwareState", new String[]
			{ "UNKNOWN", "CONFIGURING", "CONFIGURED", "STARTING", "STARTED", "STOPING", "STOPED", "RESETING", "RESETED"} );
		}
		return __typeCode;
	}
	...
	public static void write(org.omg.CORBA.portable.OutputStream ostream, com.linkare.rec.acquisition.HardwareState value)
	{
