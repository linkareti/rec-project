...
/**
* com/linkare/rec/acquisition/DataProducerPOA.java .
...
public abstract class DataProducerPOA extends org.omg.PortableServer.Servant implements com.linkare.rec.acquisition.DataProducerOperations, org.omg.CORBA.portable.InvokeHandler
{
  ...
  //Version 7.0 Change this... now we may get any of the states...
       ...
       {
         try {
           com.linkare.rec.acquisition.DataReceiver data_receiver = com.linkare.rec.acquisition.DataReceiverHelper.read (in);
  ...
  {
    return DataProducerHelper.narrow(
    super._this_object());
  }
