...
abstract public class DataProducerConfigHelper
{
	...
	if (__typeCode == null)
	{
		...
		if (__typeCode == null)
		{
		    ...
		    _tcOf_members0 = ORB.init().create_alias_tc(DataProducerIdHelper.id(), "DataProducerId", _tcOf_members0);
		    ...
		    _tcOf_members0,
		    null);
		    __typeCode = ORB.init().create_struct_tc(DataProducerConfigHelper.id(), "DataProducerConfig", _members0);
		    __active = false;
		}
	    }
	}
