...
public class FrequencyControl extends javax.swing.JPanel implements javax.media.Control
{
	...
	public FrequencyControl(InterLacedSineWaveStream baseStream)
	{
		...
		JSlider sliderleft=new JSlider(JSlider.VERTICAL,100,800,(int)baseStream.getWaveLeftFreq());
		...
		JSlider sliderright=new JSlider(JSlider.VERTICAL,100,800,(int)baseStream.getWaveRightFreq());
