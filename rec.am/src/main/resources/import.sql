...
INSERT INTO EXPERIMENT (ID, VERSION, EXTERNAL_ID, NAME, DESCRIPTION, KEY_LABORATORY, IS_ACTIVE) VALUES (1, 1, 'ELAB_ALEATORIO_V02', 'Estatística de Dados', 'Name = Aleatorio, version = 1, manufacturer = Pedro, driverVersion = v1', 1, 1);
...
INSERT INTO EXPERIMENT (ID, VERSION, EXTERNAL_ID, NAME, DESCRIPTION, KEY_LABORATORY, IS_ACTIVE) VALUES (11, 1, 'ELAB_G_STAMP_V02', 'g', 'Name = Basic STAMP, version = BS2, manufacturer = Parallax, driverVersion = v2', 1, 1);
...
INSERT INTO EXPERIMENT (ID, VERSION, EXTERNAL_ID, NAME, DESCRIPTION, KEY_LABORATORY, IS_ACTIVE) VALUES (27, 1, 'ELAB_PV_STAMP_V02', 'Boyle Mariotte', 'Name = Basic STAMP, version = BS2, manufacturer = Parallax, driverVersion = v2', 1, 1);
...
INSERT INTO EXPERIMENT (ID, VERSION, EXTERNAL_ID, NAME, DESCRIPTION, KEY_LABORATORY, IS_ACTIVE) VALUES (30, 1, 'ELAB_SCUBA_STAMP_V02', 'Scuba', 'Name = Basic STAMP, version = BS2, manufacturer = Parallax, driverVersion = v2', 1, 1);
INSERT INTO EXPERIMENT (ID, VERSION, EXTERNAL_ID, NAME, DESCRIPTION, KEY_LABORATORY, IS_ACTIVE) VALUES (31, 1, 'ELAB_STATSOUND_STAMP_V01', 'Ondas estacionarias e velocidade do som', 'Name = Basic STAMP, version = BS2, manufacturer = Parallax, driverVersion = v2', 1, 1);
