...
public class SessionListener implements HttpSessionListener {
    ...
    /**
     * our apps security service bean responsible from doing necessary operations at login/logout progress...
     */
	...
	/*
	 * nobody can reach user data after this point because session is invalidated already. So, get the user data from session and save its logout
	 * information before losing it. User's redirection to the timeout page will be handled by the SessionTimeoutFilter.
	 */
	//  try {
