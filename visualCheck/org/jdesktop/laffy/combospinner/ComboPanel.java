...
public class ComboPanel extends OptionsSettablePanel {
    ...
    public ComboPanel() {
        ...
        smallIconComboBox.setModel(new DefaultComboBoxModel(new Object[]{
                new NamedIcon("FileChooser.fileIcon"),
                new NamedIcon("FileChooser.directoryIcon"),
                new NamedIcon("FileChooser.upFolderIcon"),
                new NamedIcon("FileChooser.newFolderIcon"),
                new NamedIcon("FileChooser.hardDriveIcon"),
                new NamedIcon("FileChooser.floppyDriveIcon"),
                new NamedIcon("FileChooser.homeFolderIcon"),
                new NamedIcon("FileChooser.detailsViewIcon"),
                new NamedIcon("FileChooser.listViewIcon"),
        }));
        smallIconComboBox.setRenderer(new IconRender(smallIconComboBox.getRenderer()));
        largeIconComboBox.setModel(new DefaultComboBoxModel(new Object[]{
                new NamedIcon("OptionPane.errorIcon"),
                new NamedIcon("OptionPane.informationIcon"),
                new NamedIcon("OptionPane.questionIcon"),
...
//        smallIconComboBox.setOpaque(o);
    ...
    private static class IconRender implements ListCellRenderer {
        ...
        public Component getListCellRendererComponent(JList list, Object value, int index, boolean isSelected,
            ...
            if (value instanceof NamedIcon) {
                ...
                JLabel label = (JLabel) defaultRenderer.getListCellRendererComponent(list, namedIcon.name, index,
    ...
    private void initComponents() {
        ...
        smallIconComboBox.setModel(new javax.swing.DefaultComboBoxModel(new String[] { I18nResourceHandler.getMessage("Item_1"), I18nResourceHandler.getMessage("Item_2"), I18nResourceHandler.getMessage("Item_3"), I18nResourceHandler.getMessage("Item_4") }));
        gridBagConstraints = new java.awt.GridBagConstraints();
        gridBagConstraints.gridx = 1;
        gridBagConstraints.gridy = 5;
        ...
        largeIconComboBox.setModel(new javax.swing.DefaultComboBoxModel(new String[] { I18nResourceHandler.getMessage("Item_1"), I18nResourceHandler.getMessage("Item_2"), I18nResourceHandler.getMessage("Item_3"), I18nResourceHandler.getMessage("Item_4") }));
        gridBagConstraints = new java.awt.GridBagConstraints();
        gridBagConstraints.gridx = 1;
        ...
        jComboBox7.setModel(new javax.swing.DefaultComboBoxModel(new String[] { I18nResourceHandler.getMessage("Item_1"), I18nResourceHandler.getMessage("Item_2"), I18nResourceHandler.getMessage("Item_3"), I18nResourceHandler.getMessage("Item_4") }));
        gridBagConstraints = new java.awt.GridBagConstraints();
        gridBagConstraints.gridx = 1;
        gridBagConstraints.gridy = 1;
        gridBagConstraints.fill = java.awt.GridBagConstraints.BOTH;
        ...
        jComboBox8.setModel(new javax.swing.DefaultComboBoxModel(new String[] { I18nResourceHandler.getMessage("Item_1"), I18nResourceHandler.getMessage("Item_2"), I18nResourceHandler.getMessage("Item_3"), I18nResourceHandler.getMessage("Item_4") }));
        gridBagConstraints = new java.awt.GridBagConstraints();
        gridBagConstraints.gridx = 2;
        gridBagConstraints.gridy = 1;
        gridBagConstraints.fill = java.awt.GridBagConstraints.BOTH;
        ...
        jComboBox9.setModel(new javax.swing.DefaultComboBoxModel(new String[] { I18nResourceHandler.getMessage("Item_1"), I18nResourceHandler.getMessage("Item_2"), I18nResourceHandler.getMessage("Item_3"), I18nResourceHandler.getMessage("Item_4") }));
        gridBagConstraints = new java.awt.GridBagConstraints();
        gridBagConstraints.gridx = 3;
        gridBagConstraints.gridy = 1;
        gridBagConstraints.fill = java.awt.GridBagConstraints.BOTH;
        ...
        jComboBox10.setModel(new javax.swing.DefaultComboBoxModel(new String[] { I18nResourceHandler.getMessage("Item_1"), I18nResourceHandler.getMessage("Item_2"), I18nResourceHandler.getMessage("Item_3"), I18nResourceHandler.getMessage("Item_4") }));
